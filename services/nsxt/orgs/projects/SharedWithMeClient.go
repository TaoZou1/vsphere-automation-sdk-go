...
type SharedWithMeClient interface {
	...
	List(orgIdParam string, projectIdParam string, resourceTypeParam *string) (model.SharedResourceListResult, error)
}
...
func NewSharedWithMeClient(connector client.Connector) *sharedWithMeClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.shared_with_me")
...
func (sIface *sharedWithMeClient) List(orgIdParam string, projectIdParam string, resourceTypeParam *string) (model.SharedResourceListResult, error) {
