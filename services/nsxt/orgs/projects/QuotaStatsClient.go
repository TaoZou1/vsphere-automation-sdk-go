...
type QuotaStatsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, pathPrefixParam string, constraintPathParam *string) (model.QuotaStatsListResult, error)
}
...
func NewQuotaStatsClient(connector client.Connector) *quotaStatsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.quota_stats")
...
func (qIface *quotaStatsClient) Get(orgIdParam string, projectIdParam string, pathPrefixParam string, constraintPathParam *string) (model.QuotaStatsListResult, error) {
