...
type UserInfoClient interface {
	...
	Get(orgIdParam string, projectIdParam string) (model.UserInfo, error)
}
...
func NewUserInfoClient(connector client.Connector) *userInfoClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.aaa.user_info")
...
func (uIface *userInfoClient) Get(orgIdParam string, projectIdParam string) (model.UserInfo, error) {
