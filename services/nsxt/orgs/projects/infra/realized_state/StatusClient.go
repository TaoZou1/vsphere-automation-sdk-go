...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, intentPathParam string, includeEnforcedStatusParam *bool, sitePathParam *string) (model.ConsolidatedRealizedStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.realized_state.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, intentPathParam string, includeEnforcedStatusParam *bool, sitePathParam *string) (model.ConsolidatedRealizedStatus, error) {
