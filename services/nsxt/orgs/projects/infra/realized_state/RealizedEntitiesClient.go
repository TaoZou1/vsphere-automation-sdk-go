...
type RealizedEntitiesClient interface {
	...
	List(orgIdParam string, projectIdParam string, intentPathParam string, sitePathParam *string) (model.GenericPolicyRealizedResourceListResult, error)
}
...
func NewRealizedEntitiesClient(connector client.Connector) *realizedEntitiesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.realized_state.realized_entities")
...
func (rIface *realizedEntitiesClient) List(orgIdParam string, projectIdParam string, intentPathParam string, sitePathParam *string) (model.GenericPolicyRealizedResourceListResult, error) {
