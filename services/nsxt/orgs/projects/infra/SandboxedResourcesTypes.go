...
func sandboxedResourcesListInputType() bindings.StructType {
...
func sandboxedResourcesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.SandboxedResourceListResultBindingType)
}

func sandboxedResourcesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/sandboxed-resources",
		"",
		resultHeaders,
		200,
		"",
