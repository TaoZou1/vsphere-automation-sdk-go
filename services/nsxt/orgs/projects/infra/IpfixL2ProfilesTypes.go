...
func ipfixL2ProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-l2-profiles/{ipfixL2ProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipfixL2ProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-l2-profiles",
		"",
		resultHeaders,
		200,
		"",
