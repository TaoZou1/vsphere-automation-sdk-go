...
func ipfixL2CollectorProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-l2-collector-profiles/{ipfixL2CollectorProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipfixL2CollectorProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-l2-collector-profiles",
		"",
		resultHeaders,
		200,
		"",
