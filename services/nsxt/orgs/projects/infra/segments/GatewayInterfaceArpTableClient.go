...
type GatewayInterfaceArpTableClient interface {
	...
	List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.InterfaceArpTable, error)
}
...
func NewGatewayInterfaceArpTableClient(connector client.Connector) *gatewayInterfaceArpTableClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.gateway_interface_arp_table")
...
func (gIface *gatewayInterfaceArpTableClient) List(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.InterfaceArpTable, error) {
