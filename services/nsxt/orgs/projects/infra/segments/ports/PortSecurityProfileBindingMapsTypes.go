...
func portSecurityProfileBindingMapsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/{segmentId}/ports/{portId}/port-security-profile-binding-maps/{portSecurityProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func portSecurityProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/{segmentId}/ports/{portId}/port-security-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
