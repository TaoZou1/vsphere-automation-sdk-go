...
type GatewayInterfaceStatisticsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyInterfaceStatistics, error)
}
...
func NewGatewayInterfaceStatisticsClient(connector client.Connector) *gatewayInterfaceStatisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.gateway_interface_statistics")
...
func (gIface *gatewayInterfaceStatisticsClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, hostTransportNodePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyInterfaceStatistics, error) {
