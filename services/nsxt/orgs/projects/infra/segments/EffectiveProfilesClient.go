...
type EffectiveProfilesClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error)
}
...
func NewEffectiveProfilesClient(connector client.Connector) *effectiveProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.effective_profiles")
...
func (eIface *effectiveProfilesClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error) {
