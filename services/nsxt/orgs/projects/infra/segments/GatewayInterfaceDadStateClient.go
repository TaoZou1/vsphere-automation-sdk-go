...
type GatewayInterfaceDadStateClient interface {
	...
	Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.InterfaceDADState, error)
}
...
func NewGatewayInterfaceDadStateClient(connector client.Connector) *gatewayInterfaceDadStateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.gateway_interface_dad_state")
...
func (gIface *gatewayInterfaceDadStateClient) Get(orgIdParam string, projectIdParam string, segmentIdParam string, enforcementPointPathParam *string, sourceParam *string) (model.InterfaceDADState, error) {
