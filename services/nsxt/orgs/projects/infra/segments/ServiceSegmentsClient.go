...
type ServiceSegmentsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ServiceSegmentListResult, error)
...
func NewServiceSegmentsClient(connector client.Connector) *serviceSegmentsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments")
...
func (sIface *serviceSegmentsClient) Delete(serviceSegmentIdParam string, orgIdParam string, projectIdParam string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments", "delete", inputDataValue, executionContext)
...
func (sIface *serviceSegmentsClient) Get(serviceSegmentIdParam string, orgIdParam string, projectIdParam string) (model.ServiceSegment, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments", "get", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegment
	if methodResult.IsSuccess() {
...
func (sIface *serviceSegmentsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ServiceSegmentListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments", "list", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegmentListResult
	if methodResult.IsSuccess() {
...
func (sIface *serviceSegmentsClient) Patch(serviceSegmentIdParam string, orgIdParam string, projectIdParam string, serviceSegmentParam model.ServiceSegment) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (sIface *serviceSegmentsClient) Update(serviceSegmentIdParam string, orgIdParam string, projectIdParam string, serviceSegmentParam model.ServiceSegment) (model.ServiceSegment, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.segments.service_segments", "update", inputDataValue, executionContext)
	var emptyOutput model.ServiceSegment
	if methodResult.IsSuccess() {
