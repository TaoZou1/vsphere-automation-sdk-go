...
func serviceSegmentsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/service-segments/{serviceSegmentId}",
		"",
		resultHeaders,
		204,
		"",
...
func serviceSegmentsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/segments/service-segments",
		"",
		resultHeaders,
		200,
		"",
