...
type EffectiveResourcesClient interface {
	...
	List(orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, filterTextParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (model.PolicyResourceReferenceListResult, error)
}
...
func NewEffectiveResourcesClient(connector client.Connector) *effectiveResourcesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tags.effective_resources")
...
func (eIface *effectiveResourcesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, filterTextParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (model.PolicyResourceReferenceListResult, error) {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tags.effective_resources", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyResourceReferenceListResult
