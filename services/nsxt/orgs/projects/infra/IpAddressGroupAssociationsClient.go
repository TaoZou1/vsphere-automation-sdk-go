...
type IpAddressGroupAssociationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, ipAddressParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyResourceReferenceForEPListResult, error)
}
...
func NewIpAddressGroupAssociationsClient(connector client.Connector) *ipAddressGroupAssociationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_address_group_associations")
