...
func portMirroringProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/port-mirroring-profiles/{portMirroringProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func portMirroringProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/port-mirroring-profiles",
		"",
		resultHeaders,
		200,
		"",
