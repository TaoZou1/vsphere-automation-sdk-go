...
func NewForwardingPoliciesClient(connector client.Connector) *forwardingPoliciesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies")
...
func (fIface *forwardingPoliciesClient) Delete(domainIdParam string, forwardingPolicyIdParam string, orgIdParam string, projectIdParam string) error {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies", "delete", inputDataValue, executionContext)
...
func (fIface *forwardingPoliciesClient) Get(domainIdParam string, forwardingPolicyIdParam string, orgIdParam string, projectIdParam string) (model.ForwardingPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies", "get", inputDataValue, executionContext)
	var emptyOutput model.ForwardingPolicy
	if methodResult.IsSuccess() {
...
func (fIface *forwardingPoliciesClient) List(domainIdParam string, orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includeRuleCountParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ForwardingPolicyListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies", "list", inputDataValue, executionContext)
	var emptyOutput model.ForwardingPolicyListResult
	if methodResult.IsSuccess() {
...
func (fIface *forwardingPoliciesClient) Patch(domainIdParam string, forwardingPolicyIdParam string, orgIdParam string, projectIdParam string, forwardingPolicyParam model.ForwardingPolicy) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), fIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (fIface *forwardingPoliciesClient) Update(domainIdParam string, forwardingPolicyIdParam string, orgIdParam string, projectIdParam string, forwardingPolicyParam model.ForwardingPolicy) (model.ForwardingPolicy, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	fIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.forwarding_policies", "update", inputDataValue, executionContext)
	var emptyOutput model.ForwardingPolicy
	if methodResult.IsSuccess() {
