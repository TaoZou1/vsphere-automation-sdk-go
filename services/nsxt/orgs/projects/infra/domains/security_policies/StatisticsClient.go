...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.security_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, securityPolicyIdParam string, orgIdParam string, projectIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.SecurityPolicyStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.security_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput model.SecurityPolicyStatisticsListResult
