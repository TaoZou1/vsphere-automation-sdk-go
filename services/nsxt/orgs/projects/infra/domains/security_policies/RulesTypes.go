...
func rulesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/security-policies/{securityPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		204,
		"",
...
func rulesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/security-policies/{securityPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
