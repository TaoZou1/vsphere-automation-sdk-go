...
func containerClusterSpanDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/security-policies/{securityPolicyId}/container-cluster-span/{antreaCluster1}",
		"",
		resultHeaders,
		204,
		"",
...
func containerClusterSpanListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/security-policies/{securityPolicyId}/container-cluster-span",
		"",
		resultHeaders,
		200,
		"",
...
func containerClusterSpanPatchRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"PATCH",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/security-policies/{securityPolicyId}/container-cluster-span/{containerClusterId}",
		"",
		resultHeaders,
		204,
		"",
