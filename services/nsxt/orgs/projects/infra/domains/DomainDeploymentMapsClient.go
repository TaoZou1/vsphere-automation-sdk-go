...
type DomainDeploymentMapsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, domainIdParam string, domainDeploymentMapIdParam string) (model.DomainDeploymentMap, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DomainDeploymentMapListResult, error)
}
...
func NewDomainDeploymentMapsClient(connector client.Connector) *domainDeploymentMapsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.domain_deployment_maps")
...
func (dIface *domainDeploymentMapsClient) Get(orgIdParam string, projectIdParam string, domainIdParam string, domainDeploymentMapIdParam string) (model.DomainDeploymentMap, error) {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.domain_deployment_maps", "get", inputDataValue, executionContext)
	var emptyOutput model.DomainDeploymentMap
...
func (dIface *domainDeploymentMapsClient) List(orgIdParam string, projectIdParam string, domainIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DomainDeploymentMapListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.domain_deployment_maps", "list", inputDataValue, executionContext)
	var emptyOutput model.DomainDeploymentMapListResult
	if methodResult.IsSuccess() {
