...
// Data type definitions file for service: Pods.
...
func podsListInputType() bindings.StructType {
...
func podsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyContainerGroupMembersListResultBindingType)
}

func podsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/groups/{groupId}/members/pods",
		"",
		resultHeaders,
		200,
		"",
