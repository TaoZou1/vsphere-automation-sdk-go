...
type ConsolidatedEffectiveIpAddressesClient interface {
	...
	List(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, ipFilterParam *string, pageSizeParam *int64, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (model.ConsolidatedEffectiveIPAddressMemberListResult, error)
}
...
func NewConsolidatedEffectiveIpAddressesClient(connector client.Connector) *consolidatedEffectiveIpAddressesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.members.consolidated_effective_ip_addresses")
...
func (cIface *consolidatedEffectiveIpAddressesClient) List(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, ipFilterParam *string, pageSizeParam *int64, siteIdParam *string, sortAscendingParam *bool, sortByParam *string) (model.ConsolidatedEffectiveIPAddressMemberListResult, error) {
	...
	methodResult := cIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.members.consolidated_effective_ip_addresses", "list", inputDataValue, executionContext)
	var emptyOutput model.ConsolidatedEffectiveIPAddressMemberListResult
