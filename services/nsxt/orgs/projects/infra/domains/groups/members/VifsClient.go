...
func NewVifsClient(connector client.Connector) *vifsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.members.vifs")
...
func (vIface *vifsClient) List(domainIdParam string, groupIdParam string, orgIdParam string, projectIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.VirtualNetworkInterfaceListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.members.vifs", "list", inputDataValue, executionContext)
	var emptyOutput model.VirtualNetworkInterfaceListResult
