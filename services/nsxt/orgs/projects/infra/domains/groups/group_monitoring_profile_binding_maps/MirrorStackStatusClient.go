...
func NewMirrorStackStatusClient(connector client.Connector) *mirrorStackStatusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.group_monitoring_profile_binding_maps.mirror_stack_status")
...
func (mIface *mirrorStackStatusClient) List(orgIdParam string, projectIdParam string, domainIdParam string, groupIdParam string, groupMonitoringProfileBindingMapIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.MirrorStackStatusListResult, error) {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.groups.group_monitoring_profile_binding_maps.mirror_stack_status", "list", inputDataValue, executionContext)
	var emptyOutput model.MirrorStackStatusListResult
