...
func firewallFloodProtectionProfileBindingMapsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/groups/{groupId}/firewall-flood-protection-profile-binding-maps/{firewallFloodProtectionProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func firewallFloodProtectionProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/groups/{groupId}/firewall-flood-protection-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
