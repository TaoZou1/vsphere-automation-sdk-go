...
func groupMonitoringProfileBindingMapsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/groups/{groupId}/group-monitoring-profile-binding-maps/{groupMonitoringProfileBindingMapId}",
		"",
		resultHeaders,
		204,
		"",
...
func groupMonitoringProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/domains/{domainId}/groups/{groupId}/group-monitoring-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
