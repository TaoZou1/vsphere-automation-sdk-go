...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, domainIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.domains.gateway_policies.rules.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, domainIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.domains.gateway_policies.rules.statistics", "list", inputDataValue, executionContext)
	var emptyOutput model.RuleStatisticsListResult
