...
func NewPhysicalServerGroupAssociationsClient(connector client.Connector) *physicalServerGroupAssociationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.physical_server_group_associations")
...
func (pIface *physicalServerGroupAssociationsClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (pIface *physicalServerGroupAssociationsClient) List(orgIdParam string, projectIdParam string, bmsExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyResourceReferenceForEPListResult, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.physical_server_group_associations", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyResourceReferenceForEPListResult
