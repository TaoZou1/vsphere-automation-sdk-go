...
func (sIface *statsClient) Get(orgIdParam string, projectIdParam string, configIdParam string, connectivityPathParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DhcpServerStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.dhcp_server_configs.stats", "get", inputDataValue, executionContext)
	var emptyOutput model.DhcpServerStatistics
