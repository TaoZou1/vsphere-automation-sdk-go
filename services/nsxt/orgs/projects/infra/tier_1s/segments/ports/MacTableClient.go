...
type MacTableClient interface {
	...
	List(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, portIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.SegmentPortMacAddressListResult, error)
}
...
func NewMacTableClient(connector client.Connector) *macTableClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.ports.mac_table")
...
func (mIface *macTableClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, segmentIdParam string, portIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.SegmentPortMacAddressListResult, error) {
	...
	if inputError != nil {
		var emptyOutput model.SegmentPortMacAddressListResult
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.segments.ports.mac_table", "list", inputDataValue, executionContext)
	var emptyOutput model.SegmentPortMacAddressListResult
	if methodResult.IsSuccess() {
		...
		return output.(model.SegmentPortMacAddressListResult), nil
	} else {
