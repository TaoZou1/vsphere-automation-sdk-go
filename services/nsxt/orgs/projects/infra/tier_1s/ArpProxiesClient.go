...
type ArpProxiesClient interface {
	...
	List(orgIdParam string, projectIdParam string, tier1IdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.PolicyArpProxyTableListResult, error)
}
...
func NewArpProxiesClient(connector client.Connector) *arpProxiesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.arp_proxies")
