...
type GatewayFirewallClient interface {
	...
	List(orgIdParam string, projectIdParam string, tier1IdParam string) (model.GatewayPolicyListResult, error)
}
...
func NewGatewayFirewallClient(connector client.Connector) *gatewayFirewallClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.gateway_firewall")
...
func (gIface *gatewayFirewallClient) List(orgIdParam string, projectIdParam string, tier1IdParam string) (model.GatewayPolicyListResult, error) {
