...
type IgmpMembershipsClient interface {
	...
	List(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IgmpMemberships, error)
}
...
func NewIgmpMembershipsClient(connector client.Connector) *igmpMembershipsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.multicast.igmp_memberships")
...
func (iIface *igmpMembershipsClient) List(orgIdParam string, projectIdParam string, tier1IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IgmpMemberships, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.tier_1s.locale_services.multicast.igmp_memberships", "list", inputDataValue, executionContext)
	var emptyOutput model.IgmpMemberships
