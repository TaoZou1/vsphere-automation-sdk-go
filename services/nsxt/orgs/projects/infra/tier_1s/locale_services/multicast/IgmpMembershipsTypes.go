...
// Data type definitions file for service: IgmpMemberships.
...
func igmpMembershipsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/tier-1s/{tier1Id}/locale-services/{localeServicesId}/multicast/igmp-memberships",
		"",
		resultHeaders,
		200,
		"",
