...
type ContextProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, contextProfileIdParam string) (model.PolicyContextProfile, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyContextProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, contextProfileIdParam string, policyContextProfileParam model.PolicyContextProfile, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, contextProfileIdParam string, policyContextProfileParam model.PolicyContextProfile, overrideParam *bool) (model.PolicyContextProfile, error)
}
...
func NewContextProfilesClient(connector client.Connector) *contextProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.context_profiles")
...
func (cIface *contextProfilesClient) Get(orgIdParam string, projectIdParam string, contextProfileIdParam string) (model.PolicyContextProfile, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
...
func (cIface *contextProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyContextProfileListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
...
func (cIface *contextProfilesClient) Patch(orgIdParam string, projectIdParam string, contextProfileIdParam string, policyContextProfileParam model.PolicyContextProfile, overrideParam *bool) error {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
...
func (cIface *contextProfilesClient) Update(orgIdParam string, projectIdParam string, contextProfileIdParam string, policyContextProfileParam model.PolicyContextProfile, overrideParam *bool) (model.PolicyContextProfile, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
