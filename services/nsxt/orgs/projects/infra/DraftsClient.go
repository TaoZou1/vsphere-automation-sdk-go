...
type DraftsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, draftIdParam string) (model.PolicyDraft, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyDraftListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam model.PolicyDraft) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Publish(orgIdParam string, projectIdParam string, draftIdParam string, infraParam model.Infra) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam model.PolicyDraft) (model.PolicyDraft, error)
}
...
func NewDraftsClient(connector client.Connector) *draftsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.drafts")
...
func (dIface *draftsClient) Delete(orgIdParam string, projectIdParam string, draftIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.drafts", "delete", inputDataValue, executionContext)
...
func (dIface *draftsClient) Get(orgIdParam string, projectIdParam string, draftIdParam string) (model.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.drafts", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraft
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) List(orgIdParam string, projectIdParam string, autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyDraftListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.drafts", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraftListResult
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) Patch(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam model.PolicyDraft) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *draftsClient) Publish(orgIdParam string, projectIdParam string, draftIdParam string, infraParam model.Infra) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
...
func (dIface *draftsClient) Update(orgIdParam string, projectIdParam string, draftIdParam string, policyDraftParam model.PolicyDraft) (model.PolicyDraft, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.drafts", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraft
	if methodResult.IsSuccess() {
