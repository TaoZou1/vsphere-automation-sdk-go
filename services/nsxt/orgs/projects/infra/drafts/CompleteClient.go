...
func NewCompleteClient(connector client.Connector) *completeClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.drafts.complete")
...
func (cIface *completeClient) Get(orgIdParam string, projectIdParam string, draftIdParam string) (model.Infra, error) {
