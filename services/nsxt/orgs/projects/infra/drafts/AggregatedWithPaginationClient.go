...
type Aggregated_with_paginationClient interface {
	...
	Get(orgIdParam string, projectIdParam string, draftIdParam string, requestIdParam *string, rootPathParam *string) (model.PolicyDraftPaginatedAggregatedConfigurationResult, error)
}
...
func NewAggregated_with_paginationClient(connector client.Connector) *aggregated_with_paginationClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.drafts.aggregated_with_pagination")
...
func (aIface *aggregated_with_paginationClient) Get(orgIdParam string, projectIdParam string, draftIdParam string, requestIdParam *string, rootPathParam *string) (model.PolicyDraftPaginatedAggregatedConfigurationResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.drafts.aggregated_with_pagination", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraftPaginatedAggregatedConfigurationResult
