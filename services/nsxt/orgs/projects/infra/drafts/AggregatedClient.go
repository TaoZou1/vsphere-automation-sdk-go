...
type AggregatedClient interface {
	...
	Get(orgIdParam string, projectIdParam string, draftIdParam string) (model.Infra, error)
}
...
func NewAggregatedClient(connector client.Connector) *aggregatedClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.drafts.aggregated")
...
func (aIface *aggregatedClient) Get(orgIdParam string, projectIdParam string, draftIdParam string) (model.Infra, error) {
