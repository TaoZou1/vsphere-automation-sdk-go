...
type FloodProtectionProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string) (*data.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.FloodProtectionProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string, floodProtectionProfileParam *data.StructValue, overrideParam *bool) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string, floodProtectionProfileParam *data.StructValue, overrideParam *bool) (*data.StructValue, error)
}
...
func NewFloodProtectionProfilesClient(connector client.Connector) *floodProtectionProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.flood_protection_profiles")
...
func (fIface *floodProtectionProfilesClient) Get(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string) (*data.StructValue, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *floodProtectionProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.FloodProtectionProfileListResult, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *floodProtectionProfilesClient) Patch(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string, floodProtectionProfileParam *data.StructValue, overrideParam *bool) error {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
...
func (fIface *floodProtectionProfilesClient) Update(floodProtectionProfileIdParam string, orgIdParam string, projectIdParam string, floodProtectionProfileParam *data.StructValue, overrideParam *bool) (*data.StructValue, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
