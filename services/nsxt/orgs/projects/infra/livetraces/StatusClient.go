...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.livetraces.status", "get", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceStatus
