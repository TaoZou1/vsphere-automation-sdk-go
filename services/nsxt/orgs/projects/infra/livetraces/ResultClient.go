...
type ResultClient interface {
	...
	Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceResult, error)
}
...
func NewResultClient(connector client.Connector) *resultClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.result")
...
func (rIface *resultClient) Get(orgIdParam string, projectIdParam string, livetraceIdParam string, enforcementPointPathParam *string) (model.LiveTraceResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.livetraces.result", "get", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceResult
