...
type StatusesClient interface {
	...
	List(orgIdParam string, projectIdParam string, enforcementPointPathParam *string) (model.LiveTraceListResult, error)
}
...
func NewStatusesClient(connector client.Connector) *statusesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.livetraces.statuses")
...
func (sIface *statusesClient) List(orgIdParam string, projectIdParam string, enforcementPointPathParam *string) (model.LiveTraceListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.livetraces.statuses", "list", inputDataValue, executionContext)
	var emptyOutput model.LiveTraceListResult
