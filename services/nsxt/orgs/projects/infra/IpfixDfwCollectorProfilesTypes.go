...
func ipfixDfwCollectorProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-dfw-collector-profiles/{ipfixDfwCollectorProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipfixDfwCollectorProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-dfw-collector-profiles",
		"",
		resultHeaders,
		200,
		"",
