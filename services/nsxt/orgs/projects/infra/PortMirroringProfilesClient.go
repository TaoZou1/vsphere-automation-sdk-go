...
type PortMirroringProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PortMirroringProfileListResult, error)
...
func NewPortMirroringProfilesClient(connector client.Connector) *portMirroringProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles")
...
func (pIface *portMirroringProfilesClient) Delete(portMirroringProfileIdParam string, orgIdParam string, projectIdParam string, overrideParam *bool) error {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles", "delete", inputDataValue, executionContext)
...
func (pIface *portMirroringProfilesClient) Get(portMirroringProfileIdParam string, orgIdParam string, projectIdParam string) (model.PortMirroringProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.PortMirroringProfile
	if methodResult.IsSuccess() {
...
func (pIface *portMirroringProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PortMirroringProfileListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.PortMirroringProfileListResult
	if methodResult.IsSuccess() {
...
func (pIface *portMirroringProfilesClient) Patch(portMirroringProfileIdParam string, orgIdParam string, projectIdParam string, portMirroringProfileParam model.PortMirroringProfile, overrideParam *bool) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), pIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (pIface *portMirroringProfilesClient) Update(portMirroringProfileIdParam string, orgIdParam string, projectIdParam string, portMirroringProfileParam model.PortMirroringProfile, overrideParam *bool) (model.PortMirroringProfile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.port_mirroring_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.PortMirroringProfile
	if methodResult.IsSuccess() {
