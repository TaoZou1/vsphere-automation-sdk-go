...
type StatsClient interface {
	...
	Reset(orgIdParam string, projectIdParam string, categoryParam string, containerClusterPathParam *string, enforcementPointPathParam *string) error
}
...
func NewStatsClient(connector client.Connector) *statsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.stats")
...
func (sIface *statsClient) Reset(orgIdParam string, projectIdParam string, categoryParam string, containerClusterPathParam *string, enforcementPointPathParam *string) error {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.stats", "reset", inputDataValue, executionContext)
