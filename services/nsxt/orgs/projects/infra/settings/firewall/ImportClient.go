...
type ImportClient interface {
	...
	Cancel(orgIdParam string, projectIdParam string) (model.ImportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string) (model.ImportTask, error)
}
...
func NewImportClient(connector client.Connector) *importClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.import")
...
func (iIface *importClient) Cancel(orgIdParam string, projectIdParam string) (model.ImportTask, error) {
...
func (iIface *importClient) Get(orgIdParam string, projectIdParam string) (model.ImportTask, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
