...
func signaturesListInputType() bindings.StructType {
...
func signaturesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IdsSignatureListResultBindingType)
}

func signaturesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/settings/firewall/security/intrusion-services/signature-versions/{versionId}/signatures",
		"",
		resultHeaders,
		200,
		"",
