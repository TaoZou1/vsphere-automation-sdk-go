...
type SignatureVersionsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, versionIdParam string) (model.IdsSignatureVersion, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdsSignatureVersionListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Makeactiveversion(orgIdParam string, projectIdParam string, idsSignatureVersionParam model.IdsSignatureVersion) error
}
...
func NewSignatureVersionsClient(connector client.Connector) *signatureVersionsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.signature_versions")
...
func (sIface *signatureVersionsClient) Get(orgIdParam string, projectIdParam string, versionIdParam string) (model.IdsSignatureVersion, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.signature_versions", "get", inputDataValue, executionContext)
	var emptyOutput model.IdsSignatureVersion
...
func (sIface *signatureVersionsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdsSignatureVersionListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.signature_versions", "list", inputDataValue, executionContext)
	var emptyOutput model.IdsSignatureVersionListResult
	if methodResult.IsSuccess() {
...
func (sIface *signatureVersionsClient) Makeactiveversion(orgIdParam string, projectIdParam string, idsSignatureVersionParam model.IdsSignatureVersion) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.intrusion_services.signature_versions", "makeactiveversion", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), sIface.GetErrorBindingType(methodResult.Error().Name()))
