...
type ExcludeListClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get0(orgIdParam string, projectIdParam string) (model.PolicyExcludeList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, policyExcludeListParam model.PolicyExcludeList) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, policyExcludeListParam model.PolicyExcludeList) (model.PolicyExcludeList, error)
}
...
func (eIface *excludeListClient) Get0(orgIdParam string, projectIdParam string) (model.PolicyExcludeList, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.exclude_list", "get_0", inputDataValue, executionContext)
	var emptyOutput model.PolicyExcludeList
	if methodResult.IsSuccess() {
...
func (eIface *excludeListClient) Patch(orgIdParam string, projectIdParam string, policyExcludeListParam model.PolicyExcludeList) error {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.exclude_list", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), eIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (eIface *excludeListClient) Update(orgIdParam string, projectIdParam string, policyExcludeListParam model.PolicyExcludeList) (model.PolicyExcludeList, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	eIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.security.exclude_list", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyExcludeList
	if methodResult.IsSuccess() {
