...
func statusGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IdsSignatureStatusBindingType)
}
...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/settings/firewall/security/intrusion-services/signatures/status",
		"",
		resultHeaders,
		200,
		"",
