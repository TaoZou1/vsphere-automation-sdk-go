...
type ExportClient interface {
	...
	Cancel(orgIdParam string, projectIdParam string) (model.ExportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Create(orgIdParam string, projectIdParam string, exportRequestParameterParam model.ExportRequestParameter) (model.ExportTask, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string) (model.ExportTask, error)
}
...
func NewExportClient(connector client.Connector) *exportClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.settings.firewall.export")
...
func (eIface *exportClient) Cancel(orgIdParam string, projectIdParam string) (model.ExportTask, error) {
...
func (eIface *exportClient) Create(orgIdParam string, projectIdParam string, exportRequestParameterParam model.ExportRequestParameter) (model.ExportTask, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
...
func (eIface *exportClient) Get(orgIdParam string, projectIdParam string) (model.ExportTask, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
