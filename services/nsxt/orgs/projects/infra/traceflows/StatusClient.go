...
type StatusClient interface {
	...
	Get(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (model.Traceflow, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.traceflows.status")
...
func (sIface *statusClient) Get(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (model.Traceflow, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.traceflows.status", "get", inputDataValue, executionContext)
	var emptyOutput model.Traceflow
