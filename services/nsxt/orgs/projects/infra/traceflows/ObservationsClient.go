...
type ObservationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (model.TraceflowObservationListResult, error)
}
...
func NewObservationsClient(connector client.Connector) *observationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.traceflows.observations")
...
func (oIface *observationsClient) List(orgIdParam string, projectIdParam string, traceflowIdParam string, enforcementPointPathParam *string) (model.TraceflowObservationListResult, error) {
	...
	methodResult := oIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.traceflows.observations", "list", inputDataValue, executionContext)
	var emptyOutput model.TraceflowObservationListResult
