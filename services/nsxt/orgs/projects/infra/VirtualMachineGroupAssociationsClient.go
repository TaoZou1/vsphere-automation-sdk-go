...
type VirtualMachineGroupAssociationsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyResourceReferenceForEPListResult, error)
}
...
func NewVirtualMachineGroupAssociationsClient(connector client.Connector) *virtualMachineGroupAssociationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.virtual_machine_group_associations")
...
func (vIface *virtualMachineGroupAssociationsClient) List(orgIdParam string, projectIdParam string, vmExternalIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyResourceReferenceForEPListResult, error) {
