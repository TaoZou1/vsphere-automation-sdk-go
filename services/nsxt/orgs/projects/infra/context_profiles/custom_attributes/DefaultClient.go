...
type DefaultClient interface {
	...
	Create(orgIdParam string, projectIdParam string, policyCustomAttributesParam model.PolicyCustomAttributes, actionParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, attributeKeyParam *string, attributeSourceParam *string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyContextProfileListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, policyCustomAttributesParam model.PolicyCustomAttributes) error
}
...
func NewDefaultClient(connector client.Connector) *defaultClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.context_profiles.custom_attributes.default")
...
func (dIface *defaultClient) Create(orgIdParam string, projectIdParam string, policyCustomAttributesParam model.PolicyCustomAttributes, actionParam string) error {
...
func (dIface *defaultClient) Patch(orgIdParam string, projectIdParam string, policyCustomAttributesParam model.PolicyCustomAttributes) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
