...
func physicalServerGroupAssociationsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyResourceReferenceForEPListResultBindingType)
}

func physicalServerGroupAssociationsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/physical-server-group-associations",
		"",
		resultHeaders,
		200,
		"",
