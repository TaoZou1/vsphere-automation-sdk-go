...
type MetadataProxiesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.MetadataProxyConfigListResult, error)
...
func NewMetadataProxiesClient(connector client.Connector) *metadataProxiesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies")
...
func (mIface *metadataProxiesClient) Delete(metadataProxyIdParam string, orgIdParam string, projectIdParam string) error {
	...
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies", "delete", inputDataValue, executionContext)
...
func (mIface *metadataProxiesClient) Get(metadataProxyIdParam string, orgIdParam string, projectIdParam string) (model.MetadataProxyConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	mIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies", "get", inputDataValue, executionContext)
	var emptyOutput model.MetadataProxyConfig
	if methodResult.IsSuccess() {
...
func (mIface *metadataProxiesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.MetadataProxyConfigListResult, error) {
	typeConverter := mIface.connector.TypeConverter()
	executionContext := mIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	mIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies", "list", inputDataValue, executionContext)
	var emptyOutput model.MetadataProxyConfigListResult
	if methodResult.IsSuccess() {
...
func (mIface *metadataProxiesClient) Patch(metadataProxyIdParam string, orgIdParam string, projectIdParam string, metadataProxyConfigParam model.MetadataProxyConfig) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	mIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), mIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (mIface *metadataProxiesClient) Update(metadataProxyIdParam string, orgIdParam string, projectIdParam string, metadataProxyConfigParam model.MetadataProxyConfig) (model.MetadataProxyConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	mIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := mIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies", "update", inputDataValue, executionContext)
	var emptyOutput model.MetadataProxyConfig
	if methodResult.IsSuccess() {
