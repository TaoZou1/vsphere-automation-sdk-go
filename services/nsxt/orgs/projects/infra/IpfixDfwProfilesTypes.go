...
func ipfixDfwProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-dfw-profiles/{ipfixDfwProfileId}",
		"",
		resultHeaders,
		204,
		"",
...
func ipfixDfwProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/infra/ipfix-dfw-profiles",
		"",
		resultHeaders,
		200,
		"",
