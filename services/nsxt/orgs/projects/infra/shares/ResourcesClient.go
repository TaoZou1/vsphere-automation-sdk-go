...
func NewResourcesClient(connector client.Connector) *resourcesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.shares.resources")
...
func (rIface *resourcesClient) Delete(orgIdParam string, projectIdParam string, shareIdParam string, sharedResourceIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.shares.resources", "delete", inputDataValue, executionContext)
...
func (rIface *resourcesClient) Get(shareIdParam string, sharedResourceIdParam string, orgIdParam string, projectIdParam string) (model.SharedResource, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.shares.resources", "get", inputDataValue, executionContext)
	var emptyOutput model.SharedResource
	if methodResult.IsSuccess() {
...
func (rIface *resourcesClient) List(shareIdParam string, orgIdParam string, projectIdParam string, resourceTypeParam *string) (model.SharedResourceListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.shares.resources", "list", inputDataValue, executionContext)
	var emptyOutput model.SharedResourceListResult
	if methodResult.IsSuccess() {
...
func (rIface *resourcesClient) Patch(shareIdParam string, sharedResourceIdParam string, orgIdParam string, projectIdParam string, sharedResourceParam model.SharedResource) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.shares.resources", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *resourcesClient) Update(shareIdParam string, sharedResourceIdParam string, orgIdParam string, projectIdParam string, sharedResourceParam model.SharedResource) (model.SharedResource, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.shares.resources", "update", inputDataValue, executionContext)
	var emptyOutput model.SharedResource
	if methodResult.IsSuccess() {
