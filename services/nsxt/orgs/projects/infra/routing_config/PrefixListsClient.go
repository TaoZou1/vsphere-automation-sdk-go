...
type PrefixListsClient interface {
	...
	Delete(orgIdParam string, projectIdParam string, prefixListIdParam string) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, prefixListIdParam string) (model.PrefixList, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PrefixListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, prefixListIdParam string, prefixListParam model.PrefixList) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, prefixListIdParam string, prefixListParam model.PrefixList) (model.PrefixList, error)
}
...
func NewPrefixListsClient(connector client.Connector) *prefixListsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists")
...
func (pIface *prefixListsClient) Delete(orgIdParam string, projectIdParam string, prefixListIdParam string) error {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists", "delete", inputDataValue, executionContext)
...
func (pIface *prefixListsClient) Get(orgIdParam string, projectIdParam string, prefixListIdParam string) (model.PrefixList, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists", "get", inputDataValue, executionContext)
	var emptyOutput model.PrefixList
	if methodResult.IsSuccess() {
...
func (pIface *prefixListsClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PrefixListResult, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists", "list", inputDataValue, executionContext)
	var emptyOutput model.PrefixListResult
	if methodResult.IsSuccess() {
...
func (pIface *prefixListsClient) Patch(orgIdParam string, projectIdParam string, prefixListIdParam string, prefixListParam model.PrefixList) error {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), pIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (pIface *prefixListsClient) Update(orgIdParam string, projectIdParam string, prefixListIdParam string, prefixListParam model.PrefixList) (model.PrefixList, error) {
	typeConverter := pIface.connector.TypeConverter()
	executionContext := pIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.routing_config.prefix_lists", "update", inputDataValue, executionContext)
	var emptyOutput model.PrefixList
	if methodResult.IsSuccess() {
