...
type IpSubnetsClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string) (*data.StructValue, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, ipPoolIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IpAddressPoolSubnetListResult, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *data.StructValue) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *data.StructValue) (*data.StructValue, error)
}
...
func NewIpSubnetsClient(connector client.Connector) *ipSubnetsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ip_pools.ip_subnets")
...
func (iIface *ipSubnetsClient) Get(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string) (*data.StructValue, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
...
func (iIface *ipSubnetsClient) List(orgIdParam string, projectIdParam string, ipPoolIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IpAddressPoolSubnetListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
...
func (iIface *ipSubnetsClient) Patch(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *data.StructValue) error {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
...
func (iIface *ipSubnetsClient) Update(orgIdParam string, projectIdParam string, ipPoolIdParam string, ipSubnetIdParam string, ipAddressPoolSubnetParam *data.StructValue) (*data.StructValue, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
