...
type IpfixL2ProfilesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IPFIXL2ProfileListResult, error)
...
func NewIpfixL2ProfilesClient(connector client.Connector) *ipfixL2ProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles")
...
func (iIface *ipfixL2ProfilesClient) Delete(ipfixL2ProfileIdParam string, orgIdParam string, projectIdParam string, overrideParam *bool) error {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles", "delete", inputDataValue, executionContext)
...
func (iIface *ipfixL2ProfilesClient) Get(ipfixL2ProfileIdParam string, orgIdParam string, projectIdParam string) (model.IPFIXL2Profile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles", "get", inputDataValue, executionContext)
	var emptyOutput model.IPFIXL2Profile
	if methodResult.IsSuccess() {
...
func (iIface *ipfixL2ProfilesClient) List(orgIdParam string, projectIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IPFIXL2ProfileListResult, error) {
	typeConverter := iIface.connector.TypeConverter()
	executionContext := iIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles", "list", inputDataValue, executionContext)
	var emptyOutput model.IPFIXL2ProfileListResult
	if methodResult.IsSuccess() {
...
func (iIface *ipfixL2ProfilesClient) Patch(ipfixL2ProfileIdParam string, orgIdParam string, projectIdParam string, iPFIXL2ProfileParam model.IPFIXL2Profile, overrideParam *bool) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), iIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (iIface *ipfixL2ProfilesClient) Update(ipfixL2ProfileIdParam string, orgIdParam string, projectIdParam string, iPFIXL2ProfileParam model.IPFIXL2Profile, overrideParam *bool) (model.IPFIXL2Profile, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	iIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.ipfix_l2_profiles", "update", inputDataValue, executionContext)
	var emptyOutput model.IPFIXL2Profile
	if methodResult.IsSuccess() {
