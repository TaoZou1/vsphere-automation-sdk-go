...
type StatisticsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, metadataProxyIdParam string, enforcementPointPathParam *string, segmentPathParam *string, sourceParam *string) (model.PolicyMetadataProxyStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies.statistics")
...
func (sIface *statisticsClient) Get(orgIdParam string, projectIdParam string, metadataProxyIdParam string, enforcementPointPathParam *string, segmentPathParam *string, sourceParam *string) (model.PolicyMetadataProxyStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.infra.metadata_proxies.statistics", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyMetadataProxyStatistics
