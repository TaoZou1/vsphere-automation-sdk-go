...
type QueryClient interface {
	...
	List(orgIdParam string, projectIdParam string, queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SearchResponse, error)
}
...
func NewQueryClient(connector client.Connector) *queryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.search.query")
...
func (qIface *queryClient) List(orgIdParam string, projectIdParam string, queryParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SearchResponse, error) {
	...
	methodResult := qIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.search.query", "list", inputDataValue, executionContext)
	var emptyOutput model.SearchResponse
