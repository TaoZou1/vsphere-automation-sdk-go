...
type UserInfoClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string) (model.UserInfo, error)
}
...
func NewUserInfoClient(connector client.Connector) *userInfoClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.aaa.user_info")
...
func (uIface *userInfoClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string) (model.UserInfo, error) {
