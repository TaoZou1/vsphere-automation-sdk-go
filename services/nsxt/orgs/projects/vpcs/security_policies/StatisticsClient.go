...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.security_policies.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.SecurityPolicyStatisticsListResult, error) {
