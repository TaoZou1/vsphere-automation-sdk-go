...
func NewSubnetPortsClient(connector client.Connector) *subnetPortsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.groups.members.subnet_ports")
...
func (sIface *subnetPortsClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (sIface *subnetPortsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyGroupMembersListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(subnetPortsListInputType(), typeConverter)
