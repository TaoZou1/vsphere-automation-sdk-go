...
type VirtualMachinesClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RealizedVirtualMachineListResult, error)
}
...
func NewVirtualMachinesClient(connector client.Connector) *virtualMachinesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.groups.members.virtual_machines")
...
func (vIface *virtualMachinesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RealizedVirtualMachineListResult, error) {
