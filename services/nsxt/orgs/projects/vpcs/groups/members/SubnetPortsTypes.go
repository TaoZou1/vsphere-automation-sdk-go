...
// Data type definitions file for service: SubnetPorts.
...
func subnetPortsListInputType() bindings.StructType {
...
func subnetPortsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyGroupMembersListResultBindingType)
}

func subnetPortsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/groups/{groupId}/members/subnet-ports",
		"",
		resultHeaders,
		200,
		"",
