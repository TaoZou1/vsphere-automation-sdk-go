...
type TagOperationsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, operationIdParam string) (model.TagBulkOperation, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(orgIdParam string, projectIdParam string, vpcIdParam string, operationIdParam string, tagBulkOperationParam model.TagBulkOperation) (model.TagBulkOperation, error)
}
...
func NewTagOperationsClient(connector client.Connector) *tagOperationsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.tags.tag_operations")
...
func (tIface *tagOperationsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, operationIdParam string) (model.TagBulkOperation, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.tags.tag_operations", "get", inputDataValue, executionContext)
	var emptyOutput model.TagBulkOperation
...
func (tIface *tagOperationsClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, operationIdParam string, tagBulkOperationParam model.TagBulkOperation) (model.TagBulkOperation, error) {
	typeConverter := tIface.connector.TypeConverter()
	executionContext := tIface.connector.NewExecutionContext()
	...
	connectionMetadata["isStreamingResponse"] = false
	tIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.tags.tag_operations", "update", inputDataValue, executionContext)
	var emptyOutput model.TagBulkOperation
	if methodResult.IsSuccess() {
