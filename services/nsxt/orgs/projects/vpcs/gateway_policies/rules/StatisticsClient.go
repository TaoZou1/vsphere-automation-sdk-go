...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.gateway_policies.rules.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, gatewayPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.RuleStatisticsListResult, error) {
