...
type StatsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string) (model.DhcpServerStatistics, error)
}
...
func NewStatsClient(connector client.Connector) *statsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_server_config.stats")
...
func (sIface *statsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string) (model.DhcpServerStatistics, error) {
