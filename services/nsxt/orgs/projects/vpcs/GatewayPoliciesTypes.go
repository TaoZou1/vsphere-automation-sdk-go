...
func gatewayPoliciesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/gateway-policies/{gatewayPolicyId}",
		"",
		resultHeaders,
		204,
		"",
...
func gatewayPoliciesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/orgs/{orgId}/projects/{projectId}/vpcs/{vpcId}/gateway-policies",
		"",
		resultHeaders,
		200,
		"",
