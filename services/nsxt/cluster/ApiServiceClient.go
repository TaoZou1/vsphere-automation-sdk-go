...
func NewApiServiceClient(connector client.Connector) *apiServiceClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.api_service")
...
func (aIface *apiServiceClient) Get() (model.ApiServiceConfig, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.api_service", "get", inputDataValue, executionContext)
	var emptyOutput model.ApiServiceConfig
...
func (aIface *apiServiceClient) Update(apiServiceConfigParam model.ApiServiceConfig) (model.ApiServiceConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	aIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.api_service", "update", inputDataValue, executionContext)
	var emptyOutput model.ApiServiceConfig
	if methodResult.IsSuccess() {
