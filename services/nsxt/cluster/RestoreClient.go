...
func NewRestoreClient(connector client.Connector) *restoreClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.cluster.restore")
...
func (rIface *restoreClient) Advance(advanceClusterRestoreRequestParam model.AdvanceClusterRestoreRequest) (model.ClusterRestoreStatus, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.restore", "advance", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
...
func (rIface *restoreClient) Cancel() (model.ClusterRestoreStatus, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.restore", "cancel", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
	if methodResult.IsSuccess() {
...
func (rIface *restoreClient) Retry() (model.ClusterRestoreStatus, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.restore", "retry", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
	if methodResult.IsSuccess() {
...
func (rIface *restoreClient) Start(initiateClusterRestoreRequestParam model.InitiateClusterRestoreRequest) (model.ClusterRestoreStatus, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.restore", "start", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
	if methodResult.IsSuccess() {
...
func (rIface *restoreClient) Suspend() (model.ClusterRestoreStatus, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.cluster.restore", "suspend", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
	if methodResult.IsSuccess() {
