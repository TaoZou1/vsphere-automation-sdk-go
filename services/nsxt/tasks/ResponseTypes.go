...
// Data type definitions file for service: Response.
...
func responseGetInputType() bindings.StructType {
...
func responseGetOutputType() bindings.BindingType {
	return bindings.NewDynamicStructType(nil, bindings.REST)
}

func responseGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/tasks/{taskId}/response",
		"",
		resultHeaders,
		200,
		"",
