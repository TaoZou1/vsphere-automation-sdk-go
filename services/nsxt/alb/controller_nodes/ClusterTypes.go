...
func clusterGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ALBControllerClusterInfoBindingType)
}
...
func clusterUpdateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ALBControllerClusterTriggerBindingType)
}
