...
func statusGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ALBControllerNodeVMDeploymentStatusReportBindingType)
}
...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/alb/controller-nodes/deployments/{nodeId}/status",
		"",
		resultHeaders,
		200,
		"",
