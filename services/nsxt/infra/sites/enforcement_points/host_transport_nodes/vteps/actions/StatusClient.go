...
type StatusClient interface {
	...
	List(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (model.TransportNodeVtepActionsStatusListResult, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.host_transport_nodes.vteps.actions.status")
...
func (sIface *statusClient) List(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (model.TransportNodeVtepActionsStatusListResult, error) {
	...
	if inputError != nil {
		var emptyOutput model.TransportNodeVtepActionsStatusListResult
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.sites.enforcement_points.host_transport_nodes.vteps.actions.status", "list", inputDataValue, executionContext)
	var emptyOutput model.TransportNodeVtepActionsStatusListResult
	if methodResult.IsSuccess() {
		...
		return output.(model.TransportNodeVtepActionsStatusListResult), nil
	} else {
