...
type StateClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(siteIdParam string, enforcementpointIdParam string, mmStateParam *string, statusParam *string, vtepIpParam *string) (model.TransportNodeStateListResult, error)
}
...
func NewStateClient(connector client.Connector) *stateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.host_transport_nodes.state")
...
func (sIface *stateClient) Get(siteIdParam string, enforcementpointIdParam string, hostTransportNodeIdParam string) (model.TransportNodeState, error) {
...
func (sIface *stateClient) List(siteIdParam string, enforcementpointIdParam string, mmStateParam *string, statusParam *string, vtepIpParam *string) (model.TransportNodeStateListResult, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
