...
// Data type definitions file for service: NodeAgentStatus.
...
func nodeAgentStatusListInputType() bindings.StructType {
...
func nodeAgentStatusListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TnNodeAgentStatusListResultBindingType)
}

func nodeAgentStatusListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/enforcement-points/{enforcementPointId}/host-transport-nodes/{nodeId}/node-agent-status",
		"",
		resultHeaders,
		200,
		"",
