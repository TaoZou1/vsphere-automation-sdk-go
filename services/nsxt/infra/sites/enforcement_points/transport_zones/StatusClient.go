...
type StatusClient interface {
	...
	Get(siteIdParam string, enforcementPointIdParam string, zoneIdParam string, sourceParam *string) (model.HeatMapTransportZoneStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sites.enforcement_points.transport_zones.status")
...
func (sIface *statusClient) Get(siteIdParam string, enforcementPointIdParam string, zoneIdParam string, sourceParam *string) (model.HeatMapTransportZoneStatus, error) {
