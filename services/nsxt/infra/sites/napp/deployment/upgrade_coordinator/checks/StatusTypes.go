...
func statusGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DeploymentChecksStatusResultBindingType)
}
...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sites/{siteId}/napp/deployment/upgrade-coordinator/checks/status",
		"",
		resultHeaders,
		200,
		"",
