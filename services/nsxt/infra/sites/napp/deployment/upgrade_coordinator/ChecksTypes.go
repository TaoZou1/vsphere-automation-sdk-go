...
func checksUpdateInputType() bindings.StructType {
	...
	fields["deployment_checks_action"] = bindings.NewReferenceType(model.DeploymentChecksActionBindingType)
...
func checksUpdateRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["deployment_checks_action"] = bindings.NewReferenceType(model.DeploymentChecksActionBindingType)
