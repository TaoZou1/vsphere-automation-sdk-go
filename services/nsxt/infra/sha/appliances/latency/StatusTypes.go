...
func statusGetInputType() bindings.StructType {
	...
	fields["appliance_id"] = bindings.NewStringType()
	fieldNameMap["appliance_id"] = "ApplianceId"
	var validators = []bindings.Validator{}
	return bindings.NewStructType("operation-input", fields, reflect.TypeOf(data.StructValue{}), fieldNameMap, validators)
}

func statusGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ApplianceLatencyDataBindingType)
}
...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	fields["appliance_id"] = bindings.NewStringType()
	fieldNameMap["appliance_id"] = "ApplianceId"
	paramsTypeMap["appliance_id"] = bindings.NewStringType()
	paramsTypeMap["applianceId"] = bindings.NewStringType()
	pathParams["appliance_id"] = "applianceId"
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sha/appliances/{applianceId}/latency/status",
		"",
		resultHeaders,
		200,
		"",
...
func statusListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ApplianceLatencyListResultBindingType)
}
...
func statusListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/sha/appliances/latency/status",
		"",
		resultHeaders,
		200,
		"",
