...
type EffectiveProfilesClient interface {
	...
	Get(segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error)
}
...
func NewEffectiveProfilesClient(connector client.Connector) *effectiveProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.segments.effective_profiles")
...
func (eIface *effectiveProfilesClient) Get(segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error) {
