...
type SharesClient interface {
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Patch(shareIdParam string, shareParam model.Share) error
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Update(shareIdParam string, shareParam model.Share) (model.Share, error)
}
...
func (sIface *sharesClient) Patch(shareIdParam string, shareParam model.Share) error {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
...
func (sIface *sharesClient) Update(shareIdParam string, shareParam model.Share) (model.Share, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
