...
// Data type definitions file for service: MemberGroups.
...
func memberGroupsListInputType() bindings.StructType {
...
func memberGroupsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DirectoryGroupMemberListResultsBindingType)
}

func memberGroupsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/firewall-identity-stores/{firewallIdentityStoreId}/groups/{groupId}/member-groups",
		"",
		resultHeaders,
		200,
		"",
