...
// Data type definitions file for service: SyncStats.
...
func syncStatsGetInputType() bindings.StructType {
...
func syncStatsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DirectoryDomainSyncStatsBindingType)
}

func syncStatsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/firewall-identity-stores/{firewallIdentityStoreId}/sync-stats",
		"",
		resultHeaders,
		200,
		"",
