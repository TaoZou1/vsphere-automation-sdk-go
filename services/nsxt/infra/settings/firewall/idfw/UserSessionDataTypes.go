...
// Data type definitions file for service: UserSessionData.
...
func userSessionDataGetInputType() bindings.StructType {
...
func userSessionDataGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IdfwUserSessionDataAndMappingsBindingType)
}

func userSessionDataGetRestMetadata() protocol.OperationRestMetadata {
