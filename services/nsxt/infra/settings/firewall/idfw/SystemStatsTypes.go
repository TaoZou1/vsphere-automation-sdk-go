...
// Data type definitions file for service: SystemStats.
...
func systemStatsGetInputType() bindings.StructType {
...
func systemStatsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IdfwSystemStatsBindingType)
}

func systemStatsGetRestMetadata() protocol.OperationRestMetadata {
