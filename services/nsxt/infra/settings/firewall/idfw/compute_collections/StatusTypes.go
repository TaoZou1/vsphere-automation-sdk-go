...
func statusGetInputType() bindings.StructType {
	...
	fields["compute_collection_id"] = bindings.NewStringType()
...
func statusGetRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["compute_collection_id"] = bindings.NewStringType()
	paramsTypeMap["computeCollectionId"] = bindings.NewStringType()
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/settings/firewall/idfw/compute-collections/{computeCollectionId}/status",
		"",
		resultHeaders,
		200,
		"",
