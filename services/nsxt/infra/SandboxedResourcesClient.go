...
type SandboxedResourcesClient interface {
	...
	List(intentPathParam *string, sitePathParam *string) (model.SandboxedResourceListResult, error)
}
...
func NewSandboxedResourcesClient(connector client.Connector) *sandboxedResourcesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.sandboxed_resources")
...
func (sIface *sandboxedResourcesClient) List(intentPathParam *string, sitePathParam *string) (model.SandboxedResourceListResult, error) {
