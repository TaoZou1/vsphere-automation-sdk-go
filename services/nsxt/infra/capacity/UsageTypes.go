...
// Data type definitions file for service: Usage.
...
func usageGetInputType() bindings.StructType {
...
func usageGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyCapacityUsageResponseBindingType)
}

func usageGetRestMetadata() protocol.OperationRestMetadata {
