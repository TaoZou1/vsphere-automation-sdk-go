...
type FirewallIpReputationFeedClient interface {
	...
	Create(operationParam string) (model.PolicyFirewallIpReputationConfig, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get() (model.PolicyFirewallIpReputationConfig, error)
}
...
func NewFirewallIpReputationFeedClient(connector client.Connector) *firewallIpReputationFeedClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.firewall_ip_reputation_feed")
...
func (fIface *firewallIpReputationFeedClient) Create(operationParam string) (model.PolicyFirewallIpReputationConfig, error) {
...
func (fIface *firewallIpReputationFeedClient) Get() (model.PolicyFirewallIpReputationConfig, error) {
	typeConverter := fIface.connector.TypeConverter()
	executionContext := fIface.connector.NewExecutionContext()
