...
type TagsClient interface {
	...
	Create(virtualMachineIdParam string, virtualMachineTagsUpdateParam model.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error
}
...
func NewTagsClient(connector client.Connector) *tagsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.realized_state.virtual_machines.tags")
...
func (tIface *tagsClient) Create(virtualMachineIdParam string, virtualMachineTagsUpdateParam model.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.realized_state.virtual_machines.tags", "create", inputDataValue, executionContext)
