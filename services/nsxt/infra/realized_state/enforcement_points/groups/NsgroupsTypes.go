...
func nsgroupsGetInputType() bindings.StructType {
	...
	fields["nsgroup_name"] = bindings.NewStringType()
	fieldNameMap["enforcement_point_name"] = "EnforcementPointName"
	fieldNameMap["nsgroup_name"] = "NsgroupName"
...
func nsgroupsGetRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["nsgroup_name"] = bindings.NewStringType()
	paramsTypeMap["enforcementPointName"] = bindings.NewStringType()
	paramsTypeMap["nsgroupName"] = bindings.NewStringType()
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/realized-state/enforcement-points/{enforcementPointName}/groups/nsgroups/{nsgroupName}",
		"",
		resultHeaders,
		200,
		"",
...
func nsgroupsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/realized-state/enforcement-points/{enforcementPointName}/groups/nsgroups",
		"",
		resultHeaders,
		200,
		"",
