...
func NewVirtualMachinesClient(connector client.Connector) *virtualMachinesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.groups.members.virtual_machines")
...
func (vIface *virtualMachinesClient) List(tier0IdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.RealizedVirtualMachineListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.groups.members.virtual_machines", "list", inputDataValue, executionContext)
	var emptyOutput model.RealizedVirtualMachineListResult
