...
func NewSummaryClient(connector client.Connector) *summaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.tier_1_interface.statistics.summary")
...
func (sIface *summaryClient) Get(tier0IdParam string, tier1PathParam string, cursorParam *string, edgePathParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyInterfaceStatisticsSummary, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.tier_1_interface.statistics.summary", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyInterfaceStatisticsSummary
