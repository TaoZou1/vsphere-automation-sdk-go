...
type StatisticsClient interface {
	...
	Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.AggregateL2VpnStatistics, error)
}
...
func (sIface *statisticsClient) Get(tier0IdParam string, localeServiceIdParam string, l2vpnIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.AggregateL2VpnStatistics, error) {
