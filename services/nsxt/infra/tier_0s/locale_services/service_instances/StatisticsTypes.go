...
func statisticsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyServiceInstanceStatisticsBindingType)
}
...
func statisticsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/service-instances/{serviceInstanceId}/statistics",
		"",
		resultHeaders,
		200,
		"",
