...
type IgmpMembershipsClient interface {
	...
	List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IgmpMemberships, error)
}
...
func NewIgmpMembershipsClient(connector client.Connector) *igmpMembershipsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_0s.locale_services.multicast.igmp_memberships")
...
func (iIface *igmpMembershipsClient) List(tier0IdParam string, localeServicesIdParam string, cursorParam *string, edgePathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IgmpMemberships, error) {
	...
	methodResult := iIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.tier_0s.locale_services.multicast.igmp_memberships", "list", inputDataValue, executionContext)
	var emptyOutput model.IgmpMemberships
