...
type UsersClient interface {
	...
	List(identityFirewallStoreIdParam string, filterValueParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdentityFirewallStoreUserOrGrouptListResults, error)
}
...
func NewUsersClient(connector client.Connector) *usersClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.identity_firewall_stores.users")
...
func (uIface *usersClient) List(identityFirewallStoreIdParam string, filterValueParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdentityFirewallStoreUserOrGrouptListResults, error) {
