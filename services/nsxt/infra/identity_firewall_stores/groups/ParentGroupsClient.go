...
type ParentGroupsClient interface {
	...
	List(identityFirewallStoreIdParam string, groupIdParam string) (model.IdentityFirewallStoreUserOrGrouptListResults, error)
}
...
func NewParentGroupsClient(connector client.Connector) *parentGroupsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.identity_firewall_stores.groups.parent_groups")
...
func (pIface *parentGroupsClient) List(identityFirewallStoreIdParam string, groupIdParam string) (model.IdentityFirewallStoreUserOrGrouptListResults, error) {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.identity_firewall_stores.groups.parent_groups", "list", inputDataValue, executionContext)
	var emptyOutput model.IdentityFirewallStoreUserOrGrouptListResults
