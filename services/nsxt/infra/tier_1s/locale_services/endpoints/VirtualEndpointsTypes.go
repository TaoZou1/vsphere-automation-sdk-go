...
func virtualEndpointsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/endpoints/virtual-endpoints/{virtualEndpointId}",
		"",
		resultHeaders,
		204,
		"",
...
func virtualEndpointsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/locale-services/{localeServiceId}/endpoints/virtual-endpoints",
		"",
		resultHeaders,
		200,
		"",
