...
func mirrorStackStatusListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/tier-1s/{tier1Id}/segments/{segmentId}/ports/{portId}/port-monitoring-profile-binding-maps/{portMonitoringProfileBindingMapId}/mirror-stack-status",
		"",
		resultHeaders,
		200,
		"",
