...
type EffectiveProfilesClient interface {
	...
	Get(tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error)
}
...
func NewEffectiveProfilesClient(connector client.Connector) *effectiveProfilesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.tier_1s.segments.effective_profiles")
...
func (eIface *effectiveProfilesClient) Get(tier1IdParam string, segmentIdParam string, enforcementPointPathParam *string) (model.EffectiveProfilesResponse, error) {
