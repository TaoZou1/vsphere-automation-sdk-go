...
type StatusClient interface {
	...
	Get(traceflowIdParam string, enforcementPointPathParam *string) (model.AntreaTraceflowStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.antrea.traceflows.status")
...
func (sIface *statusClient) Get(traceflowIdParam string, enforcementPointPathParam *string) (model.AntreaTraceflowStatus, error) {
	...
	if inputError != nil {
		var emptyOutput model.AntreaTraceflowStatus
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.antrea.traceflows.status", "get", inputDataValue, executionContext)
	var emptyOutput model.AntreaTraceflowStatus
	if methodResult.IsSuccess() {
		...
		return output.(model.AntreaTraceflowStatus), nil
	} else {
