...
type StatisticsClient interface {
	...
	List(domainIdParam string, policyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsSecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, policyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsSecurityPolicyStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput model.IdsSecurityPolicyStatisticsListResult
