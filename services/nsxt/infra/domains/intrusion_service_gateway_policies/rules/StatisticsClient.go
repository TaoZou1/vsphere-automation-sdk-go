...
type StatisticsClient interface {
	...
	List(domainIdParam string, policyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, policyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsRuleStatisticsListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules.statistics", "list", inputDataValue, executionContext)
	var emptyOutput model.IdsRuleStatisticsListResult
