...
func NewRulesClient(connector client.Connector) *rulesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules")
...
func (rIface *rulesClient) Delete(domainIdParam string, policyIdParam string, ruleIdParam string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "delete", inputDataValue, executionContext)
...
func (rIface *rulesClient) Get(domainIdParam string, policyIdParam string, ruleIdParam string) (model.IdsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "get", inputDataValue, executionContext)
	var emptyOutput model.IdsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) List(domainIdParam string, policyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.IdsRuleListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "list", inputDataValue, executionContext)
	var emptyOutput model.IdsRuleListResult
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Patch(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), rIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (rIface *rulesClient) Revise(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule, anchorPathParam *string, operationParam *string) (model.IdsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "revise", inputDataValue, executionContext)
	var emptyOutput model.IdsRule
	if methodResult.IsSuccess() {
...
func (rIface *rulesClient) Update(domainIdParam string, policyIdParam string, ruleIdParam string, idsRuleParam model.IdsRule) (model.IdsRule, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.infra.domains.intrusion_service_gateway_policies.rules", "update", inputDataValue, executionContext)
	var emptyOutput model.IdsRule
	if methodResult.IsSuccess() {
