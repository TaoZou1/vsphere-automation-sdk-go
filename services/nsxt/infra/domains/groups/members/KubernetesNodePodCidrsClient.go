...
func NewKubernetesNodePodCidrsClient(connector client.Connector) *kubernetesNodePodCidrsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.groups.members.kubernetes_node_pod_cidrs")
...
func (kIface *kubernetesNodePodCidrsClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (kIface *kubernetesNodePodCidrsClient) List(domainIdParam string, groupIdParam string, clusterIdParam *string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyGroupPodCidrListResult, error) {
	typeConverter := kIface.connector.TypeConverter()
	executionContext := kIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(kubernetesNodePodCidrsListInputType(), typeConverter)
