...
// Data type definitions file for service: KubernetesNodes.
...
func kubernetesNodesListInputType() bindings.StructType {
...
func kubernetesNodesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyGroupKubernetesNodeListResultBindingType)
}

func kubernetesNodesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/groups/{groupId}/members/kubernetes-nodes",
		"",
		resultHeaders,
		200,
		"",
