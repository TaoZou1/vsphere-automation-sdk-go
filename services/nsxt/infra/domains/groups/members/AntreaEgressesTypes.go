...
// Data type definitions file for service: AntreaEgresses.
...
func antreaEgressesListInputType() bindings.StructType {
...
func antreaEgressesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.PolicyGroupAntreaEgressListResultBindingType)
}

func antreaEgressesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/infra/domains/{domainId}/groups/{groupId}/members/antrea-egresses",
		"",
		resultHeaders,
		200,
		"",
