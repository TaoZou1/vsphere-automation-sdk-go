...
type StatisticsClient interface {
	...
	List(domainIdParam string, forwardingPolicyIdParam string, forwardingRuleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.ForwardingRuleStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.forwarding_policies.rules.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, forwardingPolicyIdParam string, forwardingRuleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.ForwardingRuleStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput model.ForwardingRuleStatisticsListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(model.ForwardingRuleStatisticsListResult), nil
	} else {
