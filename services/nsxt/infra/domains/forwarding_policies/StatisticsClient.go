...
type StatisticsClient interface {
	...
	List(domainIdParam string, forwardingPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.ForwardingPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.infra.domains.forwarding_policies.statistics")
...
func (sIface *statisticsClient) List(domainIdParam string, forwardingPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.ForwardingPolicyStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput model.ForwardingPolicyStatisticsListResult
	...
	if methodResult.IsSuccess() {
		...
		return output.(model.ForwardingPolicyStatisticsListResult), nil
	} else {
