...
type StatisticsClient interface {
	...
	List(domainIdParam string, idsPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsRuleStatisticsListResult, error)
}
...
func (sIface *statisticsClient) List(domainIdParam string, idsPolicyIdParam string, ruleIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (model.IdsRuleStatisticsListResult, error) {
