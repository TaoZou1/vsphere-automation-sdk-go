...
func tlsInspectionConfigProfilesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/security/tls-inspection-config-profiles/{tlsInspectionConfigProfile}",
		"",
		resultHeaders,
		204,
		"",
...
func tlsInspectionConfigProfilesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/security/tls-inspection-config-profiles",
		"",
		resultHeaders,
		200,
		"",
