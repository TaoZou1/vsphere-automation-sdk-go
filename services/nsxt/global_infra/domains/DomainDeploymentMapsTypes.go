...
func domainDeploymentMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/domain-deployment-maps/{domainDeploymentMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func domainDeploymentMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/domain-deployment-maps",
		"",
		resultHeaders,
		200,
		"",
