...
func discoveryProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/groups/{groupId}/discovery-profile-binding-maps/{discoveryProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func discoveryProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/groups/{groupId}/discovery-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
