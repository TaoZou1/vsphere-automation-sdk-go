...
func groupMonitoringProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/groups/{groupId}/group-monitoring-profile-binding-maps/{groupMonitoringProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func groupMonitoringProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/groups/{groupId}/group-monitoring-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
