...
func rulesGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/security-policies/{securityPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		200,
		"",
...
func rulesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/security-policies/{securityPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
