...
func rulesDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/policy/api/v1/global-infra/domains/{domainId}/intrusion-service-policies/{policyId}/rules/{ruleId}",
		"",
		resultHeaders,
		204,
		"",
...
func rulesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/domains/{domainId}/intrusion-service-policies/{policyId}/rules",
		"",
		resultHeaders,
		200,
		"",
