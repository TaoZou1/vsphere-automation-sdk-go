...
func NewDefaultClient(connector client.Connector) *defaultClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default")
...
func (dIface *defaultClient) Create(policyCustomAttributesParam model.PolicyCustomAttributes, actionParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default", "create", inputDataValue, executionContext)
...
func (dIface *defaultClient) List(attributeKeyParam *string, attributeSourceParam *string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyContextProfileListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyContextProfileListResult
	if methodResult.IsSuccess() {
...
func (dIface *defaultClient) Patch(policyCustomAttributesParam model.PolicyCustomAttributes) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.context_profiles.custom_attributes.default", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
