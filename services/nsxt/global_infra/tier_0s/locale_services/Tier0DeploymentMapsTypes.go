...
func tier0DeploymentMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/tier-0-deployment-maps/{tier0DeploymentMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func tier0DeploymentMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServiceId}/tier-0-deployment-maps",
		"",
		resultHeaders,
		200,
		"",
