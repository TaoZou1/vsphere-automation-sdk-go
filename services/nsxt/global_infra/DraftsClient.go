...
func NewDraftsClient(connector client.Connector) *draftsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.drafts")
...
func (dIface *draftsClient) Delete(draftIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "delete", inputDataValue, executionContext)
...
func (dIface *draftsClient) Get(draftIdParam string) (model.PolicyDraft, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "get", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraft
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) List(autoDraftsParam *bool, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.PolicyDraftListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraftListResult
	if methodResult.IsSuccess() {
...
func (dIface *draftsClient) Patch(draftIdParam string, policyDraftParam model.PolicyDraft) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *draftsClient) Publish(draftIdParam string, infraParam model.Infra) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "publish", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *draftsClient) Update(draftIdParam string, policyDraftParam model.PolicyDraft) (model.PolicyDraft, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	dIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.drafts", "update", inputDataValue, executionContext)
	var emptyOutput model.PolicyDraft
	if methodResult.IsSuccess() {
