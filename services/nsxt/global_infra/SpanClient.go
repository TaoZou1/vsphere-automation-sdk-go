...
func NewSpanClient(connector client.Connector) *spanClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.span")
...
func (sIface *spanClient) Get(intentPathParam string, sitePathParam *string) (model.Span, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.span", "get", inputDataValue, executionContext)
	var emptyOutput model.Span
