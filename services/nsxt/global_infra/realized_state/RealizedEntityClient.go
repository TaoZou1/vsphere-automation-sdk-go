...
func NewRealizedEntityClient(connector client.Connector) *realizedEntityClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.realized_state.realized_entity")
...
func (rIface *realizedEntityClient) Refresh(intentPathParam string, enforcementPointPathParam *string) error {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.realized_state.realized_entity", "refresh", inputDataValue, executionContext)
