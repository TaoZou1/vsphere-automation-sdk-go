...
func NewArpProxyClient(connector client.Connector) *arpProxyClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.segments.arp_proxy")
...
func (aIface *arpProxyClient) List(segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.PolicyArpProxyTableListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.segments.arp_proxy", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyArpProxyTableListResult
