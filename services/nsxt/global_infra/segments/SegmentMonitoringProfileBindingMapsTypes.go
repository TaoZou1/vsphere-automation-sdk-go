...
func segmentMonitoringProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{infraSegmentId}/segment-monitoring-profile-binding-maps/{segmentMonitoringProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func segmentMonitoringProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{infraSegmentId}/segment-monitoring-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
