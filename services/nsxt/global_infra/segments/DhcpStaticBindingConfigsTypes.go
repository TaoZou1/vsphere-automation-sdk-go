...
func dhcpStaticBindingConfigsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{segmentId}/dhcp-static-binding-configs/{bindingId}",
		"",
		resultHeaders,
		200,
		"",
...
func dhcpStaticBindingConfigsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{segmentId}/dhcp-static-binding-configs",
		"",
		resultHeaders,
		200,
		"",
