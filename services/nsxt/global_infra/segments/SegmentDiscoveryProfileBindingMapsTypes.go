...
func segmentDiscoveryProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{infraSegmentId}/segment-discovery-profile-binding-maps/{segmentDiscoveryProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func segmentDiscoveryProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/segments/{infraSegmentId}/segment-discovery-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
