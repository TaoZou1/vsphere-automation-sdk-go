...
func (sIface *signatureVersionsClient) Get(versionIdParam string) (model.IdsSignatureVersion, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.signature_versions", "get", inputDataValue, executionContext)
	var emptyOutput model.IdsSignatureVersion
