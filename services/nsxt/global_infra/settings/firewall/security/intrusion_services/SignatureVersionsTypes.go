...
func signatureVersionsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/signature-versions/{versionId}",
		"",
		resultHeaders,
		200,
		"",
...
func signatureVersionsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/settings/firewall/security/intrusion-services/signature-versions",
		"",
		resultHeaders,
		200,
		"",
