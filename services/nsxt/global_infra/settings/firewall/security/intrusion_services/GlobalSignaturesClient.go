...
func NewGlobalSignaturesClient(connector client.Connector) *globalSignaturesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures")
...
func (gIface *globalSignaturesClient) Delete(signatureIdParam string) error {
	...
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures", "delete", inputDataValue, executionContext)
...
func (gIface *globalSignaturesClient) Get(signatureIdParam string) (model.GlobalIdsSignature, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	gIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures", "get", inputDataValue, executionContext)
	var emptyOutput model.GlobalIdsSignature
	if methodResult.IsSuccess() {
...
func (gIface *globalSignaturesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.GlobalIdsSignatureListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	gIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures", "list", inputDataValue, executionContext)
	var emptyOutput model.GlobalIdsSignatureListResult
	if methodResult.IsSuccess() {
...
func (gIface *globalSignaturesClient) Patch(signatureIdParam string, globalIdsSignatureParam model.GlobalIdsSignature) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	gIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), gIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (gIface *globalSignaturesClient) Update(signatureIdParam string, globalIdsSignatureParam model.GlobalIdsSignature) (model.GlobalIdsSignature, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	gIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := gIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.settings.firewall.security.intrusion_services.global_signatures", "update", inputDataValue, executionContext)
	var emptyOutput model.GlobalIdsSignature
	if methodResult.IsSuccess() {
