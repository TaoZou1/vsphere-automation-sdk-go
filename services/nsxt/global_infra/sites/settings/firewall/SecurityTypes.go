...
func securityGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.GlobalDfwConfigurationBindingType)
}
...
func securityGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/policy/api/v1/global-infra/sites/{siteId}/settings/firewall/security",
		"",
		resultHeaders,
		200,
		"",
...
func securityListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func securityListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.GlobalDfwConfigurationListResultBindingType)
}

func securityListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
