...
func NewFederationConfigClient(connector client.Connector) *federationConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.federation_config")
...
func (fIface *federationConfigClient) Get() (model.FederationConfig, error) {
	...
	methodResult := fIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.federation_config", "get", inputDataValue, executionContext)
	var emptyOutput model.FederationConfig
