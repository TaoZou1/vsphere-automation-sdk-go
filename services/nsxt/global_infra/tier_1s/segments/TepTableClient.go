...
func NewTepTableClient(connector client.Connector) *tepTableClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.segments.tep_table")
...
func (tIface *tepTableClient) List(tier1IdParam string, segmentIdParam string, cursorParam *string, enforcementPointPathParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, sourceParam *string, transportNodeIdParam *string) (model.PolicyTepListResult, error) {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.tep_table", "list", inputDataValue, executionContext)
	var emptyOutput model.PolicyTepListResult
