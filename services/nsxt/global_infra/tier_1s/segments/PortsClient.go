...
func NewPortsClient(connector client.Connector) *portsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports")
...
func (pIface *portsClient) Delete(tier1IdParam string, segmentIdParam string, portIdParam string) error {
	...
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports", "delete", inputDataValue, executionContext)
...
func (pIface *portsClient) Get(tier1IdParam string, segmentIdParam string, portIdParam string) (model.SegmentPort, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports", "get", inputDataValue, executionContext)
	var emptyOutput model.SegmentPort
	if methodResult.IsSuccess() {
...
func (pIface *portsClient) List(tier1IdParam string, segmentIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.SegmentPortListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports", "list", inputDataValue, executionContext)
	var emptyOutput model.SegmentPortListResult
	if methodResult.IsSuccess() {
...
func (pIface *portsClient) Patch(tier1IdParam string, segmentIdParam string, portIdParam string, segmentPortParam model.SegmentPort) error {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), pIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (pIface *portsClient) Update(tier1IdParam string, segmentIdParam string, portIdParam string, segmentPortParam model.SegmentPort) (model.SegmentPort, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := pIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.tier_1s.segments.ports", "update", inputDataValue, executionContext)
	var emptyOutput model.SegmentPort
	if methodResult.IsSuccess() {
