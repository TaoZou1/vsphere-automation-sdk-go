...
func NewSecurityGlobalConfigClient(connector client.Connector) *securityGlobalConfigClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_policy.global_infra.security_global_config")
...
func (sIface *securityGlobalConfigClient) Get() (model.InfraSecurityConfig, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.security_global_config", "get", inputDataValue, executionContext)
	var emptyOutput model.InfraSecurityConfig
...
func (sIface *securityGlobalConfigClient) Update(infraSecurityConfigParam model.InfraSecurityConfig) (model.InfraSecurityConfig, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	sIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.global_infra.security_global_config", "update", inputDataValue, executionContext)
	var emptyOutput model.InfraSecurityConfig
	if methodResult.IsSuccess() {
