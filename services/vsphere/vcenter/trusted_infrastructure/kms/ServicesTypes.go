...
type ServicesInfo struct {
    ...
    // The group determines reports issued by which Attestation Service instances this ``Services`` instance can accept. This property was added in vSphere API 7.0.0.
	Group string
    // The cluster determines which Trust Authority Cluster this ``Services`` belongs to. This property was added in vSphere API 7.0.0.
	TrustAuthorityCluster string
}
...
// The ``FilterSpec`` class contains the data necessary for identifying a Key Provider Service instance. This class was added in vSphere API 7.0.0.
