...
import (
	"reflect"
	"github.com/vmware/vsphere-automation-sdk-go/services/vsphere/vcenter/trusted_infrastructure"
...
type ServicesSummary struct {
    ...
    // The group determines reports issued by which ``Services`` instances can this ``Services`` instance accept. This property was added in vSphere API 7.0.0.
	Group string
...
type ServicesCreateSpec struct {
    // Source of truth for the configuration of the Key Provider Service. This property was added in vSphere API 7.0.0.
...
// The ``SourceType`` enumeration class lists options which source the the Key Provider Service to use for its configuration. This enumeration was added in vSphere API 7.0.0.
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type ServicesCreateSpecSourceType string

const (
    // The Key Provider Service will be configured based on an ID of an specific Key Provider Service. This constant field was added in vSphere API 7.0.0.
	ServicesCreateSpecSourceType_SERVICE ServicesCreateSpecSourceType = "SERVICE"
    // The Key Provider Service will be configured based on an ID of a whole attestation cluster. This constant field was added in vSphere API 7.0.0.
...
func ServicesSummaryBindingType() bindings.BindingType {
	...
	var validators = []bindings.Validator{}
	return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.services.summary", fields, reflect.TypeOf(ServicesSummary{}), fieldNameMap, validators)
}
...
func ServicesInfoBindingType() bindings.BindingType {
	...
	fieldNameMap["trust_authority_cluster"] = "TrustAuthorityCluster"
	var validators = []bindings.Validator{}
	return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.services.info", fields, reflect.TypeOf(ServicesInfo{}), fieldNameMap, validators)
}

func ServicesCreateSpecBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["type"] = bindings.NewEnumType("com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.services.create_spec.source_type", reflect.TypeOf(ServicesCreateSpecSourceType(ServicesCreateSpecSourceType_SERVICE)))
...
func ServicesFilterSpecBindingType() bindings.BindingType {
	...
	fieldNameMap["trust_authority_cluster"] = "TrustAuthorityCluster"
	var validators = []bindings.Validator{}
	return bindings.NewStructType("com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.services.filter_spec", fields, reflect.TypeOf(ServicesFilterSpec{}), fieldNameMap, validators)
}
