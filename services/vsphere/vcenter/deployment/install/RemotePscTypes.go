...
func remotePscCheckInputType() bindings.StructType {
...
func remotePscCheckOutputType() bindings.BindingType {
	return bindings.NewReferenceType(deployment.CheckInfoBindingType)
}

func remotePscCheckRestMetadata() protocol.OperationRestMetadata {
