...
/*
 * Client stubs for service: CustomizationSpecs
 * Functions that implement the generated CustomizationSpecsClient interface
 */
...
func NewDefaultCustomizationSpecsClient(connector client.Connector) *DefaultCustomizationSpecsClient {
	...
	methodIdentifiers := []core.MethodIdentifier{
		...
		core.NewMethodIdentifier(interfaceIdentifier, "export"),
		core.NewMethodIdentifier(interfaceIdentifier, "importSpecification"),
	}
	...
	cIface.methodNameToDefMap["export"] = cIface.exportMethodDefinition()
	cIface.methodNameToDefMap["import_specification"] = cIface.importSpecificationMethodDefinition()
	return &cIface
}
...
func (cIface *DefaultCustomizationSpecsClient) List(filterParam *CustomizationSpecsFilterSpec) ([]CustomizationSpecsSummary, error) {
	...
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), customizationSpecsListOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.([]CustomizationSpecsSummary), nil
	} else {
...
func (cIface *DefaultCustomizationSpecsClient) Create(specParam CustomizationSpecsCreateSpec) (string, error) {
	...
	var emptyOutput string
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), customizationSpecsCreateOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
...
func (cIface *DefaultCustomizationSpecsClient) Get(nameParam string) (CustomizationSpecsInfo, error) {
	...
	var emptyOutput CustomizationSpecsInfo
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), customizationSpecsGetOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.(CustomizationSpecsInfo), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.errorBindingMap[methodResult.Error().Name()])
		if errorInError != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInError)
...
func (cIface *DefaultCustomizationSpecsClient) Export(nameParam string, formatParam CustomizationSpecsFormat) (string, error) {
	...
	var emptyOutput string
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), customizationSpecsExportOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.(string), nil
...
func (cIface *DefaultCustomizationSpecsClient) ImportSpecification(customizationSpecParam string) (CustomizationSpecsCreateSpec, error) {
	...
	sv.AddStructField("CustomizationSpec", customizationSpecParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
	...
	var emptyOutput CustomizationSpecsCreateSpec
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), customizationSpecsImportSpecificationOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.(CustomizationSpecsCreateSpec), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.errorBindingMap[methodResult.Error().Name()])
		if errorInError != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInError)
...
func (cIface *DefaultCustomizationSpecsClient) exportMethodDefinition() *core.MethodDefinition {
	...
	methodIdentifier := core.NewMethodIdentifier(interfaceIdentifier, "export")
	errorDefinitions := make([]data.ErrorDefinition, 0)
	cIface.errorBindingMap[errors.InvalidArgument{}.Error()] = errors.InvalidArgumentBindingType()
	errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.InvalidArgumentBindingType())
	if errError1 != nil {
...
func (cIface *DefaultCustomizationSpecsClient) importSpecificationMethodDefinition() *core.MethodDefinition {
	...
	methodIdentifier := core.NewMethodIdentifier(interfaceIdentifier, "importSpecification")
	errorDefinitions := make([]data.ErrorDefinition, 0)
	cIface.errorBindingMap[errors.InvalidArgument{}.Error()] = errors.InvalidArgumentBindingType()
	errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.InvalidArgumentBindingType())
	if errError1 != nil {
