...
func configurationUpdateInputType() bindings.StructType {
	...
	fields["model"] = bindings.NewReferenceType(ConfigurationModelBindingType)
	fieldNameMap["model"] = "Model"
...
func configurationGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(ConfigurationModelBindingType)
}
