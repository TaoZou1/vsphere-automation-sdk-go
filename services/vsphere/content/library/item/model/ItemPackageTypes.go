...
func UpdateSessionModelBindingType() bindings.BindingType {
	...
	fields["expiration_time"] = bindings.NewOptionalType(bindings.NewDateTimeType())
	fieldNameMap["expiration_time"] = "ExpirationTime"
	fields["preview_info"] = bindings.NewOptionalType(bindings.NewReferenceType(PreviewInfoBindingType))
	fieldNameMap["preview_info"] = "PreviewInfo"
	fields["warning_behavior"] = bindings.NewOptionalType(bindings.NewListType(bindings.NewReferenceType(WarningBehaviorBindingType), reflect.TypeOf([]WarningBehavior{})))
