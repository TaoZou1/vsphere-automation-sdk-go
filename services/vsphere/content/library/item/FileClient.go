...
type FileClient interface {
	...
	// @return The FileInfo object with information on the specified file.
	...
	Get(libraryItemIdParam string, nameParam string) (FileInfo, error)
	...
	//
	// * The resource ``com.vmware.content.library.Item`` referenced by the parameter ``library_item_id`` requires ``System.Read``.
	List(libraryItemIdParam string) ([]FileInfo, error)
}
