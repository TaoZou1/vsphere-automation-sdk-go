...
func NewDefaultFileClient(connector client.Connector) *DefaultFileClient {
	interfaceName := "com.vmware.content.library.item.file"
...
func (fIface *DefaultFileClient) Get(libraryItemIdParam string, nameParam string) (FileInfo, error) {
...
func (fIface *DefaultFileClient) List(libraryItemIdParam string) ([]FileInfo, error) {
	typeConverter := fIface.connector.TypeConverter()
