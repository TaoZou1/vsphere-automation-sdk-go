...
// Data type definitions file for service: Results.
...
func resultsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.LiveTraceResultBindingType)
}

func resultsGetRestMetadata() protocol.OperationRestMetadata {
