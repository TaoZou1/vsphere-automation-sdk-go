...
// Data type definitions file for service: NsgroupVmDetails.
...
func nsgroupVmDetailsListInputType() bindings.StructType {
...
func nsgroupVmDetailsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IdfwNsgroupVmDetailListResultBindingType)
}

func nsgroupVmDetailsListRestMetadata() protocol.OperationRestMetadata {
