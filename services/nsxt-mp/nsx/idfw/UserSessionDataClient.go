...
type UserSessionDataClient interface {
	...
	Get() (model.IdfwUserSessionDataAndMappings, error)
}
...
func NewUserSessionDataClient(connector client.Connector) *userSessionDataClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.idfw.user_session_data")
...
func (uIface *userSessionDataClient) Get() (model.IdfwUserSessionDataAndMappings, error) {
