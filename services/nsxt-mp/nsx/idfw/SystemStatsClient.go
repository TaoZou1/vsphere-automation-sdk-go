...
type SystemStatsClient interface {
	...
	Get() (model.IdfwSystemStats, error)
}
...
func NewSystemStatsClient(connector client.Connector) *systemStatsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.idfw.system_stats")
...
func (sIface *systemStatsClient) Get() (model.IdfwSystemStats, error) {
