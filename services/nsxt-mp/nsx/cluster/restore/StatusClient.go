...
type StatusClient interface {
	...
	Get(restoreComponentParam *string) (model.ClusterRestoreStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.cluster.restore.status")
...
func (sIface *statusClient) Get(restoreComponentParam *string) (model.ClusterRestoreStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.restore.status", "get", inputDataValue, executionContext)
	var emptyOutput model.ClusterRestoreStatus
