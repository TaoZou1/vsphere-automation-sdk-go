...
func nodesCreateInputType() bindings.StructType {
...
func nodesCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ClusterNodeConfigBindingType)
}

func nodesCreateRestMetadata() protocol.OperationRestMetadata {
...
func nodesDeleteInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func nodesDeleteOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func nodesDeleteRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
