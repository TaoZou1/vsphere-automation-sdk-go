...
func NewHistoryClient(connector client.Connector) *historyClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.cluster.backups.history")
...
func (hIface *historyClient) Get() (model.BackupOperationHistory, error) {
	...
	methodResult := hIface.connector.GetApiProvider().Invoke("com.vmware.nsx.cluster.backups.history", "get", inputDataValue, executionContext)
	var emptyOutput model.BackupOperationHistory
