...
// Data type definitions file for service: Ui_frames.
...
func uiFramesGetInputType() bindings.StructType {
...
func uiFramesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.BackupUiFramesInfoListBindingType)
}

func uiFramesGetRestMetadata() protocol.OperationRestMetadata {
