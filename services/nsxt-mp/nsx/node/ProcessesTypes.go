...
func processesGetInputType() bindings.StructType {
	...
	fields["process_id"] = bindings.NewStringType()
...
func processesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.NodeProcessPropertiesBindingType)
}
...
func processesGetRestMetadata() protocol.OperationRestMetadata {
	...
	fields["process_id"] = bindings.NewStringType()
	fieldNameMap["process_id"] = "ProcessId"
	paramsTypeMap["process_id"] = bindings.NewStringType()
	paramsTypeMap["processId"] = bindings.NewStringType()
...
func processesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.NodeProcessPropertiesListResultBindingType)
}
