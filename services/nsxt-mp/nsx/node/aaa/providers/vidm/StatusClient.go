...
type StatusClient interface {
	...
	Get() (model.NodeAuthProviderVidmStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.node.aaa.providers.vidm.status")
...
func (sIface *statusClient) Get() (model.NodeAuthProviderVidmStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.node.aaa.providers.vidm.status", "get", inputDataValue, executionContext)
	var emptyOutput model.NodeAuthProviderVidmStatus
