...
func statusClearbootuperrorInputType() bindings.StructType {
...
func statusClearbootuperrorOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.NodeStatusPropertiesBindingType)
}

func statusClearbootuperrorRestMetadata() protocol.OperationRestMetadata {
