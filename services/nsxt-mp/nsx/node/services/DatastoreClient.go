...
func NewDatastoreClient(connector client.Connector) *datastoreClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.node.services.datastore")
...
func (dIface *datastoreClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (dIface *datastoreClient) Get() (model.NodeServiceProperties, error) {
...
func (dIface *datastoreClient) Restart() (model.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(datastoreRestartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
...
func (dIface *datastoreClient) Start() (model.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(datastoreStartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput model.NodeServiceStatusProperties
		return emptyOutput, bindings.VAPIerrorsToError(inputError)
...
func (dIface *datastoreClient) Stop() (model.NodeServiceStatusProperties, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(datastoreStopInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput model.NodeServiceStatusProperties
		return emptyOutput, bindings.VAPIerrorsToError(inputError)
