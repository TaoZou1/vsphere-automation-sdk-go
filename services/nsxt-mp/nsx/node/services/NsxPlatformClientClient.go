...
func NewNsxPlatformClientClient(connector client.Connector) *nsxPlatformClientClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.node.services.nsx_platform_client")
...
func (nIface *nsxPlatformClientClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (nIface *nsxPlatformClientClient) Get() (model.NodeServiceProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(nsxPlatformClientGetInputType(), typeConverter)
...
func (nIface *nsxPlatformClientClient) Restart() (model.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(nsxPlatformClientRestartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
...
func (nIface *nsxPlatformClientClient) Start() (model.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(nsxPlatformClientStartInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput model.NodeServiceStatusProperties
		return emptyOutput, bindings.VAPIerrorsToError(inputError)
...
func (nIface *nsxPlatformClientClient) Stop() (model.NodeServiceStatusProperties, error) {
	typeConverter := nIface.connector.TypeConverter()
	executionContext := nIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(nsxPlatformClientStopInputType(), typeConverter)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		var emptyOutput model.NodeServiceStatusProperties
		return emptyOutput, bindings.VAPIerrorsToError(inputError)
