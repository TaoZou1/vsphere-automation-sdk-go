...
type StatusClient interface {
	...
	Get(proxyIdParam string, logicalSwitchIdParam string) (model.MetadataProxyStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.md_proxies.status")
...
func (sIface *statusClient) Get(proxyIdParam string, logicalSwitchIdParam string) (model.MetadataProxyStatus, error) {
