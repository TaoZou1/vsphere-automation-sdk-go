...
func NewEffectiveIpsetMembersClient(connector client.Connector) *effectiveIpsetMembersClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.ns_groups.effective_ipset_members")
...
func (eIface *effectiveIpsetMembersClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (eIface *effectiveIpsetMembersClient) List(nsGroupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.EffectiveMemberResourceListResult, error) {
	typeConverter := eIface.connector.TypeConverter()
	executionContext := eIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(effectiveIpsetMembersListInputType(), typeConverter)
