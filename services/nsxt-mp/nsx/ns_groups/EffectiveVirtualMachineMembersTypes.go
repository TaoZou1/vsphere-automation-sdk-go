...
// Data type definitions file for service: EffectiveVirtualMachineMembers.
...
func effectiveVirtualMachineMembersListInputType() bindings.StructType {
...
func effectiveVirtualMachineMembersListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.VirtualMachineListResultBindingType)
}

func effectiveVirtualMachineMembersListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/ns-groups/{nsGroupId}/effective-virtual-machine-members",
		"",
		resultHeaders,
		200,
		"",
