...
func profilesGetInputType() bindings.StructType {
	...
	fields["ids_profile_id"] = bindings.NewStringType()
	fieldNameMap["ids_profile_id"] = "IdsProfileId"
...
func profilesGetRestMetadata() protocol.OperationRestMetadata {
	...
	fields["ids_profile_id"] = bindings.NewStringType()
	fieldNameMap["ids_profile_id"] = "IdsProfileId"
	paramsTypeMap["ids_profile_id"] = bindings.NewStringType()
	paramsTypeMap["idsProfileId"] = bindings.NewStringType()
	pathParams["ids_profile_id"] = "idsProfileId"
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/intrusion-services/profiles/{idsProfileId}",
		"",
		resultHeaders,
		200,
		"",
