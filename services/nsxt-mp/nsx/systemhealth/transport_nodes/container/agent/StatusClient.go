...
type StatusClient interface {
	...
	Get(nodeIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.TnNodeAgentStatusListResult, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.systemhealth.transport_nodes.container.agent.status")
...
func (sIface *statusClient) Get(nodeIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.TnNodeAgentStatusListResult, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.systemhealth.transport_nodes.container.agent.status", "get", inputDataValue, executionContext)
	var emptyOutput model.TnNodeAgentStatusListResult
