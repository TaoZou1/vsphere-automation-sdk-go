...
// Possible value for ``status`` of method Status#get.
const Status_GET_STATUS_UNKNOWN = "UNKNOWN"

// Possible value for ``status`` of method Status#get.
const Status_GET_STATUS_HEALTHY = "HEALTHY"

// Possible value for ``status`` of method Status#get.
const Status_GET_STATUS_DOWN = "DOWN"

// Possible value for ``status`` of method Status#get.
const Status_GET_STATUS_DEGRADED = "DEGRADED"
...
func statusDeleteInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func statusDeleteOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func statusDeleteRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/api/v1/systemhealth/container-cluster/{clusterId}/ncp/status",
		"",
		resultHeaders,
		204,
		"",
