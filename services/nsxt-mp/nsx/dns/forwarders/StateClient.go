...
type StateClient interface {
	...
	Get(forwarderIdParam string, barrierIdParam *int64, requestIdParam *string) (model.ConfigurationState, error)
}
...
func NewStateClient(connector client.Connector) *stateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.dns.forwarders.state")
...
func (sIface *stateClient) Get(forwarderIdParam string, barrierIdParam *int64, requestIdParam *string) (model.ConfigurationState, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.dns.forwarders.state", "get", inputDataValue, executionContext)
	var emptyOutput model.ConfigurationState
