...
func failedQueriesGetInputType() bindings.StructType {
...
func failedQueriesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DnsFailedQueriesBindingType)
}

func failedQueriesGetRestMetadata() protocol.OperationRestMetadata {
