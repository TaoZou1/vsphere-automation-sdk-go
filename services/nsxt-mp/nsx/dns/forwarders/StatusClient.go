...
type StatusClient interface {
	...
	Get(forwarderIdParam string) (model.DnsForwarderStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.dns.forwarders.status")
...
func (sIface *statusClient) Get(forwarderIdParam string) (model.DnsForwarderStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.dns.forwarders.status", "get", inputDataValue, executionContext)
	var emptyOutput model.DnsForwarderStatus
