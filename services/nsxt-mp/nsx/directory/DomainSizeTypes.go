...
// Data type definitions file for service: DomainSize.
...
func domainSizeCreateInputType() bindings.StructType {
...
func domainSizeCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.DirectoryDomainSizeBindingType)
}

func domainSizeCreateRestMetadata() protocol.OperationRestMetadata {
