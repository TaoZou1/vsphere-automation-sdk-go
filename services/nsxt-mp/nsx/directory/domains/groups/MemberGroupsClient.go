...
type MemberGroupsClient interface {
	...
	List(domainIdParam string, groupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DirectoryGroupMemberListResults, error)
}
...
func NewMemberGroupsClient(connector client.Connector) *memberGroupsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.directory.domains.groups.member_groups")
...
func (mIface *memberGroupsClient) List(domainIdParam string, groupIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.DirectoryGroupMemberListResults, error) {
