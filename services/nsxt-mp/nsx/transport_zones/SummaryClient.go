...
type SummaryClient interface {
	...
	Get(zoneIdParam string) (model.TransportZoneStatus, error)
}
...
func NewSummaryClient(connector client.Connector) *summaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.transport_zones.summary")
...
func (sIface *summaryClient) Get(zoneIdParam string) (model.TransportZoneStatus, error) {
