...
func transportNodeStatusGetallInputType() bindings.StructType {
...
func transportNodeStatusGetallOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TransportNodeStatusListResultBindingType)
}

func transportNodeStatusGetallRestMetadata() protocol.OperationRestMetadata {
...
func transportNodeStatusListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func transportNodeStatusListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TransportNodeStatusListResultBindingType)
}

func transportNodeStatusListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
