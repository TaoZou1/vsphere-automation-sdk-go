...
type StatusClient interface {
	...
	Get() (model.HeatMapTransportNodesAggregateStatus, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get0(zoneIdParam string, sourceParam *string) (model.HeatMapTransportZoneStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.transport_zones.status")
...
func (sIface *statusClient) Get() (model.HeatMapTransportNodesAggregateStatus, error) {
...
func (sIface *statusClient) Get0(zoneIdParam string, sourceParam *string) (model.HeatMapTransportZoneStatus, error) {
	typeConverter := sIface.connector.TypeConverter()
	executionContext := sIface.connector.NewExecutionContext()
