...
func NewNodesSummaryClient(connector client.Connector) *nodesSummaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.migration.nodes_summary")
...
func (nIface *nodesSummaryClient) Get() (model.NodeSummaryList, error) {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx.migration.nodes_summary", "get", inputDataValue, executionContext)
	var emptyOutput model.NodeSummaryList
