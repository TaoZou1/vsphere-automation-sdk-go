...
type AggregateInfoClient interface {
	...
	List(componentTypeParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, summaryParam *bool, syncParam *bool) (model.MigrationUnitGroupAggregateInfoListResult, error)
}
...
func NewAggregateInfoClient(connector client.Connector) *aggregateInfoClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.migration.migration_unit_groups.aggregate_info")
...
func (aIface *aggregateInfoClient) List(componentTypeParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, summaryParam *bool, syncParam *bool) (model.MigrationUnitGroupAggregateInfoListResult, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.migration.migration_unit_groups.aggregate_info", "list", inputDataValue, executionContext)
	var emptyOutput model.MigrationUnitGroupAggregateInfoListResult
