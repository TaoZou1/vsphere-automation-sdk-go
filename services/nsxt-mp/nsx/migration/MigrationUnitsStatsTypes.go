...
// Data type definitions file for service: MigrationUnitsStats.
...
func migrationUnitsStatsListInputType() bindings.StructType {
...
func migrationUnitsStatsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.MigrationUnitTypeStatsListBindingType)
}

func migrationUnitsStatsListRestMetadata() protocol.OperationRestMetadata {
