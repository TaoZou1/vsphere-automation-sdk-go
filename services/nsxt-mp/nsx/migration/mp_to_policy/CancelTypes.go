...
func cancelCreateInputType() bindings.StructType {
...
func cancelCreateOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func cancelCreateRestMetadata() protocol.OperationRestMetadata {
