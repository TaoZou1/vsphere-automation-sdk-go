...
// Data type definitions file for service: DiscoveredSwitches.
...
func discoveredSwitchesListInputType() bindings.StructType {
...
func discoveredSwitchesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.MigrationSwitchListResultBindingType)
}

func discoveredSwitchesListRestMetadata() protocol.OperationRestMetadata {
