...
func statsGetallInputType() bindings.StructType {
...
func statsGetallOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.LogicalConstructMigrationStatsListResultBindingType)
}

func statsGetallRestMetadata() protocol.OperationRestMetadata {
