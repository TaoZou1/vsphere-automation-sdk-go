...
// Data type definitions file for service: MigratedSwitches.
...
func migratedSwitchesListInputType() bindings.StructType {
...
func migratedSwitchesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.MigrationSwitchListResultBindingType)
}

func migratedSwitchesListRestMetadata() protocol.OperationRestMetadata {
