...
// Data type definitions file for service: MigrationUnitGroupsStatus.
...
func migrationUnitGroupsStatusGetallInputType() bindings.StructType {
...
func migrationUnitGroupsStatusGetallOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.MigrationUnitGroupStatusListResultBindingType)
}

func migrationUnitGroupsStatusGetallRestMetadata() protocol.OperationRestMetadata {
