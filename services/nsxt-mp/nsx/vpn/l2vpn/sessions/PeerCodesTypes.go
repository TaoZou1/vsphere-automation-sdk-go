...
// Data type definitions file for service: PeerCodes.
...
func peerCodesGetInputType() bindings.StructType {
...
func peerCodesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.L2VpnSessionPeerCodesBindingType)
}

func peerCodesGetRestMetadata() protocol.OperationRestMetadata {
