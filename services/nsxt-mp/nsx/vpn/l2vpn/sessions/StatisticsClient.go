...
type StatisticsClient interface {
	...
	Get(sessionIdParam string, sourceParam *string) (model.L2VPNSessionStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.vpn.l2vpn.sessions.statistics")
...
func (sIface *statisticsClient) Get(sessionIdParam string, sourceParam *string) (model.L2VPNSessionStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.vpn.l2vpn.sessions.statistics", "get", inputDataValue, executionContext)
	var emptyOutput model.L2VPNSessionStatistics
