...
func statisticsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.IPSecVPNSessionStatisticsBindingType)
}
...
func statisticsResetInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["session_id"] = bindings.NewStringType()
	fieldNameMap["session_id"] = "SessionId"
...
func statisticsResetOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func statisticsResetRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
