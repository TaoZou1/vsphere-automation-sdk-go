...
type StatisticsClient interface {
	...
	Get(endpointIdParam string, sourceParam *string) (model.BridgeEndpointStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.bridge_endpoints.statistics")
...
func (sIface *statisticsClient) Get(endpointIdParam string, sourceParam *string) (model.BridgeEndpointStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.bridge_endpoints.statistics", "get", inputDataValue, executionContext)
	var emptyOutput model.BridgeEndpointStatistics
