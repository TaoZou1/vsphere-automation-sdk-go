...
// Data type definitions file for service: ObjectIds.
...
func objectIdsListInputType() bindings.StructType {
...
func objectIdsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.MpDataListResultBindingType)
}

func objectIdsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/api/v1/mppolicy/migration/object-ids",
		"",
		resultHeaders,
		200,
		"",
