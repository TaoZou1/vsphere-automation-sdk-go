...
func topologyByClusterApplyInputType() bindings.StructType {
...
func topologyByClusterApplyOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.UpgradeTopologyBindingType)
}

func topologyByClusterApplyRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"upgrade_topology",
		"POST",
		"/api/v1/nvds-urt/topology-by-cluster/{precheckId}",
		"",
		resultHeaders,
		200,
		"",
...
func topologyByClusterGetInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["precheck_id"] = bindings.NewStringType()
	fields["cluster_id"] = bindings.NewOptionalType(bindings.NewStringType())
...
func topologyByClusterGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.UpgradeTopologyBindingType)
}

func topologyByClusterGetRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
