...
func precheckCreateInputType() bindings.StructType {
...
func precheckCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.NvdsUpgradePrecheckIdBindingType)
}

func precheckCreateRestMetadata() protocol.OperationRestMetadata {
