...
func NewRetrieveClient(connector client.Connector) *retrieveClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.aaa.registration_token.retrieve")
...
func (rIface *retrieveClient) Create(regTokenQueryParam model.RegTokenQuery) (model.RegistrationToken, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx.aaa.registration_token.retrieve", "create", inputDataValue, executionContext)
	var emptyOutput model.RegistrationToken
