...
type StatusClient interface {
	...
	List(groupIdParam string, cursorParam *string, hasErrorsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.UpgradeUnitStatusListResult, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.upgrade.upgrade_unit_groups.status")
...
func (sIface *statusClient) List(groupIdParam string, cursorParam *string, hasErrorsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.UpgradeUnitStatusListResult, error) {
