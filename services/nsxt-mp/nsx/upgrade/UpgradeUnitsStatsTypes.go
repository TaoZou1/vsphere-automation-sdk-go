...
// Data type definitions file for service: UpgradeUnitsStats.
...
func upgradeUnitsStatsListInputType() bindings.StructType {
...
func upgradeUnitsStatsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.UpgradeUnitTypeStatsListBindingType)
}

func upgradeUnitsStatsListRestMetadata() protocol.OperationRestMetadata {
