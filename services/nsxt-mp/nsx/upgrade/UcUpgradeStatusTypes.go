...
// Data type definitions file for service: UcUpgradeStatus.
...
func ucUpgradeStatusGetInputType() bindings.StructType {
...
func ucUpgradeStatusGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.UcUpgradeStatusBindingType)
}

func ucUpgradeStatusGetRestMetadata() protocol.OperationRestMetadata {
