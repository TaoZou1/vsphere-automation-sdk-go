...
func NewAcceptanceClient(connector client.Connector) *acceptanceClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.upgrade.eula.acceptance")
...
func (aIface *acceptanceClient) Get() (model.EULAAcceptance, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.upgrade.eula.acceptance", "get", inputDataValue, executionContext)
	var emptyOutput model.EULAAcceptance
