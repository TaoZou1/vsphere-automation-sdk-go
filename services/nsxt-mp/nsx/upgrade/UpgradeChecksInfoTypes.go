...
// Data type definitions file for service: UpgradeChecksInfo.
...
func upgradeChecksInfoListInputType() bindings.StructType {
...
func upgradeChecksInfoListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ComponentUpgradeChecksInfoListResultBindingType)
}

func upgradeChecksInfoListRestMetadata() protocol.OperationRestMetadata {
