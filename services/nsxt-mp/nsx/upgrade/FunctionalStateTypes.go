...
// Data type definitions file for service: FunctionalState.
...
func functionalStateGetInputType() bindings.StructType {
...
func functionalStateGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.UcFunctionalStateBindingType)
}

func functionalStateGetRestMetadata() protocol.OperationRestMetadata {
