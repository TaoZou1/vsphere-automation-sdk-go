...
type StatsClient interface {
	...
	Get(transportNodeIdParam string, interfaceIdParam string, sourceParam *string) (model.NodeInterfaceStatisticsProperties, error)
}
...
func NewStatsClient(connector client.Connector) *statsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.network.interfaces.stats")
...
func (sIface *statsClient) Get(transportNodeIdParam string, interfaceIdParam string, sourceParam *string) (model.NodeInterfaceStatisticsProperties, error) {
