...
type StatisticsClient interface {
	...
	Get(edgeNodeIdParam string) (model.NodeInterSiteStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.transport_nodes.inter_site.statistics")
...
func (sIface *statisticsClient) Get(edgeNodeIdParam string) (model.NodeInterSiteStatistics, error) {
