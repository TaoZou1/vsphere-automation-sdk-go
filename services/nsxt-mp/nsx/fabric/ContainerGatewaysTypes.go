...
func containerGatewaysListInputType() bindings.StructType {
...
func containerGatewaysListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerGatewayListResultBindingType)
}

func containerGatewaysListRestMetadata() protocol.OperationRestMetadata {
