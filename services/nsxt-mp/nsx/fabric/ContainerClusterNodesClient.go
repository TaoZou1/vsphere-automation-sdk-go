...
type ContainerClusterNodesClient interface {
	...
	Get(containerClusterNodeIdParam string) (model.ContainerClusterNode, error)
	...
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	List(containerClusterIdParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeIdParam *string, sortAscendingParam *bool, sortByParam *string) (model.ContainerClusterNodeListResult, error)
}
...
func NewContainerClusterNodesClient(connector client.Connector) *containerClusterNodesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.fabric.container_cluster_nodes")
...
func (cIface *containerClusterNodesClient) GetErrorBindingType(errorName string) bindings.BindingType {
...
func (cIface *containerClusterNodesClient) Get(containerClusterNodeIdParam string) (model.ContainerClusterNode, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(containerClusterNodesGetInputType(), typeConverter)
...
func (cIface *containerClusterNodesClient) List(containerClusterIdParam *string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeIdParam *string, sortAscendingParam *bool, sortByParam *string) (model.ContainerClusterNodeListResult, error) {
	typeConverter := cIface.connector.TypeConverter()
	executionContext := cIface.connector.NewExecutionContext()
	sv := bindings.NewStructValueBuilder(containerClusterNodesListInputType(), typeConverter)
