...
func containerEgressesListInputType() bindings.StructType {
...
func containerEgressesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerEgressListResultBindingType)
}

func containerEgressesListRestMetadata() protocol.OperationRestMetadata {
