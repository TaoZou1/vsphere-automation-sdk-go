...
// Data type definitions file for service: MemberStatus.
...
func memberStatusListInputType() bindings.StructType {
...
func memberStatusListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.HostNodeStatusListResultBindingType)
}

func memberStatusListRestMetadata() protocol.OperationRestMetadata {
