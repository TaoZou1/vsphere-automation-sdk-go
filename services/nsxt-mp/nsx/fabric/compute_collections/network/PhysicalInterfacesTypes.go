...
// Data type definitions file for service: PhysicalInterfaces.
...
func physicalInterfacesListInputType() bindings.StructType {
...
func physicalInterfacesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ComputeCollectionNetworkInterfacesListResultBindingType)
}

func physicalInterfacesListRestMetadata() protocol.OperationRestMetadata {
