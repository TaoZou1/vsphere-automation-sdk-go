...
func ostypesListInputType() bindings.StructType {
...
func ostypesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.SupportedHostOSListResultBindingType)
}

func ostypesListRestMetadata() protocol.OperationRestMetadata {
