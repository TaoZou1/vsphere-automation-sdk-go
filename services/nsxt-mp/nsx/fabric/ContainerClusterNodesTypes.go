...
func containerClusterNodesGetInputType() bindings.StructType {
...
func containerClusterNodesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerClusterNodeBindingType)
}

func containerClusterNodesGetRestMetadata() protocol.OperationRestMetadata {
...
func containerClusterNodesListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func containerClusterNodesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerClusterNodeListResultBindingType)
}

func containerClusterNodesListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
