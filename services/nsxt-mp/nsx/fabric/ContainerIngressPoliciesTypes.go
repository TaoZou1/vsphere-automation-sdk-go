...
func containerIngressPoliciesGetInputType() bindings.StructType {
...
func containerIngressPoliciesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerIngressPolicyBindingType)
}

func containerIngressPoliciesGetRestMetadata() protocol.OperationRestMetadata {
...
func containerIngressPoliciesListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func containerIngressPoliciesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerIngressPolicyListResultBindingType)
}

func containerIngressPoliciesListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
