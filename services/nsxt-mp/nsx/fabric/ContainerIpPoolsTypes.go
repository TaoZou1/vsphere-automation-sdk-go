...
func containerIpPoolsListInputType() bindings.StructType {
...
func containerIpPoolsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ContainerIpPoolListResultBindingType)
}

func containerIpPoolsListRestMetadata() protocol.OperationRestMetadata {
