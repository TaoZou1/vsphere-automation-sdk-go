...
func serviceConfigsCreateInputType() bindings.StructType {
...
func serviceConfigsCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ServiceConfigBindingType)
}

func serviceConfigsCreateRestMetadata() protocol.OperationRestMetadata {
...
func serviceConfigsDeleteInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func serviceConfigsDeleteOutputType() bindings.BindingType {
	return bindings.NewVoidType()
}

func serviceConfigsDeleteRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func serviceConfigsGetInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["config_set_id"] = bindings.NewStringType()
	fieldNameMap["config_set_id"] = "ConfigSetId"
...
func serviceConfigsGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ServiceConfigBindingType)
}

func serviceConfigsGetRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func serviceConfigsListInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
...
func serviceConfigsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ServiceConfigListResultBindingType)
}

func serviceConfigsListRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
...
func serviceConfigsUpdateInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["config_set_id"] = bindings.NewStringType()
	fields["service_config"] = bindings.NewReferenceType(model.ServiceConfigBindingType)
...
func serviceConfigsUpdateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ServiceConfigBindingType)
}

func serviceConfigsUpdateRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
