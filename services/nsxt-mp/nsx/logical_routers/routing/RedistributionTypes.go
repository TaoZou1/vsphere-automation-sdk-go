...
// Data type definitions file for service: Redistribution.
...
func redistributionGetInputType() bindings.StructType {
...
func redistributionGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RedistributionConfigBindingType)
}

func redistributionGetRestMetadata() protocol.OperationRestMetadata {
...
func redistributionUpdateInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["logical_router_id"] = bindings.NewStringType()
...
func redistributionUpdateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RedistributionConfigBindingType)
}

func redistributionUpdateRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
