...
func NewAdvertisedRoutesClient(connector client.Connector) *advertisedRoutesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.logical_routers.routing.bgp.neighbors.advertised_routes")
...
func (aIface *advertisedRoutesClient) Get(logicalRouterIdParam string, neighborIdParam string) (model.BgpNeighborRouteDetails, error) {
