...
func routingGetInputType() bindings.StructType {
...
func routingGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RoutingConfigBindingType)
}

func routingGetRestMetadata() protocol.OperationRestMetadata {
...
func routingUpdateInputType() bindings.StructType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["logical_router_id"] = bindings.NewStringType()
...
func routingUpdateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.RoutingConfigBindingType)
}

func routingUpdateRestMetadata() protocol.OperationRestMetadata {
	fields := map[string]bindings.BindingType{}
	fieldNameMap := map[string]string{}
	paramsTypeMap := map[string]bindings.BindingType{}
	pathParams := map[string]string{}
