...
type StateClient interface {
	...
	Get(logicalRouterIdParam string, barrierIdParam *int64, requestIdParam *string) (model.LogicalRouterState, error)
}
...
func NewStateClient(connector client.Connector) *stateClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.logical_routers.state")
...
func (sIface *stateClient) Get(logicalRouterIdParam string, barrierIdParam *int64, requestIdParam *string) (model.LogicalRouterState, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.logical_routers.state", "get", inputDataValue, executionContext)
	var emptyOutput model.LogicalRouterState
