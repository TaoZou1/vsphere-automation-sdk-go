...
func searchCreateInputType() bindings.StructType {
	...
	fields["search_string"] = bindings.NewStringType()
	...
	fieldNameMap["id"] = "Id"
	fieldNameMap["search_string"] = "SearchString"
...
func searchCreateOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ScimSearchListResultBindingType)
}
...
func searchCreateRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["search_string"] = bindings.NewStringType()
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"POST",
		"/api/v1/trust-management/oidc-uris/{id}/search",
		"",
		resultHeaders,
		201,
		"",
