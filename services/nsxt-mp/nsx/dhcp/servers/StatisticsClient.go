...
type StatisticsClient interface {
	...
	Get(serverIdParam string) (model.DhcpStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.dhcp.servers.statistics")
...
func (sIface *statisticsClient) Get(serverIdParam string) (model.DhcpStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.dhcp.servers.statistics", "get", inputDataValue, executionContext)
	var emptyOutput model.DhcpStatistics
