...
type StatusClient interface {
	...
	Get(serverIdParam string) (model.DhcpServerStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.dhcp.servers.status")
...
func (sIface *statusClient) Get(serverIdParam string) (model.DhcpServerStatus, error) {
