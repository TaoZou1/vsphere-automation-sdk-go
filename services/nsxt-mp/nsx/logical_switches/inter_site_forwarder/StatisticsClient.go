...
type StatisticsClient interface {
	...
	Get(logicalSwitchIdParam string) (model.L2ForwarderStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.logical_switches.inter_site_forwarder.statistics")
...
func (sIface *statisticsClient) Get(logicalSwitchIdParam string) (model.L2ForwarderStatistics, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.logical_switches.inter_site_forwarder.statistics", "get", inputDataValue, executionContext)
	var emptyOutput model.L2ForwarderStatistics
