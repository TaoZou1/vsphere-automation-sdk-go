...
type StatisticsClient interface {
	...
	Get(lswitchIdParam string, sourceParam *string) (model.LogicalSwitchStatistics, error)
}
...
func NewStatisticsClient(connector client.Connector) *statisticsClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.logical_switches.statistics")
...
func (sIface *statisticsClient) Get(lswitchIdParam string, sourceParam *string) (model.LogicalSwitchStatistics, error) {
