...
type SummaryClient interface {
	...
	Get(switchingProfileIdParam string) (model.SwitchingProfileStatus, error)
}
...
func NewSummaryClient(connector client.Connector) *summaryClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.switching_profiles.summary")
...
func (sIface *summaryClient) Get(switchingProfileIdParam string) (model.SwitchingProfileStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.switching_profiles.summary", "get", inputDataValue, executionContext)
	var emptyOutput model.SwitchingProfileStatus
