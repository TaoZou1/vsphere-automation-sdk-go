...
// Data type definitions file for service: SourceEntities.
...
func sourceEntitiesListInputType() bindings.StructType {
...
func sourceEntitiesListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.SourceEntityResultBindingType)
}

func sourceEntitiesListRestMetadata() protocol.OperationRestMetadata {
