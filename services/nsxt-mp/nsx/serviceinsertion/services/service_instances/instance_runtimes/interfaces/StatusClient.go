...
type StatusClient interface {
	...
	Get(serviceIdParam string, serviceInstanceIdParam string, instanceRuntimeIdParam string, interfaceIndexParam string, sourceParam *string) (model.RuntimeInterfaceOperationalStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_instances.instance_runtimes.interfaces.status")
...
func (sIface *statusClient) Get(serviceIdParam string, serviceInstanceIdParam string, instanceRuntimeIdParam string, interfaceIndexParam string, sourceParam *string) (model.RuntimeInterfaceOperationalStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.serviceinsertion.services.service_instances.instance_runtimes.interfaces.status", "get", inputDataValue, executionContext)
	var emptyOutput model.RuntimeInterfaceOperationalStatus
