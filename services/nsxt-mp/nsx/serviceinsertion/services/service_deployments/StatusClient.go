...
type StatusClient interface {
	...
	Get(serviceIdParam string, serviceDeploymentIdParam string, sourceParam *string) (model.ServiceDeploymentStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.serviceinsertion.services.service_deployments.status")
...
func (sIface *statusClient) Get(serviceIdParam string, serviceDeploymentIdParam string, sourceParam *string) (model.ServiceDeploymentStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.serviceinsertion.services.service_deployments.status", "get", inputDataValue, executionContext)
	var emptyOutput model.ServiceDeploymentStatus
