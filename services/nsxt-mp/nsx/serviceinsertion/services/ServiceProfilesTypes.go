...
func serviceProfilesCreateInputType() bindings.StructType {
...
func serviceProfilesCreateOutputType() bindings.BindingType {
...
func serviceProfilesCreateRestMetadata() protocol.OperationRestMetadata {
