...
type StatusClient interface {
	...
	Get(edgeClusterIdParam string, sourceParam *string) (model.EdgeClusterStatus, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.edge_clusters.status")
...
func (sIface *statusClient) Get(edgeClusterIdParam string, sourceParam *string) (model.EdgeClusterStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx.edge_clusters.status", "get", inputDataValue, executionContext)
	var emptyOutput model.EdgeClusterStatus
