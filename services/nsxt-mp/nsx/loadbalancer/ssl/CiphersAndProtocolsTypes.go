...
// Data type definitions file for service: CiphersAndProtocols.
...
func ciphersAndProtocolsListInputType() bindings.StructType {
...
func ciphersAndProtocolsListOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.LbSslCipherAndProtocolListResultBindingType)
}

func ciphersAndProtocolsListRestMetadata() protocol.OperationRestMetadata {
