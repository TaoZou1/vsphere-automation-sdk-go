...
// Data type definitions file for service: DebugInfo.
...
func debugInfoGetInputType() bindings.StructType {
...
func debugInfoGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.LbServiceDebugInfoBindingType)
}

func debugInfoGetRestMetadata() protocol.OperationRestMetadata {
