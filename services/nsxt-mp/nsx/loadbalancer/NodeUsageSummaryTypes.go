...
// Data type definitions file for service: NodeUsageSummary.
...
func nodeUsageSummaryGetInputType() bindings.StructType {
...
func nodeUsageSummaryGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.LbNodeUsageSummaryBindingType)
}

func nodeUsageSummaryGetRestMetadata() protocol.OperationRestMetadata {
