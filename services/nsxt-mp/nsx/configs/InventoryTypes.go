...
// Data type definitions file for service: Inventory.
...
func inventoryGetInputType() bindings.StructType {
...
func inventoryGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.InventoryConfigBindingType)
}

func inventoryGetRestMetadata() protocol.OperationRestMetadata {
