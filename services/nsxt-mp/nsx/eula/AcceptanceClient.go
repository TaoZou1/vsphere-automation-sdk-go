...
func NewAcceptanceClient(connector client.Connector) *acceptanceClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx.eula.acceptance")
...
func (aIface *acceptanceClient) Get() (model.EULAAcceptance, error) {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx.eula.acceptance", "get", inputDataValue, executionContext)
	var emptyOutput model.EULAAcceptance
