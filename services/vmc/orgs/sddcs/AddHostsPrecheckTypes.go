...
func addHostsPrecheckAddHostPrecheckTaskInputType() bindings.StructType {
...
func addHostsPrecheckAddHostPrecheckTaskOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.TaskBindingType)
}

func addHostsPrecheckAddHostPrecheckTaskRestMetadata() protocol.OperationRestMetadata {
