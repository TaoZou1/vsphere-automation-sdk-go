...
func NewResourcesClient(connector client.Connector) *resourcesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.fine_tuning.resources")
...
func (rIface *resourcesClient) List(cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string, type_Param *string) (model.ResourceInfoListResult, error) {
	...
	if inputError != nil {
		var emptyOutput model.ResourceInfoListResult
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.fine_tuning.resources", "list", inputDataValue, executionContext)
	var emptyOutput model.ResourceInfoListResult
	if methodResult.IsSuccess() {
		...
		return output.(model.ResourceInfoListResult), nil
	} else {
