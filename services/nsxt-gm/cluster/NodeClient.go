...
func NewNodeClient(connector client.Connector) *nodeClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.cluster.node")
...
func (nIface *nodeClient) Reposync() error {
	...
	methodResult := nIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.cluster.node", "reposync", inputDataValue, executionContext)
