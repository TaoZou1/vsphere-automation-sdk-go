...
// Data type definitions file for service: InstructionResources.
...
func instructionResourcesGetInputType() bindings.StructType {
...
func instructionResourcesGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.ActionableResourceListResultBindingType)
}

func instructionResourcesGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/cluster/restore/instruction-resources",
		"",
		resultHeaders,
		200,
		"",
