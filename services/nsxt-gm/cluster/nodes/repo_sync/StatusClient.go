...
type StatusClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.RepoSyncStatusReport
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
	// @throws NotFound  Not Found
	Get(nodeIdParam string) (model.RepoSyncStatusReport, error)
}
...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.cluster.nodes.repo_sync.status")
...
func (sIface *statusClient) Get(nodeIdParam string) (model.RepoSyncStatusReport, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.cluster.nodes.repo_sync.status", "get", inputDataValue, executionContext)
	var emptyOutput model.RepoSyncStatusReport
