...
func NewAcceptClient(connector client.Connector) *acceptClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.eula.accept")
...
func (aIface *acceptClient) Create() error {
	...
	methodResult := aIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.eula.accept", "create", inputDataValue, executionContext)
