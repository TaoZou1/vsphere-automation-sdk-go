...
func NewStatusClient(connector client.Connector) *statusClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.sites.onboarding.status")
...
func (sIface *statusClient) Get(siteIdParam string) (model.ConfigOnboardingStatus, error) {
	...
	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.sites.onboarding.status", "get", inputDataValue, executionContext)
	var emptyOutput model.ConfigOnboardingStatus
