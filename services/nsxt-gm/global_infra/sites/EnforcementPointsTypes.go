...
func enforcementPointsDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/global-manager/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}",
		"",
		resultHeaders,
		204,
		"",
...
func enforcementPointsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/sites/{siteId}/enforcement-points",
		"",
		resultHeaders,
		200,
		"",
