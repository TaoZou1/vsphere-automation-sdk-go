...
func transportZonesGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/transport-zones/{transportZoneId}",
		"",
		resultHeaders,
		200,
		"",
...
func transportZonesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/sites/{siteId}/enforcement-points/{enforcementpointId}/transport-zones",
		"",
		resultHeaders,
		200,
		"",
