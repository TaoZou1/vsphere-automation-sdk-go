...
func statisticsGetInputType() bindings.StructType {
	...
	fields["tier1_path"] = bindings.NewStringType()
	...
	fieldNameMap["tier1_path"] = "Tier1Path"
...
func statisticsGetRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["tier1_path"] = bindings.NewStringType()
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/tier-1-interface/statistics",
		"",
		resultHeaders,
		200,
		"",
