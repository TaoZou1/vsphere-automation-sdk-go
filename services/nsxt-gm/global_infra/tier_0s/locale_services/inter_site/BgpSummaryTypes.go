...
// Data type definitions file for service: BgpSummary.
...
func bgpSummaryListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-0s/{tier0Id}/locale-services/{localeServicesId}/inter-site/bgp-summary",
		"",
		resultHeaders,
		200,
		"",
