...
func rulesGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/domains/{domainId}/forwarding-policies/{forwardingPolicyId}/rules/{ruleId}",
		"",
		resultHeaders,
		200,
		"",
...
func rulesListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/domains/{domainId}/forwarding-policies/{forwardingPolicyId}/rules",
		"",
		resultHeaders,
		200,
		"",
