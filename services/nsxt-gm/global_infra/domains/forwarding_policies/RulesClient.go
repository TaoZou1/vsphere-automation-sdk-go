...
type RulesClient interface {
	...
	// @return com.vmware.nsx_global_policy.model.ForwardingRule
	...
	// @return com.vmware.nsx_global_policy.model.ForwardingRuleListResult
	// @throws InvalidRequest  Bad Request, Precondition Failed
	// @throws Unauthorized  Forbidden
	// @throws ServiceUnavailable  Service Unavailable
	// @throws InternalServerError  Internal Server Error
...
func NewRulesClient(connector client.Connector) *rulesClient {
	interfaceIdentifier := core.NewInterfaceIdentifier("com.vmware.nsx_global_policy.global_infra.domains.forwarding_policies.rules")
...
func (rIface *rulesClient) Get(domainIdParam string, forwardingPolicyIdParam string, ruleIdParam string) (model.ForwardingRule, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.domains.forwarding_policies.rules", "get", inputDataValue, executionContext)
	var emptyOutput model.ForwardingRule
...
func (rIface *rulesClient) List(domainIdParam string, forwardingPolicyIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (model.ForwardingRuleListResult, error) {
	...
	connectionMetadata["isStreamingResponse"] = false
	rIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_global_policy.global_infra.domains.forwarding_policies.rules", "list", inputDataValue, executionContext)
	var emptyOutput model.ForwardingRuleListResult
	if methodResult.IsSuccess() {
