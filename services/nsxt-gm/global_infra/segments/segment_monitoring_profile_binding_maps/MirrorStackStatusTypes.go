...
func mirrorStackStatusListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{infraSegmentId}/segment-monitoring-profile-binding-maps/{segmentMonitoringProfileBindingMapId}/mirror-stack-status",
		"",
		resultHeaders,
		200,
		"",
