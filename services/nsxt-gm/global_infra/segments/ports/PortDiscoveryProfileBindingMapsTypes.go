...
func portDiscoveryProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{infraSegmentId}/ports/{infraPortId}/port-discovery-profile-binding-maps/{portDiscoveryProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func portDiscoveryProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{infraSegmentId}/ports/{infraPortId}/port-discovery-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
