...
func portQosProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/ports/{portId}/port-qos-profile-binding-maps/{portQosProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func portQosProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/ports/{portId}/port-qos-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
