...
func portSecurityProfileBindingMapsGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/ports/{portId}/port-security-profile-binding-maps/{portSecurityProfileBindingMapId}",
		"",
		resultHeaders,
		200,
		"",
...
func portSecurityProfileBindingMapsListRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/segments/{segmentId}/ports/{portId}/port-security-profile-binding-maps",
		"",
		resultHeaders,
		200,
		"",
