...
func siteSpanInfoGetOutputType() bindings.BindingType {
	return bindings.NewReferenceType(model.SegmentL2ForwarderSiteSpanInfoBindingType)
}
...
func siteSpanInfoGetRestMetadata() protocol.OperationRestMetadata {
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"GET",
		"/global-manager/api/v1/global-infra/tier-1s/{tier1Id}/segments/{segmentId}/inter-site-forwarder/site-span-info",
		"",
		resultHeaders,
		200,
		"",
