...
type ComponentClient interface {
    ...
    //
    //  The authentication.ComponentData contains the authentication information about the component element and it's fingerprint. It contains information about all the package elements that belong to this component element.
    //
    ...
    // @return The authentication.ComponentData instance that corresponds to ``component_id``
    // @throws NotFound if the component element associated with ``component_id`` does not have any authentication information.
    Get(componentIdParam string) (authentication.ComponentData, error) 
