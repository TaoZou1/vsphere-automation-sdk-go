...
func NewDefaultOperationClient(connector client.Connector) *DefaultOperationClient {
	interfaceName := "com.vmware.vapi.metadata.authentication.service.operation"
...
func (oIface *DefaultOperationClient) Get(serviceIdParam string, operationIdParam string) (authentication.OperationInfo, error) {
	typeConverter := oIface.connector.TypeConverter()
