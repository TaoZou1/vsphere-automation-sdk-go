...
type ComponentClient interface {
    ...
    //
    //  The metamodel.ComponentData contains the metamodel information about the component and it's fingerprint. It contains information about all the package elements that are contained in this component element.
    //
    ...
    // @return The metamodel.ComponentData instance that corresponds to ``component_id``.
    // @throws NotFound if the component element associated with ``component_id`` is not registered with the infrastructure.
    Get(componentIdParam string) (metamodel.ComponentData, error) 
