...
type ComponentClient interface {
    ...
    //
    //  The privilege.ComponentData contains the privilege information about the component element and its fingerprint. It contains information about all the package elements that belong to this component element.
    //
    ...
    // @return The privilege.ComponentData instance that corresponds to ``component_id``
    // @throws NotFound if the component element associated with ``component_id`` does not have any privilege information.
    Get(componentIdParam string) (privilege.ComponentData, error) 
