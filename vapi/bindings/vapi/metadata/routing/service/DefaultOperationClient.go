...
import (
	"gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/vapi/bindings/vapi/metadata/routing"
...
func (oIface *DefaultOperationClient) Get(serviceIdParam string, operationIdParam string) (routing.OperationInfo, error) {
	typeConverter := oIface.connector.TypeConverter()
