...
func (oIface *DefaultOperationClient) List(serviceIdParam string) (map[string]bool, error) {
...
func (oIface *DefaultOperationClient) Get(serviceIdParam string, operationIdParam string) (OperationInfo, error) {
	typeConverter := oIface.connector.TypeConverter()
