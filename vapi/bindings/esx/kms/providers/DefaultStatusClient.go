...
func (sIface *DefaultStatusClient) Get(providerParam string) (StatusInfo, error) {
...
func (sIface *DefaultStatusClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.InvalidArgument error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultStatusClient.get method's errors.Unauthenticated error - %s",
