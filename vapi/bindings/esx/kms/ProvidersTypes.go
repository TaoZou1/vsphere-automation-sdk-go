...
func ProvidersKeyServerCreateSpecBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["type"] = bindings.NewEnumType("com.vmware.esx.kms.providers.key_server_create_spec.type", reflect.TypeOf(ProvidersKeyServerCreateSpecType(ProvidersKeyServerCreateSpecType_KMIP)))
...
func ProvidersKeyServerUpdateSpecBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.kms.providers.key_server_update_spec.type", reflect.TypeOf(ProvidersKeyServerUpdateSpecType(ProvidersKeyServerUpdateSpecType_KMIP))))
	fieldNameMap["type"] = "Type_"
	fields["description"] = bindings.NewOptionalType(bindings.NewStringType())
	fieldNameMap["description"] = "Description"
	fields["proxy_server"] = bindings.NewOptionalType(bindings.NewReferenceType(ProvidersNetworkAddressBindingType))
...
func ProvidersKeyServerInfoBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["type"] = bindings.NewEnumType("com.vmware.esx.kms.providers.key_server_info.type", reflect.TypeOf(ProvidersKeyServerInfoType(ProvidersKeyServerInfoType_KMIP)))
	fieldNameMap["type"] = "Type_"
