...
type TagAssociationClient interface {
    ...
    // Fetches the array of TagToObjects describing the input tag identifiers and the objects they are attached to. To invoke this method, you need the read privilege on each input tag. The TagToObjects#objectIds will only contain those objects for which you have the read privilege. This method was added in vSphere API 6.5.
    //
    // @param tagIdsParam  The identifiers of the input tags.
    // The parameter must contain identifiers for the resource type: ``com.vmware.cis.tagging.Tag``.
    ...
    // Fetches the array of ObjectToTags describing the input object identifiers and the tags attached to each object. To invoke this method, you need the read privilege on each input object. The ObjectToTags#tagIds will only contain those tags for which you have the read privilege. This method was added in vSphere API 6.5.
    //
    // @param objectIdsParam  The identifiers of the input objects.
