...
import (
	"reflect"
	"gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/vapi/bindings/cis/task"
...
type DeploymentOption struct {
	...
	SkipOptions map[DeploymentOptionSkipOptions]bool
}
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type DeploymentOptionSkipOptions string
...
const (
	...
	DeploymentOptionSkipOptions_SKIP_SSO_CHECK DeploymentOptionSkipOptions = "SKIP_SSO_CHECK"
)

func (s DeploymentOptionSkipOptions) DeploymentOptionSkipOptions() bool {
	switch s {
	case DeploymentOptionSkipOptions_SKIP_SSO_CHECK:
		return true
	default:
		return false
	}
...
type Network struct {
	...
	IpFamily *TemporaryNetworkIpType
	...
	Mode TemporaryNetworkNetworkMode
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type TemporaryNetworkIpType string
...
const (
	...
	TemporaryNetworkIpType_IPV4 TemporaryNetworkIpType = "IPV4"
	...
	TemporaryNetworkIpType_IPV6 TemporaryNetworkIpType = "IPV6"
)

func (i TemporaryNetworkIpType) TemporaryNetworkIpType() bool {
	switch i {
	case TemporaryNetworkIpType_IPV4:
		return true
	case TemporaryNetworkIpType_IPV6:
		return true
	default:
		return false
	}
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type TemporaryNetworkNetworkMode string
...
const (
	...
	TemporaryNetworkNetworkMode_DHCP TemporaryNetworkNetworkMode = "DHCP"
	...
	TemporaryNetworkNetworkMode_STATIC TemporaryNetworkNetworkMode = "STATIC"
)

func (n TemporaryNetworkNetworkMode) TemporaryNetworkNetworkMode() bool {
	switch n {
	case TemporaryNetworkNetworkMode_DHCP:
		return true
	case TemporaryNetworkNetworkMode_STATIC:
		return true
	default:
		return false
	}
...
func DeploymentOptionBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["skip_options"] = bindings.NewMapType(bindings.NewEnumType("com.vmware.vcenter.lcm.deployment_option.skip_options", reflect.TypeOf(DeploymentOptionSkipOptions(DeploymentOptionSkipOptions_SKIP_SSO_CHECK))), bindings.NewBooleanType(),reflect.TypeOf(map[DeploymentOptionSkipOptions]bool{}))
...
func NetworkBindingType() bindings.BindingType {
	...
	fields["hostname"] = bindings.NewOptionalType(bindings.NewStringType())
	fieldNameMap["hostname"] = "Hostname"
	fields["ip_family"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vcenter.lcm.temporary_network.ip_type", reflect.TypeOf(TemporaryNetworkIpType(TemporaryNetworkIpType_IPV4))))
	fieldNameMap["ip_family"] = "IpFamily"
	fields["mode"] = bindings.NewEnumType("com.vmware.vcenter.lcm.temporary_network.network_mode", reflect.TypeOf(TemporaryNetworkNetworkMode(TemporaryNetworkNetworkMode_DHCP)))
