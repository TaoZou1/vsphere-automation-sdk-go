...
func scheduledListInputType() bindings.StructType {
...
func scheduledListOutputType() bindings.BindingType {
	return bindings.NewListType(bindings.NewReferenceType(lcm.TasksInfoBindingType), reflect.TypeOf([]lcm.TasksInfo{}))
}

func scheduledListRestMetadata() protocol.OperationRestMetadata {
