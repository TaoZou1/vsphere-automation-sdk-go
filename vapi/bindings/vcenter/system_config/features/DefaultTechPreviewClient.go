...
func (tIface *DefaultTechPreviewClient) Get(featuresParam map[string]bool) (map[string]TechPreviewStatus, error) {
...
func (tIface *DefaultTechPreviewClient) Update(featureStatusParam map[string]TechPreviewStatus) error {
	typeConverter := tIface.connector.TypeConverter()
