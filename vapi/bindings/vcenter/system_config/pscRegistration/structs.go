...
func repointInputType() bindings.StructType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
...
func repointOutputType() bindings.BindingType {
    return bindings.NewVoidType()
}

func repointRestMetadata() protocol.OperationRestMetadata {
    paramsTypeMap := map[string]bindings.BindingType{}
    pathParams := map[string]string{}
    queryParams := map[string]string{}
    headerParams := map[string]string{}
...
func InfoBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.system_config.psc_registration.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
