...
func (dIface *DatacenterClientImpl) Create(specParam CreateSpec) (string, error) {
...
func (dIface *DatacenterClientImpl) List(filterParam *FilterSpec) ([]Summary, error) {
	typeConverter := dIface.connector.TypeConverter()
...
func (dIface *DatacenterClientImpl) Get(datacenterParam string) (Info, error) {
	typeConverter := dIface.connector.TypeConverter()
