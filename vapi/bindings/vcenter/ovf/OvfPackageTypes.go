...
type DatastoreTarget struct {
	...
	InaccessibleReasons []DatastoreTargetInaccessibleReason
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type DatastoreTargetInaccessibleReason string

const (
    // The datastore is not connected.
	DatastoreTargetInaccessibleReason_NOT_CONNECTED DatastoreTargetInaccessibleReason = "NOT_CONNECTED"
    // The datastore is in maintenance mode.
	DatastoreTargetInaccessibleReason_MAINTENANCE_MODE DatastoreTargetInaccessibleReason = "MAINTENANCE_MODE"
    // The datastore is mounted read-only.
	DatastoreTargetInaccessibleReason_READ_ONLY DatastoreTargetInaccessibleReason = "READ_ONLY"
	...
	DatastoreTargetInaccessibleReason_NO_ALLOCATE_RIGHT DatastoreTargetInaccessibleReason = "NO_ALLOCATE_RIGHT"
)

func (i DatastoreTargetInaccessibleReason) DatastoreTargetInaccessibleReason() bool {
	switch i {
	case DatastoreTargetInaccessibleReason_NOT_CONNECTED:
		return true
	case DatastoreTargetInaccessibleReason_MAINTENANCE_MODE:
		return true
	case DatastoreTargetInaccessibleReason_READ_ONLY:
		return true
	case DatastoreTargetInaccessibleReason_NO_ALLOCATE_RIGHT:
		return true
	default:
		return false
	}
...
type TargetNetwork struct {
	...
	InaccessibleReasons []TargetNetworkInaccessibleReason
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type TargetNetworkInaccessibleReason string

const (
    // The current logged on user does not have Network.Assign privilege which is required to assign to this network.
	TargetNetworkInaccessibleReason_NO_ASSIGN_RIGHT TargetNetworkInaccessibleReason = "NO_ASSIGN_RIGHT"
)

func (i TargetNetworkInaccessibleReason) TargetNetworkInaccessibleReason() bool {
	switch i {
	case TargetNetworkInaccessibleReason_NO_ASSIGN_RIGHT:
		return true
	default:
		return false
	}
...
type OvfFileInfo struct {
	...
	UploadMethod *OvfFileInfoHttpUploadMethod
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type OvfFileInfoFileType string

const (
    // The file is an OVF descriptor.
	OvfFileInfoFileType_OVF OvfFileInfoFileType = "OVF"
    // The file is a manifest.
	OvfFileInfoFileType_MANIFEST OvfFileInfoFileType = "MANIFEST"
    // The file is a certificate.
	OvfFileInfoFileType_CERT OvfFileInfoFileType = "CERT"
    // A file with localized messages for the OVF.
	OvfFileInfoFileType_MSG_BUNDLE OvfFileInfoFileType = "MSG_BUNDLE"
    // The file is a disk.
	OvfFileInfoFileType_DISK OvfFileInfoFileType = "DISK"
    // Anything else a file that does not need special treatment during transfer.
	OvfFileInfoFileType_CONTENT OvfFileInfoFileType = "CONTENT"
    // The file is an OVA file.
	OvfFileInfoFileType_OVA OvfFileInfoFileType = "OVA"
    // The file is a NVRAM file for EFI boot support.
	OvfFileInfoFileType_NVRAM OvfFileInfoFileType = "NVRAM"
)

func (f OvfFileInfoFileType) OvfFileInfoFileType() bool {
	switch f {
	case OvfFileInfoFileType_OVF:
		return true
	case OvfFileInfoFileType_MANIFEST:
		return true
	case OvfFileInfoFileType_CERT:
		return true
	case OvfFileInfoFileType_MSG_BUNDLE:
		return true
	case OvfFileInfoFileType_DISK:
		return true
	case OvfFileInfoFileType_CONTENT:
		return true
	case OvfFileInfoFileType_OVA:
		return true
	case OvfFileInfoFileType_NVRAM:
		return true
	default:
		return false
	}
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type OvfFileInfoHttpUploadMethod string

const (
    // HTTP PUT method
	OvfFileInfoHttpUploadMethod_PUT OvfFileInfoHttpUploadMethod = "PUT"
    // HTTP POST method
	OvfFileInfoHttpUploadMethod_POST OvfFileInfoHttpUploadMethod = "POST"
)

func (h OvfFileInfoHttpUploadMethod) OvfFileInfoHttpUploadMethod() bool {
	switch h {
	case OvfFileInfoHttpUploadMethod_PUT:
		return true
	case OvfFileInfoHttpUploadMethod_POST:
		return true
	default:
		return false
	}
...
type VServiceProvider struct {
	...
	Status *VServiceProviderBindingStatus
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type VServiceProviderBindingStatus string

const (
    // The dependency on the provider cannot be bound.
	VServiceProviderBindingStatus_RED VServiceProviderBindingStatus = "RED"
    // The dependency on the provider can be bound, but with warnings.
	VServiceProviderBindingStatus_YELLOW VServiceProviderBindingStatus = "YELLOW"
    // The dependency on the provider can be bound.
	VServiceProviderBindingStatus_GREEN VServiceProviderBindingStatus = "GREEN"
)

func (b VServiceProviderBindingStatus) VServiceProviderBindingStatus() bool {
	switch b {
	case VServiceProviderBindingStatus_RED:
		return true
	case VServiceProviderBindingStatus_YELLOW:
		return true
	case VServiceProviderBindingStatus_GREEN:
		return true
	default:
		return false
	}
...
type VcenterGuestCustomization struct {
	...
	Type_ VcenterGuestCustomizationType
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type VcenterGuestCustomizationType string

const (
    // Customization setting is encapsulated in a vCenter Server guest operating system customization specification.
	VcenterGuestCustomizationType_SPECIFICATION VcenterGuestCustomizationType = "SPECIFICATION"
	...
	VcenterGuestCustomizationType_XML VcenterGuestCustomizationType = "XML"
)

func (t VcenterGuestCustomizationType) VcenterGuestCustomizationType() bool {
	switch t {
	case VcenterGuestCustomizationType_SPECIFICATION:
		return true
	case VcenterGuestCustomizationType_XML:
		return true
	default:
		return false
	}
...
func DatastoreTargetBindingType() bindings.BindingType {
	...
	fields["inaccessible_reasons"] = bindings.NewOptionalType(bindings.NewListType(bindings.NewEnumType("com.vmware.vcenter.ovf.datastore_target.inaccessible_reason", reflect.TypeOf(DatastoreTargetInaccessibleReason(DatastoreTargetInaccessibleReason_NOT_CONNECTED))), reflect.TypeOf([]DatastoreTargetInaccessibleReason{})))
...
func TargetNetworkBindingType() bindings.BindingType {
	...
	fields["accessible"] = bindings.NewOptionalType(bindings.NewBooleanType())
	fieldNameMap["accessible"] = "Accessible"
	fields["inaccessible_reasons"] = bindings.NewOptionalType(bindings.NewListType(bindings.NewEnumType("com.vmware.vcenter.ovf.target_network.inaccessible_reason", reflect.TypeOf(TargetNetworkInaccessibleReason(TargetNetworkInaccessibleReason_NO_ASSIGN_RIGHT))), reflect.TypeOf([]TargetNetworkInaccessibleReason{})))
	fieldNameMap["inaccessible_reasons"] = "InaccessibleReasons"
	fields["name"] = bindings.NewOptionalType(bindings.NewStringType())
	fieldNameMap["name"] = "Name"
	var validators = []bindings.Validator{}
...
func OvfFileInfoBindingType() bindings.BindingType {
	...
	fieldNameMap["name"] = "Name"
	fields["file_type"] = bindings.NewEnumType("com.vmware.vcenter.ovf.ovf_file_info.file_type", reflect.TypeOf(OvfFileInfoFileType(OvfFileInfoFileType_OVF)))
	...
	fields["upload_method"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vcenter.ovf.ovf_file_info.http_upload_method", reflect.TypeOf(OvfFileInfoHttpUploadMethod(OvfFileInfoHttpUploadMethod_PUT))))
...
func VServiceProviderBindingType() bindings.BindingType {
	...
	fields["status"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vcenter.ovf.V_Service_Provider.binding_status", reflect.TypeOf(VServiceProviderBindingStatus(VServiceProviderBindingStatus_RED))))
...
func VcenterGuestCustomizationBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["type"] = bindings.NewEnumType("com.vmware.vcenter.ovf.vcenter_guest_customization.type", reflect.TypeOf(VcenterGuestCustomizationType(VcenterGuestCustomizationType_SPECIFICATION)))
	fieldNameMap["type"] = "Type_"
