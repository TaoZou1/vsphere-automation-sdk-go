...
func NewDefaultTagsClient(connector client.Connector) *DefaultTagsClient {
	interfaceName := "com.vmware.vcenter.host.tags"
...
func (tIface *DefaultTagsClient) Add(hostParam string, tagsParam map[string]bool) (TagsStatus, error) {
...
func (tIface *DefaultTagsClient) Remove(hostParam string, tagsParam map[string]bool) (TagsStatus, error) {
	typeConverter := tIface.connector.TypeConverter()
...
func (tIface *DefaultTagsClient) Get(hostParam string) (map[string]bool, error) {
	typeConverter := tIface.connector.TypeConverter()
