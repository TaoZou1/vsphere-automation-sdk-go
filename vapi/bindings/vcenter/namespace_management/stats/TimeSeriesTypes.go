...
type TimeSeriesSpecObjType string
...
const (
	...
	TimeSeriesSpecObjType_CLUSTER TimeSeriesSpecObjType = "CLUSTER"
	...
	TimeSeriesSpecObjType_NAMESPACE TimeSeriesSpecObjType = "NAMESPACE"
	...
	TimeSeriesSpecObjType_POD TimeSeriesSpecObjType = "POD"
)

func (o TimeSeriesSpecObjType) TimeSeriesSpecObjType() bool {
	switch o {
	case TimeSeriesSpecObjType_CLUSTER:
		return true
	case TimeSeriesSpecObjType_NAMESPACE:
		return true
	case TimeSeriesSpecObjType_POD:
		return true
	default:
		return false
	}
...
func timeSeriesGetRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["spec.obj_type"] = bindings.NewEnumType("com.vmware.vcenter.namespace_management.stats.time_series.spec.obj_type", reflect.TypeOf(TimeSeriesSpecObjType(TimeSeriesSpecObjType_CLUSTER)))
...
func TimeSeriesSpecBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["obj_type"] = bindings.NewEnumType("com.vmware.vcenter.namespace_management.stats.time_series.spec.obj_type", reflect.TypeOf(TimeSeriesSpecObjType(TimeSeriesSpecObjType_CLUSTER)))
