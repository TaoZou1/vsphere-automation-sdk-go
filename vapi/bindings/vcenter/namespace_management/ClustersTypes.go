...
type ClustersNetworkSpec struct {
	...
	Mode ClustersNetworkSpecIpv4Mode
...
//
// <p> See {@link com.vmware.vapi.bindings.ApiEnumeration enumerated types description}.
type ClustersNetworkSpecIpv4Mode string
...
const (
	...
	ClustersNetworkSpecIpv4Mode_DHCP ClustersNetworkSpecIpv4Mode = "DHCP"
	...
	ClustersNetworkSpecIpv4Mode_STATICRANGE ClustersNetworkSpecIpv4Mode = "STATICRANGE"
)

func (i ClustersNetworkSpecIpv4Mode) ClustersNetworkSpecIpv4Mode() bool {
	switch i {
	case ClustersNetworkSpecIpv4Mode_DHCP:
		return true
	case ClustersNetworkSpecIpv4Mode_STATICRANGE:
		return true
	default:
		return false
	}
...
func ClustersMessageBindingType() bindings.BindingType {
	fields := make(map[string]bindings.BindingType)
	fieldNameMap := make(map[string]string)
	fields["severity"] = bindings.NewEnumType("com.vmware.vcenter.namespace_management.clusters.message.severity", reflect.TypeOf(ClustersMessageSeverity(ClustersMessageSeverity_INFO)))
...
func ClustersNetworkSpecBindingType() bindings.BindingType {
	...
	fields["mode"] = bindings.NewEnumType("com.vmware.vcenter.namespace_management.clusters.network_spec.ipv4_mode", reflect.TypeOf(ClustersNetworkSpecIpv4Mode(ClustersNetworkSpecIpv4Mode_DHCP)))
