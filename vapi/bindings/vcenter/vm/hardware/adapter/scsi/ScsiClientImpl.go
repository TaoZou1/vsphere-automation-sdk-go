...
func (sIface *ScsiClientImpl) List(vmParam string) ([]Summary, error) {
...
func (sIface *ScsiClientImpl) Get(vmParam string, adapterParam string) (Info, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *ScsiClientImpl) Create(vmParam string, specParam CreateSpec) (string, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *ScsiClientImpl) Update(vmParam string, adapterParam string, specParam UpdateSpec) error {
	typeConverter := sIface.connector.TypeConverter()
