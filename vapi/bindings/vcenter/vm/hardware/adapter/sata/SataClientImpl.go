...
func (sIface *SataClientImpl) List(vmParam string) ([]Summary, error) {
...
func (sIface *SataClientImpl) Get(vmParam string, adapterParam string) (Info, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func (sIface *SataClientImpl) Create(vmParam string, specParam CreateSpec) (string, error) {
	typeConverter := sIface.connector.TypeConverter()
