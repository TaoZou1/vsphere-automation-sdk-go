...
func (oIface *DefaultOperationsClient) Get(vmParam string) (OperationsInfo, error) {
...
func (oIface *DefaultOperationsClient) getMethodDefinition() *core.MethodDefinition {
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for DefaultOperationsClient.get method's errors.NotFound error - %s",
