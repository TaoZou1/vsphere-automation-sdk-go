...
func (iIface *IdentityClientImpl) Get(vmParam string) (IdentityInfo, error) {
...
func (iIface *IdentityClientImpl) getMethodDefinition() *core.MethodDefinition {
	...
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for IdentityClientImpl.get method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for IdentityClientImpl.get method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for IdentityClientImpl.get method's errors.Error error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for IdentityClientImpl.get method's errors.NotFound error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for IdentityClientImpl.get method's errors.ServiceUnavailable error - %s",
