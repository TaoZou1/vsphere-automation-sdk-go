...
type EnvironmentClient interface {
    ...
    //
    //  If the authentication uses Credentials#interactiveSession, then the environment being read will be that of the user logged into the desktop. Otherwise it's the environment of the system user. 
    //
    ...
    // @param credentialsParam The guest authentication data. See Credentials.
