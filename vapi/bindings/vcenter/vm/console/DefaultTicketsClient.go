...
func NewTicketsClientImpl(connector client.Connector) *TicketsClientImpl {
	...
	tIface := TicketsClientImpl{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier: interfaceIdentifier, connector: connector}
...
func (tIface *TicketsClientImpl) Create(vmParam string, specParam TicketsCreateSpec) (TicketsSummary, error) {
...
func (tIface *TicketsClientImpl) Invoke(ctx *core.ExecutionContext, methodId core.MethodIdentifier, inputDataValue data.DataValue) core.MethodResult {
	methodResult := tIface.connector.GetApiProvider().Invoke(tIface.interfaceName, methodId.Name(), inputDataValue, ctx)
	return methodResult
}


func (tIface *TicketsClientImpl) createMethodDefinition() *core.MethodDefinition {
	...
	if inputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's input - %s",
			bindings.VAPIerrorsToError(inputError).Error())
		return nil
	}
	if outputError != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's output - %s",
	...
	if errError1 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.Error error - %s",
	...
	if errError2 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.InvalidArgument error - %s",
	...
	if errError3 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.NotAllowedInCurrentState error - %s",
	...
	if errError4 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.NotFound error - %s",
	...
	if errError5 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.ResourceInaccessible error - %s",
	...
	if errError6 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.ServiceUnavailable error - %s",
	...
	if errError7 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.Unauthenticated error - %s",
	...
	if errError8 != nil {
		log.Errorf("Error in ConvertToDataDefinition for TicketsClientImpl.create method's errors.Unauthorized error - %s",
