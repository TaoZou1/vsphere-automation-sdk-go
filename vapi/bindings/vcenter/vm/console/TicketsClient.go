...
type TicketsClient interface {
    ...
    // @throws NotAllowedInCurrentState if the virtual machine is powered off and requested ticket type is TicketsType#TicketsType_WEBMKS
