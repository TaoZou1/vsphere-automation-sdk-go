...
func (pIface *PowerClientImpl) Get(vmParam string) (Info, error) {
...
func (pIface *PowerClientImpl) Start(vmParam string) error {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *PowerClientImpl) Stop(vmParam string) error {
	typeConverter := pIface.connector.TypeConverter()
	methodIdentifier := core.NewMethodIdentifier(pIface.interfaceIdentifier, "stop")
	sv := bindings.NewStructValueBuilder(stopInputType(), typeConverter)
	sv.AddStructField("Vm", vmParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		return bindings.VAPIerrorsToError(inputError)
	}
	operationRestMetaData := stopRestMetadata()
	connectionMetadata := map[string]interface{}{lib.REST_METADATA: operationRestMetaData}
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult:= pIface.Invoke(pIface.connector.NewExecutionContext(), methodIdentifier, inputDataValue)
    if methodResult.IsSuccess() {
...
func (pIface *PowerClientImpl) Suspend(vmParam string) error {
	typeConverter := pIface.connector.TypeConverter()
	methodIdentifier := core.NewMethodIdentifier(pIface.interfaceIdentifier, "suspend")
	sv := bindings.NewStructValueBuilder(suspendInputType(), typeConverter)
	sv.AddStructField("Vm", vmParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		return bindings.VAPIerrorsToError(inputError)
	}
	operationRestMetaData := suspendRestMetadata()
	connectionMetadata := map[string]interface{}{lib.REST_METADATA: operationRestMetaData}
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult:= pIface.Invoke(pIface.connector.NewExecutionContext(), methodIdentifier, inputDataValue)
    if methodResult.IsSuccess() {
...
func (pIface *PowerClientImpl) Reset(vmParam string) error {
	typeConverter := pIface.connector.TypeConverter()
	methodIdentifier := core.NewMethodIdentifier(pIface.interfaceIdentifier, "reset")
	sv := bindings.NewStructValueBuilder(resetInputType(), typeConverter)
	sv.AddStructField("Vm", vmParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
		return bindings.VAPIerrorsToError(inputError)
	}
	operationRestMetaData := resetRestMetadata()
	connectionMetadata := map[string]interface{}{lib.REST_METADATA: operationRestMetaData}
	pIface.connector.SetConnectionMetadata(connectionMetadata)
	methodResult:= pIface.Invoke(pIface.connector.NewExecutionContext(), methodIdentifier, inputDataValue)
    if methodResult.IsSuccess() {
...
func (pIface *PowerClientImpl) getMethodDefinition() *core.MethodDefinition {
	  ...
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.get method's errors.ResourceInaccessible error - %s",
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.get method's errors.ServiceUnavailable error - %s",
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.get method's errors.Unauthenticated error - %s",
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.get method's errors.Unauthorized error - %s",
...
func (pIface *PowerClientImpl) startMethodDefinition() *core.MethodDefinition {
      interfaceIdentifier := core.NewInterfaceIdentifier(pIface.interfaceName)
      typeConverter := pIface.connector.TypeConverter()
      ...
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's output - %s",
              bindings.VAPIerrorsToError(outputError).Error())
          return nil
      }
	  ...
	  errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.ErrorBindingType())
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.Error error - %s",
	        bindings.VAPIerrorsToError(errError1).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	  ...
	  errDef2, errError2 := typeConverter.ConvertToDataDefinition(errors.NotFoundBindingType())
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.NotFound error - %s",
	        bindings.VAPIerrorsToError(errError2).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	  ...
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.AlreadyInDesiredState error - %s",
	        bindings.VAPIerrorsToError(errError3).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.Unsupported error - %s",
	        bindings.VAPIerrorsToError(errError4).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.UnableToAllocateResource error - %s",
	        bindings.VAPIerrorsToError(errError5).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef5.(data.ErrorDefinition))
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.ResourceInaccessible error - %s",
	        bindings.VAPIerrorsToError(errError6).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef6.(data.ErrorDefinition))
	  ...
	  if(errError7 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.ResourceInUse error - %s",
	  ...
	  if(errError8 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.ResourceBusy error - %s",
	  ...
	  if(errError9 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.ServiceUnavailable error - %s",
	  ...
	  if(errError10 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.Unauthenticated error - %s",
	  ...
	  if(errError11 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.start method's errors.Unauthorized error - %s",
...
func (pIface *PowerClientImpl) stopMethodDefinition() *core.MethodDefinition {
      interfaceIdentifier := core.NewInterfaceIdentifier(pIface.interfaceName)
      typeConverter := pIface.connector.TypeConverter()

      input, inputError := typeConverter.ConvertToDataDefinition(stopInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(stopOutputType())
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's output - %s",
              bindings.VAPIerrorsToError(outputError).Error())
          return nil
      }
	  ...
	  errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.ErrorBindingType())
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.Error error - %s",
	        bindings.VAPIerrorsToError(errError1).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	  ...
	  errDef2, errError2 := typeConverter.ConvertToDataDefinition(errors.NotFoundBindingType())
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.NotFound error - %s",
	        bindings.VAPIerrorsToError(errError2).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	  ...
	  errDef3, errError3 := typeConverter.ConvertToDataDefinition(errors.AlreadyInDesiredStateBindingType())
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.AlreadyInDesiredState error - %s",
	        bindings.VAPIerrorsToError(errError3).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.ResourceBusy error - %s",
	        bindings.VAPIerrorsToError(errError4).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.ServiceUnavailable error - %s",
	        bindings.VAPIerrorsToError(errError5).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef5.(data.ErrorDefinition))
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.Unauthenticated error - %s",
	        bindings.VAPIerrorsToError(errError6).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef6.(data.ErrorDefinition))
	  ...
	  if(errError7 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.stop method's errors.Unauthorized error - %s",
	        bindings.VAPIerrorsToError(errError7).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef7.(data.ErrorDefinition))
...
func (pIface *PowerClientImpl) suspendMethodDefinition() *core.MethodDefinition {
      interfaceIdentifier := core.NewInterfaceIdentifier(pIface.interfaceName)
      typeConverter := pIface.connector.TypeConverter()

      input, inputError := typeConverter.ConvertToDataDefinition(suspendInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(suspendOutputType())
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's output - %s",
              bindings.VAPIerrorsToError(outputError).Error())
          return nil
      }
	  ...
	  errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.ErrorBindingType())
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.Error error - %s",
	        bindings.VAPIerrorsToError(errError1).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	  ...
	  errDef2, errError2 := typeConverter.ConvertToDataDefinition(errors.NotFoundBindingType())
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.NotFound error - %s",
	        bindings.VAPIerrorsToError(errError2).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	  ...
	  errDef3, errError3 := typeConverter.ConvertToDataDefinition(errors.AlreadyInDesiredStateBindingType())
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.AlreadyInDesiredState error - %s",
	        bindings.VAPIerrorsToError(errError3).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.NotAllowedInCurrentState error - %s",
	        bindings.VAPIerrorsToError(errError4).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.ResourceBusy error - %s",
	        bindings.VAPIerrorsToError(errError5).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef5.(data.ErrorDefinition))
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.ServiceUnavailable error - %s",
	        bindings.VAPIerrorsToError(errError6).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef6.(data.ErrorDefinition))
	  ...
	  if(errError7 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.Unauthenticated error - %s",
	        bindings.VAPIerrorsToError(errError7).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef7.(data.ErrorDefinition))
	  ...
	  if(errError8 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.suspend method's errors.Unauthorized error - %s",
	        bindings.VAPIerrorsToError(errError8).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef8.(data.ErrorDefinition))
...
func (pIface *PowerClientImpl) resetMethodDefinition() *core.MethodDefinition {
      interfaceIdentifier := core.NewInterfaceIdentifier(pIface.interfaceName)
      typeConverter := pIface.connector.TypeConverter()

      input, inputError := typeConverter.ConvertToDataDefinition(resetInputType())
      output, outputError := typeConverter.ConvertToDataDefinition(resetOutputType())
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's output - %s",
              bindings.VAPIerrorsToError(outputError).Error())
          return nil
      }
	  ...
	  errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.ErrorBindingType())
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.Error error - %s",
	        bindings.VAPIerrorsToError(errError1).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	  ...
	  errDef2, errError2 := typeConverter.ConvertToDataDefinition(errors.NotFoundBindingType())
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.NotFound error - %s",
	        bindings.VAPIerrorsToError(errError2).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	  ...
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.NotAllowedInCurrentState error - %s",
	        bindings.VAPIerrorsToError(errError3).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	  ...
	  errDef4, errError4 := typeConverter.ConvertToDataDefinition(errors.ResourceBusyBindingType())
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.ResourceBusy error - %s",
	        bindings.VAPIerrorsToError(errError4).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
	  ...
	  errDef5, errError5 := typeConverter.ConvertToDataDefinition(errors.ServiceUnavailableBindingType())
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.ServiceUnavailable error - %s",
	        bindings.VAPIerrorsToError(errError5).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef5.(data.ErrorDefinition))
	  ...
	  errDef6, errError6 := typeConverter.ConvertToDataDefinition(errors.UnauthenticatedBindingType())
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.Unauthenticated error - %s",
	        bindings.VAPIerrorsToError(errError6).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef6.(data.ErrorDefinition))
	  ...
	  errDef7, errError7 := typeConverter.ConvertToDataDefinition(errors.UnauthorizedBindingType())
	  if(errError7 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PowerClientImpl.reset method's errors.Unauthorized error - %s",
	        bindings.VAPIerrorsToError(errError7).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef7.(data.ErrorDefinition))
