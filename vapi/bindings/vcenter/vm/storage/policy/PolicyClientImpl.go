...
func NewPolicyClientImpl(connector client.Connector) *PolicyClientImpl {
      ...
      pIface := PolicyClientImpl{interfaceName: interfaceName, methodIdentifiers: methodIdentifiers, interfaceDefinition: interfaceDefinition, errorBindingMap: errorBindingMap, interfaceIdentifier:interfaceIdentifier, connector: connector}
...
func (pIface *PolicyClientImpl) Update(vmParam string, specParam UpdateSpec) error {
...
func (pIface *PolicyClientImpl) Get(vmParam string) (Info, error) {
	typeConverter := pIface.connector.TypeConverter()
...
func (pIface *PolicyClientImpl) updateMethodDefinition() *core.MethodDefinition {
      ...
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's output - %s",
	  ...
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.Error error - %s",
	  ...
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.ServiceUnavailable error - %s",
	  ...
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.Unauthenticated error - %s",
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.Unauthorized error - %s",
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.InvalidArgument error - %s",
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.ResourceBusy error - %s",
	  ...
	  if(errError7 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.update method's errors.ResourceInaccessible error - %s",
...
func (pIface *PolicyClientImpl) getMethodDefinition() *core.MethodDefinition {
      interfaceIdentifier := core.NewInterfaceIdentifier(pIface.interfaceName)
      typeConverter := pIface.connector.TypeConverter()
      ...
      if(inputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's input - %s",
              bindings.VAPIerrorsToError(inputError).Error())
          return nil
      }
      if(outputError != nil) {
          log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's output - %s",
              bindings.VAPIerrorsToError(outputError).Error())
          return nil
      }
	  ...
	  errDef1, errError1 := typeConverter.ConvertToDataDefinition(errors.ErrorBindingType())
	  if(errError1 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's errors.Error error - %s",
	        bindings.VAPIerrorsToError(errError1).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef1.(data.ErrorDefinition))
	  ...
	  if(errError2 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's errors.ResourceInaccessible error - %s",
	        bindings.VAPIerrorsToError(errError2).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef2.(data.ErrorDefinition))
	  ...
	  if(errError3 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's errors.ServiceUnavailable error - %s",
	        bindings.VAPIerrorsToError(errError3).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef3.(data.ErrorDefinition))
	  ...
	  if(errError4 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's errors.Unauthenticated error - %s",
	        bindings.VAPIerrorsToError(errError4).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef4.(data.ErrorDefinition))
	  ...
	  if(errError5 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for PolicyClientImpl.get method's errors.Unauthorized error - %s",
	        bindings.VAPIerrorsToError(errError5).Error())
        return nil
	  }
	  errorDefinitions = append(errorDefinitions, errDef5.(data.ErrorDefinition))
