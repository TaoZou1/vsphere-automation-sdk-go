...
func (cIface *ComplianceClientImpl) Get(vmParam string) (*Info, error) {
...
func (cIface *ComplianceClientImpl) Check(vmParam string, checkSpecParam *CheckSpec) (*Info, error) {
	typeConverter := cIface.connector.TypeConverter()
