...
type ComplianceClient interface {
    ...
    // Returns the storage policy Compliance Info of a virtual machine after explicitly re-computing compliance check. This method was added in vSphere API 6.7.
    //
    // @param vmParam Virtual machine identifier.
    // The parameter must be an identifier for the resource type: ``VirtualMachine``.
