...
type RecommendationRecommendation struct {
	...
	Action RecommendationRecommendationAction
    // Hosts that should be removed from the cluster for a RecommendationRecommendationAction#Action_SCALE_IN recommendation. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
	HostsToRemove map[string]bool
    // The reasons why RecommendationRecommendationAction#Action_NO_ACTION is recommended. The recommendation could be ``Action_NO_ACTION`` because all resources are well utilized or because something is preventing recommending ``Action_SCALE_IN`` even though resources utilization is low. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
...
type RecommendationRecommendationAction string
...
const (
	...
	RecommendationRecommendationAction_SCALE_OUT RecommendationRecommendationAction = "SCALE_OUT"
	...
	RecommendationRecommendationAction_SCALE_IN RecommendationRecommendationAction = "SCALE_IN"
	...
	RecommendationRecommendationAction_NO_ACTION RecommendationRecommendationAction = "NO_ACTION"
)

func (a RecommendationRecommendationAction) RecommendationRecommendationAction() bool {
	switch a {
	case RecommendationRecommendationAction_SCALE_OUT:
		return true
	case RecommendationRecommendationAction_SCALE_IN:
		return true
	case RecommendationRecommendationAction_NO_ACTION:
		return true
	default:
		return false
	}
...
func RecommendationRecommendationBindingType() bindings.BindingType {
	...
	fields["action"] = bindings.NewEnumType("com.vmware.vcenter.cluster.edrs.recommendation.recommendation.action", reflect.TypeOf(RecommendationRecommendationAction(RecommendationRecommendationAction_SCALE_OUT)))
