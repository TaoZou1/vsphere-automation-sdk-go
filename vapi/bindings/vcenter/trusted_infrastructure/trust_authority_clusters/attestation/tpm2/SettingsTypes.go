...
type SettingsInfo struct {
    ...
    //
    //  When the ``Health`` is not SettingsHealth#SettingsHealth_OK or SettingsHealth#SettingsHealth_NONE, this member will provide an actionable description of the issues present.
