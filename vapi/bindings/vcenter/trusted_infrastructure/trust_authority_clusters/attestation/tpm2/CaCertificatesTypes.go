...
type CaCertificatesInfo struct {
    ...
    //
    //  When the ``Health`` is not CaCertificatesHealth#CaCertificatesHealth_OK or CaCertificatesHealth#CaCertificatesHealth_NONE, this member will provide an actionable description of the issues present.
