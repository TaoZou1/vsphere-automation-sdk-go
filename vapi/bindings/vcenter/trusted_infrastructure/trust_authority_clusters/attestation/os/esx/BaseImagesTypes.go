...
type BaseImagesInfo struct {
    ...
    //
    //  When the ``Health`` is not BaseImagesHealth#BaseImagesHealth_OK or BaseImagesHealth#BaseImagesHealth_NONE, this member will provide an actionable description of the issues present.
