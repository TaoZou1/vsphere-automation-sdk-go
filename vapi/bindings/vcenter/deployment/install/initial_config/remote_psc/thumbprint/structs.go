...
func getInputType() bindings.StructType {
    ...
    fields["spec"] = bindings.NewReferenceType(RemoteSpecBindingType)
...
func RemoteSpecBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.deployment.install.initial_config.remote_psc.thumbprint.remote_spec",fields, reflect.TypeOf(RemoteSpec{}), fieldNameMap, validators)
}
