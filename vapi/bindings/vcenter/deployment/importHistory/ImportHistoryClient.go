...
// The ``ImportHistory`` interface provides methods for managing the import of vCenter historical data, e.g. Tasks, Events and Statistics, when is is imported separately from the upgrade or migration process. This interface was added in vSphere API 6.7.
