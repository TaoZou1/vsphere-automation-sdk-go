...
func (cIface *CapabilitiesClientImpl) List() ([]CapabilitiesSummary, error) {
	...
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), capabilitiesListOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.([]CapabilitiesSummary), nil
	} else {
...
func (cIface *CapabilitiesClientImpl) Get(capabilityParam string) (CapabilitiesInfo, error) {
	...
	sv.AddStructField("Capability", capabilityParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
