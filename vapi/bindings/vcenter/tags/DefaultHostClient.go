...
func NewDefaultHostClient(connector client.Connector) *DefaultHostClient {
	interfaceName := "com.vmware.vcenter.tags.host"
...
func (hIface *DefaultHostClient) List(filterParam *HostFilterSpec) (HostListResult, error) {
...
func (hIface *DefaultHostClient) Delete(tagParam string) error {
	typeConverter := hIface.connector.TypeConverter()
