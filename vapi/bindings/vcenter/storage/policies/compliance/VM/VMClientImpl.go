...
func (vIface *VMClientImpl) List(filterParam FilterSpec) (map[string]Info, error) {
...
func (vIface *VMClientImpl) listMethodDefinition() *core.MethodDefinition {
	  ...
	  if(errError6 != nil) {
	    log.Errorf("Error in ConvertToDataDefinition for VMClientImpl.list method's errors.Unsupported error - %s",
