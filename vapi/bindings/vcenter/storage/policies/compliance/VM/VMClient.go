...
type VMClient interface {
    ...
    // Returns compliance information about at most 1000 virtual machines matching the filter FilterSpec. If there are no virtual machines matching the FilterSpec an empty List is returned. Virtual machines without storage policy association are not returned. This method was added in vSphere API 6.7.
    //
