...
type ComplianceClient interface {
    ...
    // Returns compliance information about entities matching the filter FilterSpec. Entities without storage policy association are not returned. This method was added in vSphere API 6.7.
    //
