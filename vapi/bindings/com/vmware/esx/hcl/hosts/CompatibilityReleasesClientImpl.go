 ...
 *
 * Client stubs for service: CompatibilityReleases
 * Functions that implement the generated CompatibilityReleasesClient interface
 */
...
func (cIface *CompatibilityReleasesClientImpl) List(hostParam string) (CompatibilityReleasesEsxiCompatibilityReleases, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), compatibilityReleasesListOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(CompatibilityReleasesEsxiCompatibilityReleases), nil
	} else {
