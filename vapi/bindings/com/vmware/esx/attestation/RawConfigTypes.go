...
func rawConfigGetInputType() bindings.StructType {
	...
	fields["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.attestation.raw_config.info_type", reflect.TypeOf(RawConfigInfoType(RawConfigInfoType_FULL))))
...
func rawConfigGetRestMetadata() protocol.OperationRestMetadata {
	...
	paramsTypeMap["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.attestation.raw_config.info_type", reflect.TypeOf(RawConfigInfoType(RawConfigInfoType_FULL))))
