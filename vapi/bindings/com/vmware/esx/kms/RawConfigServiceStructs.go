...
func (RawConfigSetSpec RawConfigSetSpec) Error() string {
    return "com.vmware.esx.kms.set_spec"
}
...
func rawConfigGetInputType() bindings.StructType {
    ...
    fields["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.kms.raw_config.info_type", reflect.TypeOf(RawConfig_InfoType(RawConfig_InfoType_FULL))))
...
func rawConfigGetRestMetadata() protocol.OperationRestMetadata {
    ...
    paramsTypeMap["type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.kms.raw_config.info_type", reflect.TypeOf(RawConfig_InfoType(RawConfig_InfoType_FULL))))
