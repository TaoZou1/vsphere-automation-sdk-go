...
func (cIface *CsrClientImpl) Get(providerParam string, specParam *CsrGetSpec) (CsrInfo, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *CsrClientImpl) Set(providerParam string, specParam CsrSetSpec) error {
	typeConverter := cIface.connector.TypeConverter()
