...
// The ``Summary`` class contains a summary of a KMS service instance.
 type ServicesSummary struct {
    ...
    // The group identifier determines which attestation service instances this KMS service can communicate with.
    //
...
func (ServicesInfo ServicesInfo) Error() string {
    return "com.vmware.esx.trusted_infrastructure.kms.info"
}
...
func (ServicesCreateSpec ServicesCreateSpec) Error() string {
    return "com.vmware.esx.trusted_infrastructure.kms.create_spec"
}
...
func ServicesSummaryBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.trusted_infrastructure.kms.services.summary",fields, reflect.TypeOf(ServicesSummary{}), fieldNameMap, validators)
}
...
func ServicesInfoBindingType() bindings.BindingType {
    ...
    fieldNameMap["group"] = "Group"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.trusted_infrastructure.kms.services.info",fields, reflect.TypeOf(ServicesInfo{}), fieldNameMap, validators)
}
...
func ServicesCreateSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["group"] = "Group"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.trusted_infrastructure.kms.services.create_spec",fields, reflect.TypeOf(ServicesCreateSpec{}), fieldNameMap, validators)
}
...
func ServicesFilterSpecBindingType() bindings.BindingType {
    ...
    fieldNameMap["group"] = "Group"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.esx.trusted_infrastructure.kms.services.filter_spec",fields, reflect.TypeOf(ServicesFilterSpec{}), fieldNameMap, validators)
}
