...
type ClientProfiles_ResourceType string
...
const (
    ...
    //  These are coarse-grained permissions that are not associated with an object, i.e. they are system-wide.
     ClientProfiles_ResourceType_ENTITLEMENT ClientProfiles_ResourceType = "ENTITLEMENT"
)

func (r ClientProfiles_ResourceType) ClientProfiles_ResourceType() bool {
    switch r {
        case ClientProfiles_ResourceType_ENTITLEMENT:
            return true
        default:
            return false
    }
...
type ClientProfiles_Entitlement string

const (
    // Allows modifying the identity configuration. 
    //
    //  For example: ClientProfiles, SecurityTokenIssuers.
     ClientProfiles_Entitlement_IDENTITY_MGMT ClientProfiles_Entitlement = "IDENTITY_MGMT"
    // Allows modifying security configuration. 
    //
    //  For example: KMS, Attestation.
     ClientProfiles_Entitlement_SECURITY_MGMT ClientProfiles_Entitlement = "SECURITY_MGMT"
    // Allows access to some read-only methods. Not all read-only methods are accessible with this entitlement. Check the specific method documentation for the required authorization.
     ClientProfiles_Entitlement_READ_ONLY ClientProfiles_Entitlement = "READ_ONLY"
)

func (e ClientProfiles_Entitlement) ClientProfiles_Entitlement() bool {
    switch e {
        case ClientProfiles_Entitlement_IDENTITY_MGMT:
            return true
        case ClientProfiles_Entitlement_SECURITY_MGMT:
            return true
        case ClientProfiles_Entitlement_READ_ONLY:
            return true
        default:
            return false
    }
...
type ClientProfiles_SubjectType string

const (
    // local user
     ClientProfiles_SubjectType_LOCAL_USER ClientProfiles_SubjectType = "LOCAL_USER"
    // A group from external source.
     ClientProfiles_SubjectType_EXTERNAL_GROUP ClientProfiles_SubjectType = "EXTERNAL_GROUP"
    // A user from external source.
     ClientProfiles_SubjectType_EXTERNAL_USER ClientProfiles_SubjectType = "EXTERNAL_USER"
)

func (s ClientProfiles_SubjectType) ClientProfiles_SubjectType() bool {
    switch s {
        case ClientProfiles_SubjectType_LOCAL_USER:
            return true
        case ClientProfiles_SubjectType_EXTERNAL_GROUP:
            return true
        case ClientProfiles_SubjectType_EXTERNAL_USER:
            return true
        default:
            return false
    }
...
type ClientProfiles_SummaryType string

const (
    // The full profile information, including access grants.
     ClientProfiles_SummaryType_FULL ClientProfiles_SummaryType = "FULL"
    // A summary containing only the profile identifier and the subject information.
     ClientProfiles_SummaryType_NORMAL ClientProfiles_SummaryType = "NORMAL"
    // A brief summary, containing only the profile identifier.
     ClientProfiles_SummaryType_BRIEF ClientProfiles_SummaryType = "BRIEF"
)

func (s ClientProfiles_SummaryType) ClientProfiles_SummaryType() bool {
    switch s {
        case ClientProfiles_SummaryType_FULL:
            return true
        case ClientProfiles_SummaryType_NORMAL:
            return true
        case ClientProfiles_SummaryType_BRIEF:
            return true
        default:
            return false
    }
...
//  The structure includes resource type and the specific resource information - entitlement.
 type ClientProfilesAccessGrant struct {
    ...
    ResourceType ClientProfiles_ResourceType
    // The entitlement in the access grant.
    Entitlement *ClientProfiles_Entitlement
}
...
//  The structure includes a name, issuer alias, and domain.
 type ClientProfilesSubject struct {
    // subject type
    Type_ ClientProfiles_SubjectType
...
//  The structure includes a client profile identifier, subject type, the details of the subject - local user, external user or external group.
 type ClientProfilesSummary struct {
    ...
    SummaryType ClientProfiles_SummaryType
...
func clientProfilesListInputType() bindings.StructType {
    ...
    fields["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.summary_type", reflect.TypeOf(ClientProfiles_SummaryType(ClientProfiles_SummaryType_FULL))))
...
func clientProfilesListRestMetadata() protocol.OperationRestMetadata {
    ...
    paramsTypeMap["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.summary_type", reflect.TypeOf(ClientProfiles_SummaryType(ClientProfiles_SummaryType_FULL))))
...
func ClientProfilesAccessGrantBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["resource_type"] = bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.resource_type", reflect.TypeOf(ClientProfiles_ResourceType(ClientProfiles_ResourceType_ENTITLEMENT)))
    fieldNameMap["resource_type"] = "ResourceType"
    fields["entitlement"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.entitlement", reflect.TypeOf(ClientProfiles_Entitlement(ClientProfiles_Entitlement_IDENTITY_MGMT))))
...
func ClientProfilesSubjectBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["type"] = bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.subject_type", reflect.TypeOf(ClientProfiles_SubjectType(ClientProfiles_SubjectType_LOCAL_USER)))
...
func ClientProfilesSummaryBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["summary_type"] = bindings.NewEnumType("com.vmware.esx.authentication.client_profiles.summary_type", reflect.TypeOf(ClientProfiles_SummaryType(ClientProfiles_SummaryType_FULL)))
