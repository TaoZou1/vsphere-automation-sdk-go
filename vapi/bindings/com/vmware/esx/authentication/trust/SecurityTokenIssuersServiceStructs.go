...
type SecurityTokenIssuers_SummaryType string

const (
    // The full security token isuer information, including certificates.
     SecurityTokenIssuers_SummaryType_FULL SecurityTokenIssuers_SummaryType = "FULL"
    // A summary containing only the security token issuer alias and the issuer string.
     SecurityTokenIssuers_SummaryType_NORMAL SecurityTokenIssuers_SummaryType = "NORMAL"
    // A brief summary, containing only the security token issuer alias.
     SecurityTokenIssuers_SummaryType_BRIEF SecurityTokenIssuers_SummaryType = "BRIEF"
)

func (s SecurityTokenIssuers_SummaryType) SecurityTokenIssuers_SummaryType() bool {
    switch s {
        case SecurityTokenIssuers_SummaryType_FULL:
            return true
        case SecurityTokenIssuers_SummaryType_NORMAL:
            return true
        case SecurityTokenIssuers_SummaryType_BRIEF:
            return true
        default:
            return false
    }
...
//  The structure includes the alias identifier and the issuer string.
 type SecurityTokenIssuersSummary struct {
    ...
    SummaryType SecurityTokenIssuers_SummaryType
...
func securityTokenIssuersListInputType() bindings.StructType {
    ...
    fields["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.authentication.trust.security_token_issuers.summary_type", reflect.TypeOf(SecurityTokenIssuers_SummaryType(SecurityTokenIssuers_SummaryType_FULL))))
...
func securityTokenIssuersListRestMetadata() protocol.OperationRestMetadata {
    ...
    paramsTypeMap["projection"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.esx.authentication.trust.security_token_issuers.summary_type", reflect.TypeOf(SecurityTokenIssuers_SummaryType(SecurityTokenIssuers_SummaryType_FULL))))
...
func SecurityTokenIssuersSummaryBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["summary_type"] = bindings.NewEnumType("com.vmware.esx.authentication.trust.security_token_issuers.summary_type", reflect.TypeOf(SecurityTokenIssuers_SummaryType(SecurityTokenIssuers_SummaryType_FULL)))
