...
type ConstantValue struct {
    ...
    Category ConstantValue_Category
...
func (ConstantValue ConstantValue) Error() string {
    ...
    type ConstantValue_Category string

    const (
        // Indicates the type of constant value is primitive.
         ConstantValue_Category_PRIMITIVE ConstantValue_Category = "PRIMITIVE"
        // Indicates the type of constant value is a list.
         ConstantValue_Category_LIST ConstantValue_Category = "LIST"
    )

    func (c ConstantValue_Category) ConstantValue_Category() bool {
        switch c {
            case ConstantValue_Category_PRIMITIVE:
                return true
            case ConstantValue_Category_LIST:
                return true
            default:
                return false
        }
...
func (ElementValue ElementValue) Error() string {
    ...
    type ElementValue_Type string

    const (
        // Indicates the type of the value is a long (64 bit signed integer).
         ElementValue_Type_LONG ElementValue_Type = "LONG"
        // Indicates the type of the value is a string (a variable length sequence of characters). The encoding is UTF-8.
         ElementValue_Type_STRING ElementValue_Type = "STRING"
        // Indicates the type of the value is a list of strings.
         ElementValue_Type_STRING_LIST ElementValue_Type = "STRING_LIST"
        // Indicates the type of the value is an identifier for a structure element.
         ElementValue_Type_STRUCTURE_REFERENCE ElementValue_Type = "STRUCTURE_REFERENCE"
        // Indicates the type of the value is a list of identifiers for a structure element.
         ElementValue_Type_STRUCTURE_REFERENCE_LIST ElementValue_Type = "STRUCTURE_REFERENCE_LIST"
    )

    func (t ElementValue_Type) ElementValue_Type() bool {
        switch t {
            case ElementValue_Type_LONG:
                return true
            case ElementValue_Type_STRING:
                return true
            case ElementValue_Type_STRING_LIST:
                return true
            case ElementValue_Type_STRUCTURE_REFERENCE:
                return true
            case ElementValue_Type_STRUCTURE_REFERENCE_LIST:
                return true
            default:
                return false
        }
...
type GenericInstantiation struct {
    ...
    GenericType GenericInstantiation_GenericType
    // Type of the element parameter if the generic type instantiation is a GenericInstantiation_GenericType#GenericType_LIST, GenericInstantiation_GenericType#GenericType_OPTIONAL or GenericInstantiation_GenericType#GenericType_SET.
    ElementType *Type
...
func (GenericInstantiation GenericInstantiation) Error() string {
    ...
    type GenericInstantiation_GenericType string

    const (
        // Indicates the generic type is a list.
         GenericInstantiation_GenericType_LIST GenericInstantiation_GenericType = "LIST"
        // Indicates the generic type is a map.
         GenericInstantiation_GenericType_MAP GenericInstantiation_GenericType = "MAP"
        // Indicates the generic type is an optional.
         GenericInstantiation_GenericType_OPTIONAL GenericInstantiation_GenericType = "OPTIONAL"
        // Indicates the generic type is a set.
         GenericInstantiation_GenericType_SET GenericInstantiation_GenericType = "SET"
    )

    func (g GenericInstantiation_GenericType) GenericInstantiation_GenericType() bool {
        switch g {
            case GenericInstantiation_GenericType_LIST:
                return true
            case GenericInstantiation_GenericType_MAP:
                return true
            case GenericInstantiation_GenericType_OPTIONAL:
                return true
            case GenericInstantiation_GenericType_SET:
                return true
            default:
                return false
        }
...
func (PrimitiveValue PrimitiveValue) Error() string {
    ...
    type PrimitiveValue_Type string

    const (
        // Indicates the value is a boolean (true or false).
         PrimitiveValue_Type_BOOLEAN PrimitiveValue_Type = "BOOLEAN"
        // Indicates the value is a double (64 bit floating number).
         PrimitiveValue_Type_DOUBLE PrimitiveValue_Type = "DOUBLE"
        // Indicates the value is a long (64 bit signed integer).
         PrimitiveValue_Type_LONG PrimitiveValue_Type = "LONG"
        // Indicates the value is a string (a variable length sequence of characters). The encoding is UTF8.
         PrimitiveValue_Type_STRING PrimitiveValue_Type = "STRING"
    )

    func (t PrimitiveValue_Type) PrimitiveValue_Type() bool {
        switch t {
            case PrimitiveValue_Type_BOOLEAN:
                return true
            case PrimitiveValue_Type_DOUBLE:
                return true
            case PrimitiveValue_Type_LONG:
                return true
            case PrimitiveValue_Type_STRING:
                return true
            default:
                return false
        }
...
func (StructureInfo StructureInfo) Error() string {
    ...
    type StructureInfo_Type string

    const (
        // If the type is a structure element.
         StructureInfo_Type_STRUCTURE StructureInfo_Type = "STRUCTURE"
        // If the type is an error element.
         StructureInfo_Type_ERROR StructureInfo_Type = "ERROR"
    )

    func (t StructureInfo_Type) StructureInfo_Type() bool {
        switch t {
            case StructureInfo_Type_STRUCTURE:
                return true
            case StructureInfo_Type_ERROR:
                return true
            default:
                return false
        }
...
func (Type Type) Error() string {
    ...
    type Type_Category string

    const (
        // The type is one of the built-in types specified in Type_BuiltinType
         Type_Category_BUILTIN Type_Category = "BUILTIN"
        // The type is one of the user defined named types.
         Type_Category_USER_DEFINED Type_Category = "USER_DEFINED"
        // The type is an instantiation of one of the generic types.
         Type_Category_GENERIC Type_Category = "GENERIC"
    )

    func (c Type_Category) Type_Category() bool {
        switch c {
    ...
    const (
        ...
        // The built-in type is an arbitrary exception type. This is used if the value of a typed element can be one of any user defined named type which is an exception.
         Type_BuiltinType_ANY_ERROR Type_BuiltinType = "ANY_ERROR"
        // The built-in type is a dynamic structure. This is used if the value of a typed element can be one of any user defined named type.
         Type_BuiltinType_DYNAMIC_STRUCTURE Type_BuiltinType = "DYNAMIC_STRUCTURE"
        // The built-in type is an opaque. This is used if the value of a typed element could be of any type and the actual type will be known only during the execution of the API. This is mostly used in infrastructure interfaces.
         Type_BuiltinType_OPAQUE Type_BuiltinType = "OPAQUE"
    )

    func (b Type_BuiltinType) Type_BuiltinType() bool {
        switch b {
            case Type_BuiltinType_VOID:
                return true
            case Type_BuiltinType_BOOLEAN:
                return true
            case Type_BuiltinType_LONG:
                return true
            case Type_BuiltinType_DOUBLE:
                return true
            case Type_BuiltinType_STRING:
                return true
            case Type_BuiltinType_BINARY:
                return true
            case Type_BuiltinType_SECRET:
                return true
            case Type_BuiltinType_DATE_TIME:
                return true
            case Type_BuiltinType_ID:
                return true
            case Type_BuiltinType_URI:
                return true
            case Type_BuiltinType_ANY_ERROR:
                return true
            case Type_BuiltinType_DYNAMIC_STRUCTURE:
                return true
            case Type_BuiltinType_OPAQUE:
                return true
            default:
                return false
        }
...
func ConstantValueBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["category"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.constant_value.category", reflect.TypeOf(ConstantValue_Category(ConstantValue_Category_PRIMITIVE)))
...
func ElementValueBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["type"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.element_value.type", reflect.TypeOf(ElementValue_Type(ElementValue_Type_LONG)))
    fieldNameMap["type"] = "Type_"
...
func GenericInstantiationBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["generic_type"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.generic_instantiation.generic_type", reflect.TypeOf(GenericInstantiation_GenericType(GenericInstantiation_GenericType_LIST)))
...
func PrimitiveValueBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["type"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.primitive_value.type", reflect.TypeOf(PrimitiveValue_Type(PrimitiveValue_Type_BOOLEAN)))
    fieldNameMap["type"] = "Type_"
...
func StructureInfoBindingType() bindings.BindingType {
    ...
    fields["name"] = bindings.NewStringType()
    fieldNameMap["name"] = "Name"
    fields["type"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.structure_info.type", reflect.TypeOf(StructureInfo_Type(StructureInfo_Type_STRUCTURE)))
    fieldNameMap["type"] = "Type_"
    fields["enumerations"] = bindings.NewMapType(bindings.NewIdType([]string {"com.vmware.vapi.enumeration"}, ""), bindings.NewReferenceType(EnumerationInfoBindingType),reflect.TypeOf(map[string]EnumerationInfo{}))
    fieldNameMap["enumerations"] = "Enumerations"
    fields["constants"] = bindings.NewMapType(bindings.NewStringType(), bindings.NewReferenceType(ConstantInfoBindingType),reflect.TypeOf(map[string]ConstantInfo{}))
...
func TypeBindingType() bindings.BindingType {
    fields := make(map[string]bindings.BindingType)
    fieldNameMap := make(map[string]string)
    fields["category"] = bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.type.category", reflect.TypeOf(Type_Category(Type_Category_BUILTIN)))
    fieldNameMap["category"] = "Category"
    fields["builtin_type"] = bindings.NewOptionalType(bindings.NewEnumType("com.vmware.vapi.metadata.metamodel.type.builtin_type", reflect.TypeOf(Type_BuiltinType(Type_BuiltinType_VOID))))
