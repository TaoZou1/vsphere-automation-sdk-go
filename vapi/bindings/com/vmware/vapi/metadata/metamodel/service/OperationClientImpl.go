...
import (
    "reflect"
// //     "getClientImplDependenciesOfOps gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/vapi/bindings/com/vmware/vapi/metadata/metamodel"
...
// //
// //     "getDependenciesOfServiceTypes gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/vapi/bindings/com/vmware/vapi/metadata/metamodel"
...
func (oIface *OperationClientImpl) Get(serviceIdParam string, operationIdParam string) (metamodel.OperationInfo, error) {
	typeConverter := oIface.connector.TypeConverter()
...
func operationGetOutputType() bindings.BindingType {
    return bindings.NewReferenceType(metamodel.OperationInfoBindingType)
}
