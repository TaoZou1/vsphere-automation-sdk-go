...
//
//  The remote server must support the interfaces in the com.vmware.vapi.metadata.metamodel package. It must expose metamodel information of one or more components.
    Address *url.URL
}
