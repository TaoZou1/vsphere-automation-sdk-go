...
func NewSourceClientImpl(connector client.Connector) *SourceClientImpl {
      interfaceName := "com.vmware.vapi.metadata.cli.source"
...
func InfoBindingType() bindings.BindingType {
    ...
    return bindings.NewStructType("com.vmware.vapi.metadata.cli.source.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
...
func CreateSpecBindingType() bindings.BindingType {
    ...
    validators = append(validators, uv1)
    return bindings.NewStructType("com.vmware.vapi.metadata.cli.source.create_spec",fields, reflect.TypeOf(CreateSpec{}), fieldNameMap, validators)
}
