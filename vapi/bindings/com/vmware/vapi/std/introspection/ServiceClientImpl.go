...
func (sIface *ServiceClientImpl) List() (map[string]bool, error) {
...
func (sIface *ServiceClientImpl) Get(idParam string) (Info, error) {
	typeConverter := sIface.connector.TypeConverter()
...
func InfoBindingType() bindings.BindingType {
    ...
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vapi.std.introspection.service.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
