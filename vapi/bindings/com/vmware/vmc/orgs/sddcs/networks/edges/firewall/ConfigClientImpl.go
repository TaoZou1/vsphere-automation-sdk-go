...
func (cIface *ConfigClientImpl) Get(orgParam string, sddcParam string, edgeIdParam string) (model.FirewallConfig, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ConfigClientImpl) Update(orgParam string, sddcParam string, edgeIdParam string, firewallConfigParam model.FirewallConfig) error {
	typeConverter := cIface.connector.TypeConverter()
