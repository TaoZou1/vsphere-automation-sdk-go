 ...
 *
 * Client stubs for service: Uplink
 * Functions that implement the generated UplinkClient interface
 */
...
func (uIface *UplinkClientImpl) Get(orgParam string, sddcParam string, edgeIdParam string, startTimeParam *int64, endTimeParam *int64) (model.CbmStatistics, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), uplinkGetOutputType())
...
func uplinkGetInputType() bindings.StructType {
...
func uplinkGetOutputType() bindings.BindingType {
    return bindings.NewReferenceType(model.CbmStatisticsBindingType)
}

func uplinkGetRestMetadata() protocol.OperationRestMetadata {
    ...
    return protocol.NewOperationRestMetadata(
      ...
      "",
      "GET",
      "/vmc/api/orgs/{org}/sddcs/{sddc}/networks/4.0/edges/{edgeId}/statistics/interfaces/uplink",
       resultHeaders,
       200,
       errorHeaders,
