 ...
 *
 * Client stubs for service: Leaseinfo
 * Functions that implement the generated LeaseinfoClient interface
 */
...
func (lIface *LeaseinfoClientImpl) Get(orgParam string, sddcParam string, edgeIdParam string) (model.DhcpLeases, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), leaseinfoGetOutputType())
