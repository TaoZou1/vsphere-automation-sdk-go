...
func (cIface *ConfigClientImpl) Get(orgParam string, sddcParam string, edgeIdParam string, showSensitiveDataParam *bool) (model.Nsxl2vpn, error) {
	typeConverter := cIface.connector.TypeConverter()
...
func (cIface *ConfigClientImpl) Update(orgParam string, sddcParam string, edgeIdParam string, nsxl2vpnParam model.Nsxl2vpn) error {
	typeConverter := cIface.connector.TypeConverter()
