...
//
// This value should be assigned to the property which is used to discriminate the actual type used in the polymorphic context.
const Cluster__TYPE_IDENTIFIER = "Cluster"
...
func AwsSddcResourceConfigBindingType() bindings.BindingType {
    ...
    fields["provider"] = bindings.NewStringType()
    fieldNameMap["provider"] = "Provider"
    fields["clusters"] = bindings.NewOptionalType(bindings.NewListType(bindings.NewDynamicStructType([]bindings.ReferenceType {bindings.NewReferenceType(ClusterBindingType),}, bindings.REST), reflect.TypeOf([]*data.StructValue{})))
...
func PopAgentXeniConnectionBindingType() bindings.BindingType {
    ...
    fields["eni_info"] = bindings.NewOptionalType(bindings.NewMapType(bindings.NewStringType(), bindings.NewReferenceType(EniInfoBindingType),reflect.TypeOf(map[string]EniInfo{})))
