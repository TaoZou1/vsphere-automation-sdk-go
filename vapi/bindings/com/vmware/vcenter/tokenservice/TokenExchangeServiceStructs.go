...
func (TokenExchangeExchangeSpec TokenExchangeExchangeSpec) Error() string {
    return "com.vmware.vcenter.tokenservice.exchange_spec"
}
...
func (TokenExchangeInfo TokenExchangeInfo) Error() string {
    return "com.vmware.vcenter.tokenservice.info"
}
