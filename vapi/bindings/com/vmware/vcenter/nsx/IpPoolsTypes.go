...
type IpPoolsInfo struct {
	...
	Notation IpPoolsInfoIpv4RangeNotation
...
type IpPoolsInfoIpv4RangeNotation string
...
const (
	...
	IpPoolsInfoIpv4RangeNotation_CIDR IpPoolsInfoIpv4RangeNotation = "CIDR"
	...
	IpPoolsInfoIpv4RangeNotation_IP_RANGE IpPoolsInfoIpv4RangeNotation = "IP_RANGE"
)

func (i IpPoolsInfoIpv4RangeNotation) IpPoolsInfoIpv4RangeNotation() bool {
	switch i {
	case IpPoolsInfoIpv4RangeNotation_CIDR:
		return true
	case IpPoolsInfoIpv4RangeNotation_IP_RANGE:
		return true
	default:
		return false
	}
...
func IpPoolsInfoBindingType() bindings.BindingType {
	...
	fields["vlan"] = bindings.NewIntegerType()
	fieldNameMap["vlan"] = "Vlan"
	fields["notation"] = bindings.NewEnumType("com.vmware.vcenter.nsx.ip_pools.info.ipv4_range_notation", reflect.TypeOf(IpPoolsInfoIpv4RangeNotation(IpPoolsInfoIpv4RangeNotation_CIDR)))
