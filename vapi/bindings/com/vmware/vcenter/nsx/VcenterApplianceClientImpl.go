 ...
 *
 * Client stubs for service: VcenterAppliance
 * Functions that implement the generated VcenterApplianceClient interface
 */
...
func (vIface *VcenterApplianceClientImpl) Get(managementVcenterParam *Connection) (VcenterApplianceApplianceInfo, error) {
	...
	sv.AddStructField("ManagementVcenter", managementVcenterParam)
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), vcenterApplianceGetOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(VcenterApplianceApplianceInfo), nil
	} else {
