...
func (tIface *TagsClientImpl) Add(hostParam string, tagsParam map[string]bool) (TagsStatus, error) {
...
func (tIface *TagsClientImpl) Remove(hostParam string, tagsParam map[string]bool) (TagsStatus, error) {
	typeConverter := tIface.connector.TypeConverter()
...
func (tIface *TagsClientImpl) Get(hostParam string) (map[string]bool, error) {
	typeConverter := tIface.connector.TypeConverter()
