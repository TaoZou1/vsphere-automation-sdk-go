 ...
 *
 * Client stubs for service: ClusterSizeInfo
 * Functions that implement the generated ClusterSizeInfoClient interface
 */
...
func (cIface *ClusterSizeInfoClientImpl) Get() (map[SizingHint]ClusterSizeInfoInfo, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), clusterSizeInfoGetOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(map[SizingHint]ClusterSizeInfoInfo), nil
	} else {
