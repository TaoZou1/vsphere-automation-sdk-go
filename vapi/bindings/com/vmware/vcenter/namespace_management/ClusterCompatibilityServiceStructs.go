...
func (ClusterCompatibilitySummary ClusterCompatibilitySummary) Error() string {
...
func (ClusterCompatibilityFilterSpec ClusterCompatibilityFilterSpec) Error() string {
