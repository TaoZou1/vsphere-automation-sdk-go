 ...
 *
 * Client stubs for service: ServiceAccount
 * Functions that implement the generated ServiceAccountClient interface
 */
...
func (sIface *ServiceAccountClientImpl) Create(createSpecParam ServiceAccountCreateSpec) (ServiceAccountOutputSpec, error) {
	...
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), serviceAccountCreateOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.(ServiceAccountOutputSpec), nil
	} else {
...
func (sIface *ServiceAccountClientImpl) Delete(deleteSpecParam ServiceAccountDeleteSpec) error {
	...
	sv.AddStructField("DeleteSpec", deleteSpecParam)
	inputDataValue, inputError := sv.GetStructValue()
	if inputError != nil {
