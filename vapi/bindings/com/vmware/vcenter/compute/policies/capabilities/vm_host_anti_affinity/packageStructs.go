 ...
 *
 * Data type definitions file for package: com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.
 * Includes binding types of a top level structures and enumerations.
 * Shared by client-side stubs and server-side skeletons to ensure type
 * compatibility.
 */

package vm_host_anti_affinity
...
type CreateSpec struct {
    ...
    VmTag string
    // Identifier of a tag that can be associated with a host. Virtual machines indicated by CreateSpec#vmTag will be anti-affine to hosts with this tag. **Warning:** This property is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments.
    HostTag string
...
func (CreateSpec CreateSpec) Error() string {
    return "com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.create_spec"
}
...
type Info struct {
    // Identifier of a tag that can be associated with a virtual machine. Virtual machines with this tag will be anti-affine to the hosts indicated by Info#hostTag. **Warning:** This property is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments.
    VmTag string
    // Identifier of a tag that can be associated with a host. Virtual machines indicated by Info#vmTag will be anti-affine to hosts with this tag. **Warning:** This property is available as Technology Preview. These are early access APIs provided to test, automate and provide feedback on the feature. Since this can change based on feedback, VMware does not guarantee backwards compatibility and recommends against using them in production environments. Some Technology Preview APIs might only be applicable to specific environments.
    HostTag string
...
func (Info Info) Error() string {
    return "com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.info"
}
...
func CreateSpecBindingType() bindings.BindingType {
    ...
    return bindings.NewStructType("com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.create_spec",fields, reflect.TypeOf(CreateSpec{}), fieldNameMap, validators)
}
...
func InfoBindingType() bindings.BindingType {
    ...
    fieldNameMap["capability"] = "Capability"
    var validators = []bindings.Validator{}
    return bindings.NewStructType("com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.info",fields, reflect.TypeOf(Info{}), fieldNameMap, validators)
}
