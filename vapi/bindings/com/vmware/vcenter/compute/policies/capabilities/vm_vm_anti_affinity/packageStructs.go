...
func (CreateSpec CreateSpec) Error() string {
    return "com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.create_spec"
}
...
func (Info Info) Error() string {
    return "com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.info"
}
