 ...
 *
 * Client stubs for service: ConsumerPrincipals
 * Functions that implement the generated ConsumerPrincipalsClient interface
 */
...
func (cIface *ConsumerPrincipalsClientImpl) Create(clusterParam string, specParam ConsumerPrincipalsCreateSpec) (string, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), consumerPrincipalsCreateOutputType())
...
func (cIface *ConsumerPrincipalsClientImpl) Get(clusterParam string, profileParam string) (ConsumerPrincipalsInfo, error) {
	...
	var emptyOutput ConsumerPrincipalsInfo
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), consumerPrincipalsGetOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(ConsumerPrincipalsInfo), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.errorBindingMap[methodResult.Error().Name()])
		if errorInError != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInError)
...
func (cIface *ConsumerPrincipalsClientImpl) List(clusterParam string, specParam *ConsumerPrincipalsFilterSpec) ([]ConsumerPrincipalsSummary, error) {
	...
	var emptyOutput []ConsumerPrincipalsSummary
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), consumerPrincipalsListOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.([]ConsumerPrincipalsSummary), nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), cIface.errorBindingMap[methodResult.Error().Name()])
		if errorInError != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInError)
