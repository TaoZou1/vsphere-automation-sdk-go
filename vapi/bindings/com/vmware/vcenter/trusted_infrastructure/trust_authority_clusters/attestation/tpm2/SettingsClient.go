...
// The ``Settings`` interface provides methods to get or update settings related to the TPM 2.0 attestation protocol behavior. This interface was added in vSphere API 7.0.
type SettingsClient interface {


    // Return the TPM 2.0 protocol settings. This method was added in vSphere API 7.0.
    //
    ...
    // Set the TPM 2.0 protocol settings. This method was added in vSphere API 7.0.
    //
    // @param clusterParam The id of the cluster on which the operation will be executed.
    // The parameter must be an identifier for the resource type: ``ClusterComputeResource``.
