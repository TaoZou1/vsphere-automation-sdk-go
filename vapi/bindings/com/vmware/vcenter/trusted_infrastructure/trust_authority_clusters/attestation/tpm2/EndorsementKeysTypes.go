...
type EndorsementKeysInfo struct {
    ...
    //
    //  When the ``Health`` is not EndorsementKeysHealth#EndorsementKeysHealth_OK or EndorsementKeysHealth#EndorsementKeysHealth_NONE, this member will provide an actionable description of the issues present.
