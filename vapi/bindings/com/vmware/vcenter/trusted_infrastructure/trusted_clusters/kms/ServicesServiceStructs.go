...
// The ``Summary`` class contains a summary of a ``Services``.
 type ServicesSummary struct {
    ...
    // The group determines reports issued by which ``Services`` instances can this ``Services`` instance accept.
    Group string
...
func (ServicesSummary ServicesSummary) Error() string {
    return "com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.summary"
}
...
func (ServicesInfo ServicesInfo) Error() string {
    return "com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.info"
}
...
func (ServicesCreateSpec ServicesCreateSpec) Error() string {
    return "com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.create_spec"
}
...
func (ServicesFilterSpec ServicesFilterSpec) Error() string {
    return "com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.filter_spec"
}
