...
type HostnameGenerator struct {
    ...
    // The virtual machine name specified by the client. This property was added in vSphere API 7.0.
    FixedName *string
    // Base prefix, to which a unique number is appended. This property was added in vSphere API 7.0.
    Prefix *string
}
...
//
    ...
    const (
        // Specifies that a fixed name should be used for the hostname for the virtual machine during the customization. This constant field was added in vSphere API 7.0.
        ...
        // Indicates that the host name is not specified in advance. The user must provide a valid value when the actual customization spec is applied to a virtual machine. This constant field was added in vSphere API 7.0.
...
type UserData struct {
    ...
    // Full name of the end user. Note that this is not the username but full name specified in "Firstname Lastname" format. This property was added in vSphere API 7.0.
    FullName string
    // Name of the organization that owns the computer. This property was added in vSphere API 7.0.
    Organization string
    // The product Key to use for activating Windows guest operating system. This property was added in vSphere API 7.0.
    ProductKey string
}
...
type Domain struct {
    // The type of network to join after the customization. This property was added in vSphere API 7.0.
    Type_ Domain_Type
    // The workgroup that the virtual machine should join. This property was added in vSphere API 7.0.
    Workgroup *string
    // The domain to which the virtual machine should be joined. This property was added in vSphere API 7.0.
    Domain *string
    // The domain user that has permission to join the domain after virtual machine is joined. This property was added in vSphere API 7.0.
    DomainUsername *string
    // The domain user password that has permission to join the Domain#domainUsername after customization. This property was added in vSphere API 7.0.
...
//
    ...
    const (
        // The virtual machine should be be joined to a workgroup. This constant field was added in vSphere API 7.0.
         Domain_Type_WORKGROUP Domain_Type = "WORKGROUP"
        // The virtual machine should be be joined to a domain. This constant field was added in vSphere API 7.0.
...
type GuiUnattended struct {
    ...
    AutoLogon bool
    // If the GuiUnattended#autoLogon flag is map with bool value, then this property specifies the number of times the machine should automatically log on as Administrator. Generally it should be 1, but if the setup requires a number of reboots, you may want to increase it. This number may be determined by the list of commands. This property was added in vSphere API 7.0.
    AutoLogonCount int64
    // The new administrator password for the machine. To specify that the password should be set to blank (that is, no password), leave it unset. This property was added in vSphere API 7.0.
    Password *string
    // The time zone index for the virtual machine. Numbers correspond to time zones at https://support.microsoft.com/en-us/help/973627/microsoft-time-zone-index-values. This property was added in vSphere API 7.0.
    TimeZone int64
}
...
type WindowsConfiguration struct {
    // A value specifying the action that should be taken after customization. This property was added in vSphere API 7.0.
    Reboot *WindowsConfiguration_RebootOption
    // Customization settings like user details, administrator details, etc for the windows guest operating system. Exactly one of ``sysprep`` or ``sysprepXml`` must be specified. This property was added in vSphere API 7.0.
...
//
    ...
    const (
        // Reboot the guest after customization. This constant field was added in vSphere API 7.0.
         WindowsConfiguration_RebootOption_REBOOT WindowsConfiguration_RebootOption = "REBOOT"
        // Take no action. Leave the guest OS running after customization. This option can be used to look at values for debugging purposes. This constant field was added in vSphere API 7.0.
         WindowsConfiguration_RebootOption_NO_REBOOT WindowsConfiguration_RebootOption = "NO_REBOOT"
        // Shutdown the guest after customization. This constant field was added in vSphere API 7.0.
...
//
//  The ``LinuxConfiguration`` class contains settings that identify a Linux machine in the same way that the WindowsConfiguration class identifies a Windows machine.. This class was added in vSphere API 7.0.
type LinuxConfiguration struct {
    // The network host name of the Linux virtual machine. This property was added in vSphere API 7.0.
    Hostname HostnameGenerator
    // The fully qualified domain name. This property was added in vSphere API 7.0.
    Domain string
...
//
//  See the https://kb.vmware.com/kb/2145518 for a list of supported time zones for different versions in Linux.. This property was added in vSphere API 7.0.
    TimeZone *string
...
//  fi``. This property was added in vSphere API 7.0.
    ScriptText *string
}
...
type ConfigurationSpec struct {
    // Guest customization specification for a Windows guest operating system. This property was added in vSphere API 7.0.
    WindowsConfig *WindowsConfiguration
    // Guest customization specification for a linux guest operating system. This property was added in vSphere API 7.0.
...
type GlobalDNSSettings struct {
    // List of name resolution suffixes for the virtual network adapter. This list applies to both Windows and Linux guest customization. For Linux, this setting is global, whereas in Windows, this setting is listed on a per-adapter basis. This property was added in vSphere API 7.0.
    DnsSuffixList []string
    // List of DNS servers, for a virtual network adapter with a static IP address. If this list is empty, then the guest operating system is expected to use a DHCP server to get its DNS server settings. These settings configure the virtual machine to use the specified DNS servers. These DNS server settings are listed in the order of preference. This property was added in vSphere API 7.0.
    DnsServers []string
}
...
type Ipv4 struct {
    // The type of the IPv4 configuration. This property was added in vSphere API 7.0.
    Type_ Ipv4_Type
    // The static IPv4 address. This property was added in vSphere API 7.0.
    IpAddress *string
    // The IPv4 CIDR prefix, for example, 24. See http://www.oav.net/mirrors/cidr.html for netmask-to-prefix conversion. This property was added in vSphere API 7.0.
    Prefix *int64
    // Gateways for the IPv4 address. This property was added in vSphere API 7.0.
    Gateways []string
}
...
//
    ...
    const (
        // DHCP configuration. This constant field was added in vSphere API 7.0.
         Ipv4_Type_DHCP Ipv4_Type = "DHCP"
        // Static configuration. This constant field was added in vSphere API 7.0.
         Ipv4_Type_STATIC Ipv4_Type = "STATIC"
        // Indicates that the IPv4 settings are not specified in advance. The user must provide a valid value when the actual customization spec is applied to a virtual machine. This constant field was added in vSphere API 7.0.
...
type Ipv6Address struct {
    ...
    IpAddress string
    // The CIDR prefix for the interface. This property was added in vSphere API 7.0.
    Prefix int64
}
...
type Ipv6 struct {
    // The IPv6 configuration type. This property was added in vSphere API 7.0.
    Type_ Ipv6_Type
    // IPv6 address. This property was added in vSphere API 7.0.
    Ipv6 []Ipv6Address
    // gateways for the IPv6 address. This property was added in vSphere API 7.0.
    Gateways []string
}
...
//
    ...
    const (
        // DHCP IPv6 configuration. This constant field was added in vSphere API 7.0.
         Ipv6_Type_DHCP Ipv6_Type = "DHCP"
        // Static IPv6 configuration. This constant field was added in vSphere API 7.0.
         Ipv6_Type_STATIC Ipv6_Type = "STATIC"
        // Indicates that the IPv6 settings are not specified in advance. The user must provide a valid value when the actual customization spec is applied to a virtual machine. This constant field was added in vSphere API 7.0.
...
//
//  These servers should be specified in the order of preference. If this list is not empty, and if a DHCP IP address is used, then these settings override the DHCP settings.. This property was added in vSphere API 7.0.
    DnsServers []string
    // A DNS domain suffix such as vmware.com. This property was added in vSphere API 7.0.
    DnsDomain *string
    // List of WINS Servers to set for the Windows guest operating system. A Maximum of two IP addresses can be specified in this list. The first IP address will be set as the primary WINS server. The second IP address will be set as the secondary WINS server. This property was added in vSphere API 7.0.
    WinsServers []string
    // NetBIOS setting for Windows. This property was added in vSphere API 7.0.
...
//
    ...
    const (
        // DHCP server decides whether or not to use NetBIOS. This constant field was added in vSphere API 7.0.
         WindowsNetworkAdapterSettings_NetBIOSMode_USE_DHCP WindowsNetworkAdapterSettings_NetBIOSMode = "USE_DHCP"
        // Always use NetBIOS. This constant field was added in vSphere API 7.0.
         WindowsNetworkAdapterSettings_NetBIOSMode_ENABLE WindowsNetworkAdapterSettings_NetBIOSMode = "ENABLE"
        // Never use NetBIOS. This constant field was added in vSphere API 7.0.
...
type IPSettings struct {
    ...
    Ipv4 *Ipv4
    // Specification to configure IPv6 address, subnet mask and gateway info for this virtual network adapter. This property was added in vSphere API 7.0.
    Ipv6 *Ipv6
    // Windows settings to be configured for this specific virtual Network adapter. This is valid only for Windows guest operating systems. This property was added in vSphere API 7.0.
...
type AdapterMapping struct {
    // The MAC address of a network adapter being customized. This property was added in vSphere API 7.0.
    MacAddress *string
    // The IP settings for the associated virtual network adapter. This property was added in vSphere API 7.0.
    Adapter IPSettings
}
...
type CustomizationSpec struct {
    // Settings to be applied to the guest during the customization. This property was added in vSphere API 7.0.
    ConfigurationSpec ConfigurationSpec
    // Global DNS settings constitute the DNS settings that are not specific to a particular virtual network adapter. This property was added in vSphere API 7.0.
    GlobalDNSSettings GlobalDNSSettings
    // IP settings that are specific to a particular virtual network adapter. The AdapterMapping class maps a network adapter's MAC address to its IPSettings. May be empty if there are no network adapters, else should match number of network adapters configured for the VM. This property was added in vSphere API 7.0.
