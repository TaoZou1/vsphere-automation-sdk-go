...
// The ``Items`` provides methods to create, list, update, and delete configuration items that are stored in a namespace in the Settings Store of HVC. Usage beyond VMware Cloud on AWS is not supported. **Warning:** This interface is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
