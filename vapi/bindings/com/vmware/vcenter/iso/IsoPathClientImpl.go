 ...
 *
 * Client stubs for service: IsoPath
 * Functions that implement the generated IsoPathClient interface
 */
...
func NewIsoPathClientImpl(connector client.Connector) *IsoPathClientImpl {
	...
	methodIdentifiers := []core.MethodIdentifier{
		core.NewMethodIdentifier(interfaceIdentifier, "getDatastorePath"),
	}
...
func (iIface *IsoPathClientImpl) GetDatastorePath(libraryItemIdParam string) (string, error) {
	...
	operationRestMetaData := isoPathGetDatastorePathRestMetadata()
	...
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), isoPathGetDatastorePathOutputType())
...
func (iIface *IsoPathClientImpl) getDatastorePathMethodDefinition() *core.MethodDefinition {
	...
	methodIdentifier := core.NewMethodIdentifier(interfaceIdentifier, "getDatastorePath")
