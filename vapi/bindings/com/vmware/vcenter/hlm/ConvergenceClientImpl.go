 ...
 *
 * Client stubs for service: Convergence
 * Functions that implement the generated ConvergenceClient interface
 */
...
func NewConvergenceClientImpl(connector client.Connector) *ConvergenceClientImpl {
	...
	methodIdentifiers := []core.MethodIdentifier{
		core.NewMethodIdentifier(interfaceIdentifier, "converge"),
	}
...
func (cIface *ConvergenceClientImpl) Converge() (ConvergenceConvergenceInfo, error) {
	...
	if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), convergenceConvergeOutputType())
		if errorInOutput != nil {
			return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
		return output.(ConvergenceConvergenceInfo), nil
	} else {
...
func (cIface *ConvergenceClientImpl) convergeMethodDefinition() *core.MethodDefinition {
	...
	methodIdentifier := core.NewMethodIdentifier(interfaceIdentifier, "converge")
