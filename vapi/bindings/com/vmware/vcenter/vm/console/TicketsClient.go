...
type TicketsClient interface {
    ...
    // @throws NotAllowedInCurrentState if the virtual machine is powered off and requested ticket type is Tickets_Type#TicketsType_WEBMKS
