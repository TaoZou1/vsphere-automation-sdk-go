...
// The ``Info`` class describes the VMWare Tools properties of a virtual machine. This class was added in vSphere API 7.0.
 type ToolsInfo struct {
    // Set if the virtual machine supports auto-upgrading Tools via ToolsUpgradePolicy. This property was added in vSphere API 7.0.
    ...
    Version *string
    // Tools upgrade policy setting for the virtual machine. ToolsUpgradePolicy. This property was added in vSphere API 7.0.
