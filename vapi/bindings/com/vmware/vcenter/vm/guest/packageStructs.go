...
type Credentials struct {
    // If map with bool value, the method will interact with the logged-in desktop session in the guest. This requires that the logged-on user matches the user specified by the Credentials. This is currently only supported for CredentialsType#Type_USERNAME_PASSWORD. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    ...
    // For CredentialsType#Type_SAML_BEARER_TOKEN, this is the guest user to be associated with the credentials. For CredentialsType#Type_USERNAME_PASSWORD this is the guest username. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
	UserName *string
...
const (
	...
	CredentialsType_USERNAME_PASSWORD CredentialsType = "USERNAME_PASSWORD"
	...
	CredentialsType_SAML_BEARER_TOKEN CredentialsType = "SAML_BEARER_TOKEN"
)

func (t CredentialsType) CredentialsType() bool {
	switch t {
	case CredentialsType_USERNAME_PASSWORD:
		return true
	case CredentialsType_SAML_BEARER_TOKEN:
		return true
	default:
		return false
	}
...
func CredentialsBindingType() bindings.BindingType {
	...
	fields["type"] = bindings.NewEnumType("com.vmware.vcenter.vm.guest.credentials.type", reflect.TypeOf(CredentialsType(CredentialsType_USERNAME_PASSWORD)))
