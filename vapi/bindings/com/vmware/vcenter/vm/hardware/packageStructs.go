...
type NvmeAddressInfo struct {
    // Bus number of the adapter to which the device is attached. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    Bus int64
    // Unit number of the device. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    Unit int64
}
...
type NvmeAddressSpec struct {
    // Bus number of the adapter to which the device should be attached. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    Bus int64
    // Unit number of the device. **Warning:** This property is part of a new feature in development. It may be changed at any time and may not have all supported functionality implemented.
    Unit *int64
}
