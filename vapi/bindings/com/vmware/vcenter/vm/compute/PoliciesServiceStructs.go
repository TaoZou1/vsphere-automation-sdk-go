...
import (
    "reflect"
    "gitlab.eng.vmware.com/golangsdk/vsphere-automation-sdk-go/vapi/bindings/com/vmware/vcenter/compute/policies"
...
func (PoliciesInfo PoliciesInfo) Error() string {
    return "com.vmware.vcenter.vm.compute.info"
}
