...
func historicalListInputType() bindings.StructType {
...
func historicalListOutputType() bindings.BindingType {
    return bindings.NewListType(bindings.NewReferenceType(lcm.TasksInfoBindingType), reflect.TypeOf([]lcm.TasksInfo{}))
}

func historicalListRestMetadata() protocol.OperationRestMetadata {
