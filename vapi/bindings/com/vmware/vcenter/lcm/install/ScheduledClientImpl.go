 ...
 *
 * Client stubs for service: Scheduled
 * Functions that implement the generated ScheduledClient interface
 */
...
func (sIface *ScheduledClientImpl) Get(taskParam string) (lcm.InstallSpec, error) {
    ...
    if methodResult.IsSuccess() {
		output, errorInOutput := typeConverter.ConvertToGolang(methodResult.Output(), scheduledGetOutputType())
		if errorInOutput != nil {
		    return emptyOutput, bindings.VAPIerrorsToError(errorInOutput)
		}
	    return output.(lcm.InstallSpec), nil
	} else {
