...
func installCheckInputType() bindings.StructType {
	...
	fields["options"] = bindings.NewOptionalType(bindings.NewReferenceType(DeploymentOptionBindingType))
...
func installCheckOutputType() bindings.BindingType {
	return bindings.NewIdType([]string{"com.vmware.vcenter.lcm.task"}, "")
}
