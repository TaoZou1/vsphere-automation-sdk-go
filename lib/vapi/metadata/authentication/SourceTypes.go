...
func sourceDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	fields["source_id"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.authentication.source"}, "")
	fieldNameMap["source_id"] = "SourceId"
	paramsTypeMap["source_id"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.authentication.source"}, "")
	paramsTypeMap["sourceId"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.authentication.source"}, "")
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/vapi/metadata/authentication/source/{sourceId}",
		"",
		resultHeaders,
		204,
		"",
