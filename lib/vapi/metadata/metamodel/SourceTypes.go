...
func sourceDeleteRestMetadata() protocol.OperationRestMetadata {
	...
	fields["source_id"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.metamodel.source"}, "")
	fieldNameMap["source_id"] = "SourceId"
	paramsTypeMap["source_id"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.metamodel.source"}, "")
	paramsTypeMap["sourceId"] = bindings.NewIdType([]string{"com.vmware.vapi.metadata.metamodel.source"}, "")
	...
	return protocol.NewOperationRestMetadata(
		...
		"",
		"DELETE",
		"/vapi/metadata/metamodel/source/{sourceId}",
		"",
		resultHeaders,
		204,
		"",
